...
${(l==null?void 0:l.entry)??""}`,description:l!=null&&l.description!==""?l.description:a.description,detail:l==null?void 0:l.detail,parameters:a.parameters}}));br(this,"removedUnwantedCells",o=>{const e=o.parameters.map(i=>i.filter(a=>!(a===""||a==="Aa")));return{url:o.url,entry:o.entry,description:o.description,parameters:this.removedSymbols(o.entry,e)}});br(this,"removedSymbols",(o,e)=>o==="Space Between"||o==="Divide Width"||o==="Divide Color"||o==="Divide Style"?e.map(t=>t.map(i=>i.replace(" > * + *",""))):e)}}class Ob extends _s{constructor(){super(...arguments);br(this,"documentationsTriple",[[E.Layout,ws,Nb],[E.FlexboxAndGrid,us,zb],[E.Spacing,xs,Sb],[E.Sizing,hs,Cb],[E.Typography,vs,Ab],[E.Backgrounds,ys,Eb],[E.Borders,ks,Tb],[E.Effects,js,_b],[E.Filters,Ns,Ub],[E.Tables,zs,Pb],[E.TransitionsAndAnimation,Ss,Lb],[E.Transforms,Cs,Rb],[E.Interactivity,As,Fb],[E.SVG,Es,Bb],[E.Accessibility,Ts,Mb]])}}class Db extends _s{constructor(){super(...arguments);br(this,"empty",new Map);br(this,"documentationsTriple",[[E.Layout,ws,this.empty],[E.FlexboxAndGrid,us,this.empty],[E.Spacing,xs,this.empty],[E.Sizing,hs,this.empty],[E.Typography,vs,this.empty],[E.Backgrounds,ys,this.empty],[E.Borders,ks,this.empty],[E.Effects,js,this.empty],[E.Filters,Ns,this.empty],[E.Tables,zs,this.empty],[E.TransitionsAndAnimation,Ss,this.empty],[E.Transforms,Cs,this.empty],[E.Interactivity,As,this.empty],[E.SVG,Es,this.empty],[E.Accessibility,Ts,this.empty]])}}const Ko=class Ko{};br(Ko,"id"),br(Ko,"run",(o,e)=>{clearInterval(Ko.id),Ko.id=window.setTimeout(()=>{o()},e)});let Qi=Ko;const Ib="/tailwindcss-japanese-cheat-sheet/assets/github-mark-B3LxWxcL.png",$b="/tailwindcss-japanese-cheat-sheet/assets/github-mark-white-BsLkggKK.png",ao={sm:"sm",md:"md",lg:"lg",xl:"xl"},rd=r=>r>=1280?ao.xl:r>=1024?ao.lg:r>=768?ao.md:ao.sm;class od{sliced(o){return{firstRow:[...o],secondRow:[],thirdRow:[],fourthRow:[]}}}class Wb{sliced(o){return{firstRow:o.slice(0,5),secondRow:o.slice(5),thirdRow:[],fourthRow:[]}}}class Hb{sliced(o){return{firstRow:o.slice(0,4),secondRow:o.slice(4,8),thirdRow:o.slice(8),fourthRow:[]}}}class Vb{sliced(o){return{firstRow:o.slice(0,2),secondRow:o.slice(2,6),thirdRow:o.slice(6,10),fourthRow:o.slice(10)}}}const Fe=class Fe{};br(Fe,"values",new Map([[ao.sm,new od],[ao.md,new Wb],[ao.lg,new Hb],[ao.xl,new Vb]])),br(Fe,"get",o=>{const e=Fe.values.get(o);return e??new od});let dn=Fe;const ri=new Ob,ed=new Db,Yb=()=>{const[r,o]=O.useState(ri.getTranslations()),[e,t]=O.useState(!0),[i,a]=O.useState([]),[l,d]=O.useState([]),[s,g]=O.useState([]),[u,w]=O.useState([]);return O.useEffect(()=>{let m=null;window.addEventListener("resize",()=>{const y=rd(window.innerWidth);if(m===y)return;m=y;const k=dn.get(y).sliced(r);a(k.firstRow),d(k.secondRow),g(k.thirdRow),w(k.fourthRow)})},[]),O.useEffect(()=>{const m=rd(window.innerWidth),v=dn.get(m).sliced(r);a(v.firstRow),d(v.secondRow),g(v.thirdRow),w(v.fourthRow)},[r]),n.jsxs(lb,{children:[n.jsxs("div",{className:"space-y-4 bg-gray-800 py-4 text-neutral-100",children:[n.jsx("h1",{className:"break-keep text-center text-2xl font-bold drop-shadow-[0_0_5px_rgba(0,255,255,0.75)]",children:"Tailwind CSS 日本語チートシート"}),n.jsxs("div",{className:"flex justify-between px-4",children:[n.jsx("p",{className:"my-auto -ml-4 bg-gradient-to-r from-purple-500 to-transparent px-4 text-sm",children:`Documentation ${jb}`}),n.jsx(Xb,{isJapanese:e,setIsJapanese:t,translatorJA:ri,translatorEN:ed,setTranslations:o})]})]}),n.jsxs("div",{className:"space-y-4 p-4 text-neutral-950 dark:text-neutral-100",children:[n.jsx(Qb,{isJapanese:e}),n.jsx(Gb,{translations:e?ri.getTranslations():ed.getTranslations(),setTranslations:o}),n.jsxs("div",{className:"grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4",children:[n.jsx("div",{className:"flex flex-col",children:i.map(m=>n.jsx(Nt,{category:m.category,detailedDocumentations:m.detailedDocumentations},m.category))}),n.jsx("div",{className:"flex flex-col",children:l.map(m=>n.jsx(Nt,{category:m.category,detailedDocumentations:m.detailedDocumentations},m.category))}),n.jsx("div",{className:"flex flex-col",children:s.map(m=>n.jsx(Nt,{category:m.category,detailedDocumentations:m.detailedDocumentations},m.category))}),n.jsx("div",{className:"flex flex-col",children:u.map(m=>n.jsx(Nt,{category:m.category,detailedDocumentations:m.detailedDocumentations},m.category))})]})]}),n.jsxs("div",{className:"flex justify-center gap-2 pb-4",children:[n.jsxs("a",{className:"relative h-6 w-6 opacity-70 transition hover:opacity-100",href:"https://github.com/Telehakke/tailwindcss-japanese-cheat-sheet",target:"_blank",children:[n.jsx("img",{className:"absolute inset-0 inline-block dark:hidden",src:Ib}),n.jsx("img",{className:"absolute inset-0 hidden dark:inline-block",src:$b})]}),n.jsx("small",{className:"my-auto text-neutral-950 dark:text-neutral-100",children:"© 2024 Telehakke"})]})]})},Xb=({isJapanese:r,setIsJapanese:o,translatorJA:e,translatorEN:t,setTranslations:i})=>n.jsxs("div",{children:[n.jsx("button",{className:`rounded-l-full border-y-2 border-l-2 border-purple-500 px-2 transition ${r?"bg-purple-500":"hover:bg-white/20"}`,onClick:()=>{o(!0),i(e.getTranslations())},children:"日本語"}),n.jsx("button",{className:`rounded-r-full border-y-2 border-r-2 border-purple-500 px-2 transition ${r?"hover:bg-white/20":"bg-purple-500"}`,onClick:()=>{o(!1),i(t.getTranslations())},children:"English"})]}),Qb=({isJapanese:r})=>{const{setShouldExpandAll:o}=O.useContext(Wa);return n.jsxs("div",{className:"flex justify-center gap-4",children:[n.jsx(Xi,{className:"px-2",Icon:n.jsx(cb,{className:"fill-neutral-500"}),text:r?"全て展開":"Expand All",onClick:()=>o(!0)}),n.jsx(Xi,{className:"px-2",Icon:n.jsx(gb,{className:"fill-neutral-500"}),text:r?"全て折りたたむ":"Collapse All",onClick:()=>o(!1)})]})},Gb=({translations:r,setTranslations:o})=>{const[e,t]=O.useState(!1),[i,a]=O.useState(""),l=O.useRef(null);O.useEffect(()=>{var g,u;(g=l.current)==null||g.addEventListener("focus",()=>{t(!0)}),(u=l.current)==null||u.addEventListener("focusout",()=>{t(!1)})},[]);const d=g=>{const u=g.target.value;a(u);const w=u.toLowerCase(),m=(y,v)=>y.filter(F=>{if(F.entry.toLowerCase().includes(v)||F.description.toLowerCase().includes(v))return!0;for(const b of F.parameters)for(const c of b)if(c.toLowerCase().includes(v))return!0;return!1});Qi.run(()=>{const y=r.map(v=>{const k=m(v.detailedDocumentations,w);return{category:v.category,detailedDocumentations:k}});o(y)},400)},s=()=>{a(""),o(r)};return n.jsxs("div",{className:"relative mx-auto max-w-80",children:[n.jsx("input",{className:"h-8 w-full rounded-md bg-transparent px-2",id:"search",type:"text",onChange:d,value:i,ref:l}),n.jsx("div",{className:"absolute inset-0 -z-10 rounded-md bg-neutral-50 dark:bg-neutral-700",children:!e&&i.length===0?n.jsx(pb,{className:"absolute inset-y-0 left-2 my-auto fill-neutral-500"}):null}),i.length>0&&n.jsx("button",{onClick:s,children:n.jsx(mb,{className:"absolute inset-y-0 right-2 my-auto rounded-full fill-neutral-500 transition hover:bg-neutral-200 dark:hover:bg-neutral-600 dark:hover:fill-neutral-400"})})]})};fs(document.getElementById("root")).render(n.jsx(O.StrictMode,{children:n.jsx(Yb,{})}));
