var Cs=Object.defineProperty;var As=(r,o,e)=>o in r?Cs(r,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[o]=e;var jr=(r,o,e)=>As(r,typeof o!="symbol"?o+"":o,e);(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function e(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(n){if(n.ep)return;n.ep=!0;const a=e(n);fetch(n.href,a)}})();var Jl={exports:{}},an={},Zl={exports:{}},U={};/**
 * @license React
 ...
 */var Ze=Symbol.for("react.element"),Es=Symbol.for("react.portal"),Ts=Symbol.for("react.fragment"),_s=Symbol.for("react.strict_mode"),Us=Symbol.for("react.profiler"),Ps=Symbol.for("react.provider"),Ls=Symbol.for("react.context"),Rs=Symbol.for("react.forward_ref"),Fs=Symbol.for("react.suspense"),Bs=Symbol.for("react.memo"),Ms=Symbol.for("react.lazy"),Da=Symbol.iterator;function Os(r){return r===null||typeof r!="object"?null:(r=Da&&r[Da]||r["@@iterator"],typeof r=="function"?r:null)}var ql={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},rd=Object.assign,od={};function se(r,o,e){this.props=r,this.context=o,this.refs=od,this.updater=e||ql}se.prototype.isReactComponent={};se.prototype.setState=function(r,o){if(typeof r!="object"&&typeof r!="function"&&r!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,r,o,"setState")};se.prototype.forceUpdate=function(r){this.updater.enqueueForceUpdate(this,r,"forceUpdate")};function ed(){}ed.prototype=se.prototype;function Vi(r,o,e){this.props=r,this.context=o,this.refs=od,this.updater=e||ql}var Yi=Vi.prototype=new ed;Yi.constructor=Vi;rd(Yi,se.prototype);Yi.isPureReactComponent=!0;var $a=Array.isArray,td=Object.prototype.hasOwnProperty,Xi={current:null},nd={key:!0,ref:!0,__self:!0,__source:!0};function id(r,o,e){var t,n={},a=null,l=null;if(o!=null)for(t in o.ref!==void 0&&(l=o.ref),o.key!==void 0&&(a=""+o.key),o)td.call(o,t)&&!nd.hasOwnProperty(t)&&(n[t]=o[t]);var d=arguments.length-2;if(d===1)n.children=e;else if(1<d){for(var s=Array(d),g=0;g<d;g++)s[g]=arguments[g+2];n.children=s}if(r&&r.defaultProps)for(t in d=r.defaultProps,d)n[t]===void 0&&(n[t]=d[t]);return{$$typeof:Ze,type:r,key:a,ref:l,props:n,_owner:Xi.current}}function Is(r,o){return{$$typeof:Ze,type:r.type,key:o,ref:r.ref,props:r.props,_owner:r._owner}}function Qi(r){return typeof r=="object"&&r!==null&&r.$$typeof===Ze}function Ds(r){var o={"=":"=0",":":"=2"};return"$"+r.replace(/[=:]/g,function(e){return o[e]})}var Wa=/\/+/g;function zn(r,o){return typeof r=="object"&&r!==null&&r.key!=null?Ds(""+r.key):o.toString(36)}function jt(r,o,e,t,n){var a=typeof r;(a==="undefined"||a==="boolean")&&(r=null);var l=!1;if(r===null)l=!0;else switch(a){case"string":case"number":l=!0;break;case"object":switch(r.$$typeof){case Ze:case Es:l=!0}}if(l)return l=r,n=n(l),r=t===""?"."+zn(l,0):t,$a(n)?(e="",r!=null&&(e=r.replace(Wa,"$&/")+"/"),jt(n,o,e,"",function(g){return g})):n!=null&&(Qi(n)&&(n=Is(n,e+(!n.key||l&&l.key===n.key?"":(""+n.key).replace(Wa,"$&/")+"/")+r)),o.push(n)),1;if(l=0,t=t===""?".":t+":",$a(r))for(var d=0;d<r.length;d++){a=r[d];var s=t+zn(a,d);l+=jt(a,o,e,s,n)}else if(s=Os(r),typeof s=="function")for(r=s.call(r),d=0;!(a=r.next()).done;)a=a.value,s=t+zn(a,d++),l+=jt(a,o,e,s,n);else if(a==="object")throw o=String(r),Error("Objects are not valid as a React child (found: "+(o==="[object Object]"?"object with keys {"+Object.keys(r).join(", ")+"}":o)+"). If you meant to render a collection of children, use an array instead.");return l}function it(r,o,e){if(r==null)return r;var t=[],n=0;return jt(r,t,"","",function(a){return o.call(e,a,n++)}),t}function $s(r){if(r._status===-1){var o=r._result;o=o(),o.then(function(e){(r._status===0||r._status===-1)&&(r._status=1,r._result=e)},function(e){(r._status===0||r._status===-1)&&(r._status=2,r._result=e)}),r._status===-1&&(r._status=0,r._result=o)}if(r._status===1)return r._result.default;throw r._result}var cr={current:null},Nt={transition:null},Ws={ReactCurrentDispatcher:cr,ReactCurrentBatchConfig:Nt,ReactCurrentOwner:Xi};function ad(){throw Error("act(...) is not supported in production builds of React.")}U.Children={map:it,forEach:function(r,o,e){it(r,function(){o.apply(this,arguments)},e)},count:function(r){var o=0;return it(r,function(){o++}),o},toArray:function(r){return it(r,function(o){return o})||[]},only:function(r){if(!Qi(r))throw Error("React.Children.only expected to receive a single React element child.");return r}};U.Component=se;U.Fragment=Ts;U.Profiler=Us;U.PureComponent=Vi;U.StrictMode=_s;U.Suspense=Fs;U.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Ws;U.act=ad;U.cloneElement=function(r,o,e){if(r==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+r+".");var t=rd({},r.props),n=r.key,a=r.ref,l=r._owner;if(o!=null){if(o.ref!==void 0&&(a=o.ref,l=Xi.current),o.key!==void 0&&(n=""+o.key),r.type&&r.type.defaultProps)var d=r.type.defaultProps;for(s in o)td.call(o,s)&&!nd.hasOwnProperty(s)&&(t[s]=o[s]===void 0&&d!==void 0?d[s]:o[s])}var s=arguments.length-2;if(s===1)t.children=e;else if(1<s){d=Array(s);for(var g=0;g<s;g++)d[g]=arguments[g+2];t.children=d}return{$$typeof:Ze,type:r.type,key:n,ref:a,props:t,_owner:l}};U.createContext=function(r){return r={$$typeof:Ls,_currentValue:r,_currentValue2:r,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},r.Provider={$$typeof:Ps,_context:r},r.Consumer=r};U.createElement=id;U.createFactory=function(r){var o=id.bind(null,r);return o.type=r,o};U.createRef=function(){return{current:null}};U.forwardRef=function(r){return{$$typeof:Rs,render:r}};U.isValidElement=Qi;U.lazy=function(r){return{$$typeof:Ms,_payload:{_status:-1,_result:r},_init:$s}};U.memo=function(r,o){return{$$typeof:Bs,type:r,compare:o===void 0?null:o}};U.startTransition=function(r){var o=Nt.transition;Nt.transition={};try{r()}finally{Nt.transition=o}};U.unstable_act=ad;U.useCallback=function(r,o){return cr.current.useCallback(r,o)};U.useContext=function(r){return cr.current.useContext(r)};U.useDebugValue=function(){};U.useDeferredValue=function(r){return cr.current.useDeferredValue(r)};U.useEffect=function(r,o){return cr.current.useEffect(r,o)};U.useId=function(){return cr.current.useId()};U.useImperativeHandle=function(r,o,e){return cr.current.useImperativeHandle(r,o,e)};U.useInsertionEffect=function(r,o){return cr.current.useInsertionEffect(r,o)};U.useLayoutEffect=function(r,o){return cr.current.useLayoutEffect(r,o)};U.useMemo=function(r,o){return cr.current.useMemo(r,o)};U.useReducer=function(r,o,e){return cr.current.useReducer(r,o,e)};U.useRef=function(r){return cr.current.useRef(r)};U.useState=function(r){return cr.current.useState(r)};U.useSyncExternalStore=function(r,o,e){return cr.current.useSyncExternalStore(r,o,e)};U.useTransition=function(){return cr.current.useTransition()};U.version="18.3.1";Zl.exports=U;var G=Zl.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hs=G,Vs=Symbol.for("react.element"),Ys=Symbol.for("react.fragment"),Xs=Object.prototype.hasOwnProperty,Qs=Hs.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Gs={key:!0,ref:!0,__self:!0,__source:!0};function ld(r,o,e){var t,n={},a=null,l=null;e!==void 0&&(a=""+e),o.key!==void 0&&(a=""+o.key),o.ref!==void 0&&(l=o.ref);for(t in o)Xs.call(o,t)&&!Gs.hasOwnProperty(t)&&(n[t]=o[t]);if(r&&r.defaultProps)for(t in o=r.defaultProps,o)n[t]===void 0&&(n[t]=o[t]);return{$$typeof:Vs,type:r,key:a,ref:l,props:n,_owner:Qs.current}}an.Fragment=Ys;an.jsx=ld;an.jsxs=ld;Jl.exports=an;var i=Jl.exports,dd={exports:{}},yr={},sd={exports:{}},cd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(r){function o(z,T){var _=z.length;z.push(T);r:for(;0<_;){var Y=_-1>>>1,Z=z[Y];if(0<n(Z,T))z[Y]=T,z[_]=Z,_=Y;else break r}}function e(z){return z.length===0?null:z[0]}function t(z){if(z.length===0)return null;var T=z[0],_=z.pop();if(_!==T){z[0]=_;r:for(var Y=0,Z=z.length,tt=Z>>>1;Y<tt;){var vo=2*(Y+1)-1,Nn=z[vo],yo=vo+1,nt=z[yo];if(0>n(Nn,_))yo<Z&&0>n(nt,Nn)?(z[Y]=nt,z[yo]=_,Y=yo):(z[Y]=Nn,z[vo]=_,Y=vo);else if(yo<Z&&0>n(nt,_))z[Y]=nt,z[yo]=_,Y=yo;else break r}}return T}function n(z,T){var _=z.sortIndex-T.sortIndex;return _!==0?_:z.id-T.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;r.unstable_now=function(){return a.now()}}else{var l=Date,d=l.now();r.unstable_now=function(){return l.now()-d}}var s=[],g=[],u=1,w=null,f=3,v=!1,y=!1,k=!1,F=typeof setTimeout=="function"?setTimeout:null,b=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(z){for(var T=e(g);T!==null;){if(T.callback===null)t(g);else if(T.startTime<=z)t(g),T.sortIndex=T.expirationTime,o(s,T);else break;T=e(g)}}function x(z){if(k=!1,p(z),!y)if(e(s)!==null)y=!0,kn(N);else{var T=e(g);T!==null&&jn(x,T.startTime-z)}}function N(z,T){y=!1,k&&(k=!1,b(A),A=-1),v=!0;var _=f;try{for(p(T),w=e(s);w!==null&&(!(w.expirationTime>T)||z&&!Tr());){var Y=w.callback;if(typeof Y=="function"){w.callback=null,f=w.priorityLevel;var Z=Y(w.expirationTime<=T);T=r.unstable_now(),typeof Z=="function"?w.callback=Z:w===e(s)&&t(s),p(T)}else t(s);w=e(s)}if(w!==null)var tt=!0;else{var vo=e(g);vo!==null&&jn(x,vo.startTime-T),tt=!1}return tt}finally{w=null,f=_,v=!1}}var S=!1,C=null,A=-1,V=5,P=-1;function Tr(){return!(r.unstable_now()-P<V)}function be(){if(C!==null){var z=r.unstable_now();P=z;var T=!0;try{T=C(!0,z)}finally{T?pe():(S=!1,C=null)}}else S=!1}var pe;if(typeof c=="function")pe=function(){c(be)};else if(typeof MessageChannel<"u"){var Ia=new MessageChannel,Ss=Ia.port2;Ia.port1.onmessage=be,pe=function(){Ss.postMessage(null)}}else pe=function(){F(be,0)};function kn(z){C=z,S||(S=!0,pe())}function jn(z,T){A=F(function(){z(r.unstable_now())},T)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(z){z.callback=null},r.unstable_continueExecution=function(){y||v||(y=!0,kn(N))},r.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):V=0<z?Math.floor(1e3/z):5},r.unstable_getCurrentPriorityLevel=function(){return f},r.unstable_getFirstCallbackNode=function(){return e(s)},r.unstable_next=function(z){switch(f){case 1:case 2:case 3:var T=3;break;default:T=f}var _=f;f=T;try{return z()}finally{f=_}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(z,T){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var _=f;f=z;try{return T()}finally{f=_}},r.unstable_scheduleCallback=function(z,T,_){var Y=r.unstable_now();switch(typeof _=="object"&&_!==null?(_=_.delay,_=typeof _=="number"&&0<_?Y+_:Y):_=Y,z){case 1:var Z=-1;break;case 2:Z=250;break;case 5:Z=1073741823;break;case 4:Z=1e4;break;default:Z=5e3}return Z=_+Z,z={id:u++,callback:T,priorityLevel:z,startTime:_,expirationTime:Z,sortIndex:-1},_>Y?(z.sortIndex=_,o(g,z),e(s)===null&&z===e(g)&&(k?(b(A),A=-1):k=!0,jn(x,_-Y))):(z.sortIndex=Z,o(s,z),y||v||(y=!0,kn(N))),z},r.unstable_shouldYield=Tr,r.unstable_wrapCallback=function(z){var T=f;return function(){var _=f;f=T;try{return z.apply(this,arguments)}finally{f=_}}}})(cd);sd.exports=cd;var Ks=sd.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Js=G,vr=Ks;function h(r){for(var o="https://reactjs.org/docs/error-decoder.html?invariant="+r,e=1;e<arguments.length;e++)o+="&args[]="+encodeURIComponent(arguments[e]);return"Minified React error #"+r+"; visit "+o+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var gd=new Set,Re={};function Lo(r,o){ee(r,o),ee(r+"Capture",o)}function ee(r,o){for(Re[r]=o,r=0;r<o.length;r++)gd.add(o[r])}var Qr=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),Jn=Object.prototype.hasOwnProperty,Zs=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,Ha={},Va={};function qs(r){return Jn.call(Va,r)?!0:Jn.call(Ha,r)?!1:Zs.test(r)?Va[r]=!0:(Ha[r]=!0,!1)}function rc(r,o,e,t){if(e!==null&&e.type===0)return!1;switch(typeof o){case"function":case"symbol":return!0;case"boolean":return t?!1:e!==null?!e.acceptsBooleans:(r=r.toLowerCase().slice(0,5),r!=="data-"&&r!=="aria-");default:return!1}}function oc(r,o,e,t){if(o===null||typeof o>"u"||rc(r,o,e,t))return!0;if(t)return!1;if(e!==null)switch(e.type){case 3:return!o;case 4:return o===!1;case 5:return isNaN(o);case 6:return isNaN(o)||1>o}return!1}function gr(r,o,e,t,n,a,l){this.acceptsBooleans=o===2||o===3||o===4,this.attributeName=t,this.attributeNamespace=n,this.mustUseProperty=e,this.propertyName=r,this.type=o,this.sanitizeURL=a,this.removeEmptyString=l}var tr={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(r){tr[r]=new gr(r,0,!1,r,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(r){var o=r[0];tr[o]=new gr(o,1,!1,r[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(r){tr[r]=new gr(r,2,!1,r.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(r){tr[r]=new gr(r,2,!1,r,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(r){tr[r]=new gr(r,3,!1,r.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(r){tr[r]=new gr(r,3,!0,r,null,!1,!1)});["capture","download"].forEach(function(r){tr[r]=new gr(r,4,!1,r,null,!1,!1)});["cols","rows","size","span"].forEach(function(r){tr[r]=new gr(r,6,!1,r,null,!1,!1)});["rowSpan","start"].forEach(function(r){tr[r]=new gr(r,5,!1,r.toLowerCase(),null,!1,!1)});var Gi=/[\-:]([a-z])/g;function Ki(r){return r[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(r){var o=r.replace(Gi,Ki);tr[o]=new gr(o,1,!1,r,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(r){var o=r.replace(Gi,Ki);tr[o]=new gr(o,1,!1,r,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(r){var o=r.replace(Gi,Ki);tr[o]=new gr(o,1,!1,r,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(r){tr[r]=new gr(r,1,!1,r.toLowerCase(),null,!1,!1)});tr.xlinkHref=new gr("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(r){tr[r]=new gr(r,1,!1,r.toLowerCase(),null,!0,!0)});function Ji(r,o,e,t){var n=tr.hasOwnProperty(o)?tr[o]:null;(n!==null?n.type!==0:t||!(2<o.length)||o[0]!=="o"&&o[0]!=="O"||o[1]!=="n"&&o[1]!=="N")&&(oc(o,e,n,t)&&(e=null),t||n===null?qs(o)&&(e===null?r.removeAttribute(o):r.setAttribute(o,""+e)):n.mustUseProperty?r[n.propertyName]=e===null?n.type===3?!1:"":e:(o=n.attributeName,t=n.attributeNamespace,e===null?r.removeAttribute(o):(n=n.type,e=n===3||n===4&&e===!0?"":""+e,t?r.setAttributeNS(t,o,e):r.setAttribute(o,e))))}var Zr=Js.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,at=Symbol.for("react.element"),Bo=Symbol.for("react.portal"),Mo=Symbol.for("react.fragment"),Zi=Symbol.for("react.strict_mode"),Zn=Symbol.for("react.profiler"),bd=Symbol.for("react.provider"),pd=Symbol.for("react.context"),qi=Symbol.for("react.forward_ref"),qn=Symbol.for("react.suspense"),ri=Symbol.for("react.suspense_list"),ra=Symbol.for("react.memo"),ro=Symbol.for("react.lazy"),md=Symbol.for("react.offscreen"),Ya=Symbol.iterator;function me(r){return r===null||typeof r!="object"?null:(r=Ya&&r[Ya]||r["@@iterator"],typeof r=="function"?r:null)}var W=Object.assign,Sn;function ke(r){if(Sn===void 0)try{throw Error()}catch(e){var o=e.stack.trim().match(/\n( *(at )?)/);Sn=o&&o[1]||""}return`
`+Sn+r}var Cn=!1;function An(r,o){if(!r||Cn)return"";Cn=!0;var e=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{if(o)if(o=function(){throw Error()},Object.defineProperty(o.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(o,[])}catch(g){var t=g}Reflect.construct(r,[],o)}else{try{o.call()}catch(g){t=g}r.call(o.prototype)}else{try{throw Error()}catch(g){t=g}r()}}catch(g){if(g&&t&&typeof g.stack=="string"){for(var n=g.stack.split(`
`),a=t.stack.split(`
`),l=n.length-1,d=a.length-1;1<=l&&0<=d&&n[l]!==a[d];)d--;for(;1<=l&&0<=d;l--,d--)if(n[l]!==a[d]){if(l!==1||d!==1)do if(l--,d--,0>d||n[l]!==a[d]){var s=`
`+n[l].replace(" at new "," at ");return r.displayName&&s.includes("<anonymous>")&&(s=s.replace("<anonymous>",r.displayName)),s}while(1<=l&&0<=d);break}}}finally{Cn=!1,Error.prepareStackTrace=e}return(r=r?r.displayName||r.name:"")?ke(r):""}function ec(r){switch(r.tag){case 5:return ke(r.type);case 16:return ke("Lazy");case 13:return ke("Suspense");case 19:return ke("SuspenseList");case 0:case 2:case 15:return r=An(r.type,!1),r;case 11:return r=An(r.type.render,!1),r;case 1:return r=An(r.type,!0),r;default:return""}}function oi(r){if(r==null)return null;if(typeof r=="function")return r.displayName||r.name||null;if(typeof r=="string")return r;switch(r){case Mo:return"Fragment";case Bo:return"Portal";case Zn:return"Profiler";case Zi:return"StrictMode";case qn:return"Suspense";case ri:return"SuspenseList"}if(typeof r=="object")switch(r.$$typeof){case pd:return(r.displayName||"Context")+".Consumer";case bd:return(r._context.displayName||"Context")+".Provider";case qi:var o=r.render;return r=r.displayName,r||(r=o.displayName||o.name||"",r=r!==""?"ForwardRef("+r+")":"ForwardRef"),r;case ra:return o=r.displayName||null,o!==null?o:oi(r.type)||"Memo";case ro:o=r._payload,r=r._init;try{return oi(r(o))}catch{}}return null}function tc(r){var o=r.type;switch(r.tag){case 24:return"Cache";case 9:return(o.displayName||"Context")+".Consumer";case 10:return(o._context.displayName||"Context")+".Provider";case 18:return"DehydratedFragment";case 11:return r=o.render,r=r.displayName||r.name||"",o.displayName||(r!==""?"ForwardRef("+r+")":"ForwardRef");case 7:return"Fragment";case 5:return o;case 4:return"Portal";case 3:return"Root";case 6:return"Text";case 16:return oi(o);case 8:return o===Zi?"StrictMode":"Mode";case 22:return"Offscreen";case 12:return"Profiler";case 21:return"Scope";case 13:return"Suspense";case 19:return"SuspenseList";case 25:return"TracingMarker";case 1:case 0:case 17:case 2:case 14:case 15:if(typeof o=="function")return o.displayName||o.name||null;if(typeof o=="string")return o}return null}function fo(r){switch(typeof r){case"boolean":case"number":case"string":case"undefined":return r;case"object":return r;default:return""}}function fd(r){var o=r.type;return(r=r.nodeName)&&r.toLowerCase()==="input"&&(o==="checkbox"||o==="radio")}function nc(r){var o=fd(r)?"checked":"value",e=Object.getOwnPropertyDescriptor(r.constructor.prototype,o),t=""+r[o];if(!r.hasOwnProperty(o)&&typeof e<"u"&&typeof e.get=="function"&&typeof e.set=="function"){var n=e.get,a=e.set;return Object.defineProperty(r,o,{configurable:!0,get:function(){return n.call(this)},set:function(l){t=""+l,a.call(this,l)}}),Object.defineProperty(r,o,{enumerable:e.enumerable}),{getValue:function(){return t},setValue:function(l){t=""+l},stopTracking:function(){r._valueTracker=null,delete r[o]}}}}function lt(r){r._valueTracker||(r._valueTracker=nc(r))}function wd(r){if(!r)return!1;var o=r._valueTracker;if(!o)return!0;var e=o.getValue(),t="";return r&&(t=fd(r)?r.checked?"true":"false":r.value),r=t,r!==e?(o.setValue(r),!0):!1}function Rt(r){if(r=r||(typeof document<"u"?document:void 0),typeof r>"u")return null;try{return r.activeElement||r.body}catch{return r.body}}function ei(r,o){var e=o.checked;return W({},o,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:e??r._wrapperState.initialChecked})}function Xa(r,o){var e=o.defaultValue==null?"":o.defaultValue,t=o.checked!=null?o.checked:o.defaultChecked;e=fo(o.value!=null?o.value:e),r._wrapperState={initialChecked:t,initialValue:e,controlled:o.type==="checkbox"||o.type==="radio"?o.checked!=null:o.value!=null}}function ud(r,o){o=o.checked,o!=null&&Ji(r,"checked",o,!1)}function ti(r,o){ud(r,o);var e=fo(o.value),t=o.type;if(e!=null)t==="number"?(e===0&&r.value===""||r.value!=e)&&(r.value=""+e):r.value!==""+e&&(r.value=""+e);else if(t==="submit"||t==="reset"){r.removeAttribute("value");return}o.hasOwnProperty("value")?ni(r,o.type,e):o.hasOwnProperty("defaultValue")&&ni(r,o.type,fo(o.defaultValue)),o.checked==null&&o.defaultChecked!=null&&(r.defaultChecked=!!o.defaultChecked)}function Qa(r,o,e){if(o.hasOwnProperty("value")||o.hasOwnProperty("defaultValue")){var t=o.type;if(!(t!=="submit"&&t!=="reset"||o.value!==void 0&&o.value!==null))return;o=""+r._wrapperState.initialValue,e||o===r.value||(r.value=o),r.defaultValue=o}e=r.name,e!==""&&(r.name=""),r.defaultChecked=!!r._wrapperState.initialChecked,e!==""&&(r.name=e)}function ni(r,o,e){(o!=="number"||Rt(r.ownerDocument)!==r)&&(e==null?r.defaultValue=""+r._wrapperState.initialValue:r.defaultValue!==""+e&&(r.defaultValue=""+e))}var je=Array.isArray;function Ko(r,o,e,t){if(r=r.options,o){o={};for(var n=0;n<e.length;n++)o["$"+e[n]]=!0;for(e=0;e<r.length;e++)n=o.hasOwnProperty("$"+r[e].value),r[e].selected!==n&&(r[e].selected=n),n&&t&&(r[e].defaultSelected=!0)}else{for(e=""+fo(e),o=null,n=0;n<r.length;n++){if(r[n].value===e){r[n].selected=!0,t&&(r[n].defaultSelected=!0);return}o!==null||r[n].disabled||(o=r[n])}o!==null&&(o.selected=!0)}}function ii(r,o){if(o.dangerouslySetInnerHTML!=null)throw Error(h(91));return W({},o,{value:void 0,defaultValue:void 0,children:""+r._wrapperState.initialValue})}function Ga(r,o){var e=o.value;if(e==null){if(e=o.children,o=o.defaultValue,e!=null){if(o!=null)throw Error(h(92));if(je(e)){if(1<e.length)throw Error(h(93));e=e[0]}o=e}o==null&&(o=""),e=o}r._wrapperState={initialValue:fo(e)}}function xd(r,o){var e=fo(o.value),t=fo(o.defaultValue);e!=null&&(e=""+e,e!==r.value&&(r.value=e),o.defaultValue==null&&r.defaultValue!==e&&(r.defaultValue=e)),t!=null&&(r.defaultValue=""+t)}function Ka(r){var o=r.textContent;o===r._wrapperState.initialValue&&o!==""&&o!==null&&(r.value=o)}function hd(r){switch(r){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function ai(r,o){return r==null||r==="http://www.w3.org/1999/xhtml"?hd(o):r==="http://www.w3.org/2000/svg"&&o==="foreignObject"?"http://www.w3.org/1999/xhtml":r}var dt,vd=function(r){return typeof MSApp<"u"&&MSApp.execUnsafeLocalFunction?function(o,e,t,n){MSApp.execUnsafeLocalFunction(function(){return r(o,e,t,n)})}:r}(function(r,o){if(r.namespaceURI!=="http://www.w3.org/2000/svg"||"innerHTML"in r)r.innerHTML=o;else{for(dt=dt||document.createElement("div"),dt.innerHTML="<svg>"+o.valueOf().toString()+"</svg>",o=dt.firstChild;r.firstChild;)r.removeChild(r.firstChild);for(;o.firstChild;)r.appendChild(o.firstChild)}});function Fe(r,o){if(o){var e=r.firstChild;if(e&&e===r.lastChild&&e.nodeType===3){e.nodeValue=o;return}}r.textContent=o}var Se={animationIterationCount:!0,aspectRatio:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},ic=["Webkit","ms","Moz","O"];Object.keys(Se).forEach(function(r){ic.forEach(function(o){o=o+r.charAt(0).toUpperCase()+r.substring(1),Se[o]=Se[r]})});function yd(r,o,e){return o==null||typeof o=="boolean"||o===""?"":e||typeof o!="number"||o===0||Se.hasOwnProperty(r)&&Se[r]?(""+o).trim():o+"px"}function kd(r,o){r=r.style;for(var e in o)if(o.hasOwnProperty(e)){var t=e.indexOf("--")===0,n=yd(e,o[e],t);e==="float"&&(e="cssFloat"),t?r.setProperty(e,n):r[e]=n}}var ac=W({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function li(r,o){if(o){if(ac[r]&&(o.children!=null||o.dangerouslySetInnerHTML!=null))throw Error(h(137,r));if(o.dangerouslySetInnerHTML!=null){if(o.children!=null)throw Error(h(60));if(typeof o.dangerouslySetInnerHTML!="object"||!("__html"in o.dangerouslySetInnerHTML))throw Error(h(61))}if(o.style!=null&&typeof o.style!="object")throw Error(h(62))}}function di(r,o){if(r.indexOf("-")===-1)return typeof o.is=="string";switch(r){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}var si=null;function oa(r){return r=r.target||r.srcElement||window,r.correspondingUseElement&&(r=r.correspondingUseElement),r.nodeType===3?r.parentNode:r}var ci=null,Jo=null,Zo=null;function Ja(r){if(r=ot(r)){if(typeof ci!="function")throw Error(h(280));var o=r.stateNode;o&&(o=gn(o),ci(r.stateNode,r.type,o))}}function jd(r){Jo?Zo?Zo.push(r):Zo=[r]:Jo=r}function Nd(){if(Jo){var r=Jo,o=Zo;if(Zo=Jo=null,Ja(r),o)for(r=0;r<o.length;r++)Ja(o[r])}}function zd(r,o){return r(o)}function Sd(){}var En=!1;function Cd(r,o,e){if(En)return r(o,e);En=!0;try{return zd(r,o,e)}finally{En=!1,(Jo!==null||Zo!==null)&&(Sd(),Nd())}}function Be(r,o){var e=r.stateNode;if(e===null)return null;var t=gn(e);if(t===null)return null;e=t[o];r:switch(o){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(t=!t.disabled)||(r=r.type,t=!(r==="button"||r==="input"||r==="select"||r==="textarea")),r=!t;break r;default:r=!1}if(r)return null;if(e&&typeof e!="function")throw Error(h(231,o,typeof e));return e}var gi=!1;if(Qr)try{var fe={};Object.defineProperty(fe,"passive",{get:function(){gi=!0}}),window.addEventListener("test",fe,fe),window.removeEventListener("test",fe,fe)}catch{gi=!1}function lc(r,o,e,t,n,a,l,d,s){var g=Array.prototype.slice.call(arguments,3);try{o.apply(e,g)}catch(u){this.onError(u)}}var Ce=!1,Ft=null,Bt=!1,bi=null,dc={onError:function(r){Ce=!0,Ft=r}};function sc(r,o,e,t,n,a,l,d,s){Ce=!1,Ft=null,lc.apply(dc,arguments)}function cc(r,o,e,t,n,a,l,d,s){if(sc.apply(this,arguments),Ce){if(Ce){var g=Ft;Ce=!1,Ft=null}else throw Error(h(198));Bt||(Bt=!0,bi=g)}}function Ro(r){var o=r,e=r;if(r.alternate)for(;o.return;)o=o.return;else{r=o;do o=r,o.flags&4098&&(e=o.return),r=o.return;while(r)}return o.tag===3?e:null}function Ad(r){if(r.tag===13){var o=r.memoizedState;if(o===null&&(r=r.alternate,r!==null&&(o=r.memoizedState)),o!==null)return o.dehydrated}return null}function Za(r){if(Ro(r)!==r)throw Error(h(188))}function gc(r){var o=r.alternate;if(!o){if(o=Ro(r),o===null)throw Error(h(188));return o!==r?null:r}for(var e=r,t=o;;){var n=e.return;if(n===null)break;var a=n.alternate;if(a===null){if(t=n.return,t!==null){e=t;continue}break}if(n.child===a.child){for(a=n.child;a;){if(a===e)return Za(n),r;if(a===t)return Za(n),o;a=a.sibling}throw Error(h(188))}if(e.return!==t.return)e=n,t=a;else{for(var l=!1,d=n.child;d;){if(d===e){l=!0,e=n,t=a;break}if(d===t){l=!0,t=n,e=a;break}d=d.sibling}if(!l){for(d=a.child;d;){if(d===e){l=!0,e=a,t=n;break}if(d===t){l=!0,t=a,e=n;break}d=d.sibling}if(!l)throw Error(h(189))}}if(e.alternate!==t)throw Error(h(190))}if(e.tag!==3)throw Error(h(188));return e.stateNode.current===e?r:o}function Ed(r){return r=gc(r),r!==null?Td(r):null}function Td(r){if(r.tag===5||r.tag===6)return r;for(r=r.child;r!==null;){var o=Td(r);if(o!==null)return o;r=r.sibling}return null}var _d=vr.unstable_scheduleCallback,qa=vr.unstable_cancelCallback,bc=vr.unstable_shouldYield,pc=vr.unstable_requestPaint,X=vr.unstable_now,mc=vr.unstable_getCurrentPriorityLevel,ea=vr.unstable_ImmediatePriority,Ud=vr.unstable_UserBlockingPriority,Mt=vr.unstable_NormalPriority,fc=vr.unstable_LowPriority,Pd=vr.unstable_IdlePriority,ln=null,Dr=null;function wc(r){if(Dr&&typeof Dr.onCommitFiberRoot=="function")try{Dr.onCommitFiberRoot(ln,r,void 0,(r.current.flags&128)===128)}catch{}}var Rr=Math.clz32?Math.clz32:hc,uc=Math.log,xc=Math.LN2;function hc(r){return r>>>=0,r===0?32:31-(uc(r)/xc|0)|0}var st=64,ct=4194304;function Ne(r){switch(r&-r){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return r&4194240;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return r&130023424;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 1073741824;default:return r}}function Ot(r,o){var e=r.pendingLanes;if(e===0)return 0;var t=0,n=r.suspendedLanes,a=r.pingedLanes,l=e&268435455;if(l!==0){var d=l&~n;d!==0?t=Ne(d):(a&=l,a!==0&&(t=Ne(a)))}else l=e&~n,l!==0?t=Ne(l):a!==0&&(t=Ne(a));if(t===0)return 0;if(o!==0&&o!==t&&!(o&n)&&(n=t&-t,a=o&-o,n>=a||n===16&&(a&4194240)!==0))return o;if(t&4&&(t|=e&16),o=r.entangledLanes,o!==0)for(r=r.entanglements,o&=t;0<o;)e=31-Rr(o),n=1<<e,t|=r[e],o&=~n;return t}function vc(r,o){switch(r){case 1:case 2:case 4:return o+250;case 8:case 16:case 32:case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return o+5e3;case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:return-1;case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function yc(r,o){for(var e=r.suspendedLanes,t=r.pingedLanes,n=r.expirationTimes,a=r.pendingLanes;0<a;){var l=31-Rr(a),d=1<<l,s=n[l];s===-1?(!(d&e)||d&t)&&(n[l]=vc(d,o)):s<=o&&(r.expiredLanes|=d),a&=~d}}function pi(r){return r=r.pendingLanes&-1073741825,r!==0?r:r&1073741824?1073741824:0}function Ld(){var r=st;return st<<=1,!(st&4194240)&&(st=64),r}function Tn(r){for(var o=[],e=0;31>e;e++)o.push(r);return o}function qe(r,o,e){r.pendingLanes|=o,o!==536870912&&(r.suspendedLanes=0,r.pingedLanes=0),r=r.eventTimes,o=31-Rr(o),r[o]=e}function kc(r,o){var e=r.pendingLanes&~o;r.pendingLanes=o,r.suspendedLanes=0,r.pingedLanes=0,r.expiredLanes&=o,r.mutableReadLanes&=o,r.entangledLanes&=o,o=r.entanglements;var t=r.eventTimes;for(r=r.expirationTimes;0<e;){var n=31-Rr(e),a=1<<n;o[n]=0,t[n]=-1,r[n]=-1,e&=~a}}function ta(r,o){var e=r.entangledLanes|=o;for(r=r.entanglements;e;){var t=31-Rr(e),n=1<<t;n&o|r[t]&o&&(r[t]|=o),e&=~n}}var R=0;function Rd(r){return r&=-r,1<r?4<r?r&268435455?16:536870912:4:1}var Fd,na,Bd,Md,Od,mi=!1,gt=[],ao=null,lo=null,so=null,Me=new Map,Oe=new Map,eo=[],jc="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function rl(r,o){switch(r){case"focusin":case"focusout":ao=null;break;case"dragenter":case"dragleave":lo=null;break;case"mouseover":case"mouseout":so=null;break;case"pointerover":case"pointerout":Me.delete(o.pointerId);break;case"gotpointercapture":case"lostpointercapture":Oe.delete(o.pointerId)}}function we(r,o,e,t,n,a){return r===null||r.nativeEvent!==a?(r={blockedOn:o,domEventName:e,eventSystemFlags:t,nativeEvent:a,targetContainers:[n]},o!==null&&(o=ot(o),o!==null&&na(o)),r):(r.eventSystemFlags|=t,o=r.targetContainers,n!==null&&o.indexOf(n)===-1&&o.push(n),r)}function Nc(r,o,e,t,n){switch(o){case"focusin":return ao=we(ao,r,o,e,t,n),!0;case"dragenter":return lo=we(lo,r,o,e,t,n),!0;case"mouseover":return so=we(so,r,o,e,t,n),!0;case"pointerover":var a=n.pointerId;return Me.set(a,we(Me.get(a)||null,r,o,e,t,n)),!0;case"gotpointercapture":return a=n.pointerId,Oe.set(a,we(Oe.get(a)||null,r,o,e,t,n)),!0}return!1}function Id(r){var o=No(r.target);if(o!==null){var e=Ro(o);if(e!==null){if(o=e.tag,o===13){if(o=Ad(e),o!==null){r.blockedOn=o,Od(r.priority,function(){Bd(e)});return}}else if(o===3&&e.stateNode.current.memoizedState.isDehydrated){r.blockedOn=e.tag===3?e.stateNode.containerInfo:null;return}}}r.blockedOn=null}function zt(r){if(r.blockedOn!==null)return!1;for(var o=r.targetContainers;0<o.length;){var e=fi(r.domEventName,r.eventSystemFlags,o[0],r.nativeEvent);if(e===null){e=r.nativeEvent;var t=new e.constructor(e.type,e);si=t,e.target.dispatchEvent(t),si=null}else return o=ot(e),o!==null&&na(o),r.blockedOn=e,!1;o.shift()}return!0}function ol(r,o,e){zt(r)&&e.delete(o)}function zc(){mi=!1,ao!==null&&zt(ao)&&(ao=null),lo!==null&&zt(lo)&&(lo=null),so!==null&&zt(so)&&(so=null),Me.forEach(ol),Oe.forEach(ol)}function ue(r,o){r.blockedOn===o&&(r.blockedOn=null,mi||(mi=!0,vr.unstable_scheduleCallback(vr.unstable_NormalPriority,zc)))}function Ie(r){function o(n){return ue(n,r)}if(0<gt.length){ue(gt[0],r);for(var e=1;e<gt.length;e++){var t=gt[e];t.blockedOn===r&&(t.blockedOn=null)}}for(ao!==null&&ue(ao,r),lo!==null&&ue(lo,r),so!==null&&ue(so,r),Me.forEach(o),Oe.forEach(o),e=0;e<eo.length;e++)t=eo[e],t.blockedOn===r&&(t.blockedOn=null);for(;0<eo.length&&(e=eo[0],e.blockedOn===null);)Id(e),e.blockedOn===null&&eo.shift()}var qo=Zr.ReactCurrentBatchConfig,It=!0;function Sc(r,o,e,t){var n=R,a=qo.transition;qo.transition=null;try{R=1,ia(r,o,e,t)}finally{R=n,qo.transition=a}}function Cc(r,o,e,t){var n=R,a=qo.transition;qo.transition=null;try{R=4,ia(r,o,e,t)}finally{R=n,qo.transition=a}}function ia(r,o,e,t){if(It){var n=fi(r,o,e,t);if(n===null)In(r,o,t,Dt,e),rl(r,t);else if(Nc(n,r,o,e,t))t.stopPropagation();else if(rl(r,t),o&4&&-1<jc.indexOf(r)){for(;n!==null;){var a=ot(n);if(a!==null&&Fd(a),a=fi(r,o,e,t),a===null&&In(r,o,t,Dt,e),a===n)break;n=a}n!==null&&t.stopPropagation()}else In(r,o,t,null,e)}}var Dt=null;function fi(r,o,e,t){if(Dt=null,r=oa(t),r=No(r),r!==null)if(o=Ro(r),o===null)r=null;else if(e=o.tag,e===13){if(r=Ad(o),r!==null)return r;r=null}else if(e===3){if(o.stateNode.current.memoizedState.isDehydrated)return o.tag===3?o.stateNode.containerInfo:null;r=null}else o!==r&&(r=null);return Dt=r,null}function Dd(r){switch(r){case"cancel":case"click":case"close":case"contextmenu":case"copy":case"cut":case"auxclick":case"dblclick":case"dragend":case"dragstart":case"drop":case"focusin":case"focusout":case"input":case"invalid":case"keydown":case"keypress":case"keyup":case"mousedown":case"mouseup":case"paste":case"pause":case"play":case"pointercancel":case"pointerdown":case"pointerup":case"ratechange":case"reset":case"resize":case"seeked":case"submit":case"touchcancel":case"touchend":case"touchstart":case"volumechange":case"change":case"selectionchange":case"textInput":case"compositionstart":case"compositionend":case"compositionupdate":case"beforeblur":case"afterblur":case"beforeinput":case"blur":case"fullscreenchange":case"focus":case"hashchange":case"popstate":case"select":case"selectstart":return 1;case"drag":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"mousemove":case"mouseout":case"mouseover":case"pointermove":case"pointerout":case"pointerover":case"scroll":case"toggle":case"touchmove":case"wheel":case"mouseenter":case"mouseleave":case"pointerenter":case"pointerleave":return 4;case"message":switch(mc()){case ea:return 1;case Ud:return 4;case Mt:case fc:return 16;case Pd:return 536870912;default:return 16}default:return 16}}var no=null,aa=null,St=null;function $d(){if(St)return St;var r,o=aa,e=o.length,t,n="value"in no?no.value:no.textContent,a=n.length;for(r=0;r<e&&o[r]===n[r];r++);var l=e-r;for(t=1;t<=l&&o[e-t]===n[a-t];t++);return St=n.slice(r,1<t?1-t:void 0)}function Ct(r){var o=r.keyCode;return"charCode"in r?(r=r.charCode,r===0&&o===13&&(r=13)):r=o,r===10&&(r=13),32<=r||r===13?r:0}function bt(){return!0}function el(){return!1}function kr(r){function o(e,t,n,a,l){this._reactName=e,this._targetInst=n,this.type=t,this.nativeEvent=a,this.target=l,this.currentTarget=null;for(var d in r)r.hasOwnProperty(d)&&(e=r[d],this[d]=e?e(a):a[d]);return this.isDefaultPrevented=(a.defaultPrevented!=null?a.defaultPrevented:a.returnValue===!1)?bt:el,this.isPropagationStopped=el,this}return W(o.prototype,{preventDefault:function(){this.defaultPrevented=!0;var e=this.nativeEvent;e&&(e.preventDefault?e.preventDefault():typeof e.returnValue!="unknown"&&(e.returnValue=!1),this.isDefaultPrevented=bt)},stopPropagation:function(){var e=this.nativeEvent;e&&(e.stopPropagation?e.stopPropagation():typeof e.cancelBubble!="unknown"&&(e.cancelBubble=!0),this.isPropagationStopped=bt)},persist:function(){},isPersistent:bt}),o}var ce={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(r){return r.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},la=kr(ce),rt=W({},ce,{view:0,detail:0}),Ac=kr(rt),_n,Un,xe,dn=W({},rt,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:da,button:0,buttons:0,relatedTarget:function(r){return r.relatedTarget===void 0?r.fromElement===r.srcElement?r.toElement:r.fromElement:r.relatedTarget},movementX:function(r){return"movementX"in r?r.movementX:(r!==xe&&(xe&&r.type==="mousemove"?(_n=r.screenX-xe.screenX,Un=r.screenY-xe.screenY):Un=_n=0,xe=r),_n)},movementY:function(r){return"movementY"in r?r.movementY:Un}}),tl=kr(dn),Ec=W({},dn,{dataTransfer:0}),Tc=kr(Ec),_c=W({},rt,{relatedTarget:0}),Pn=kr(_c),Uc=W({},ce,{animationName:0,elapsedTime:0,pseudoElement:0}),Pc=kr(Uc),Lc=W({},ce,{clipboardData:function(r){return"clipboardData"in r?r.clipboardData:window.clipboardData}}),Rc=kr(Lc),Fc=W({},ce,{data:0}),nl=kr(Fc),Bc={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},Mc={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},Oc={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function Ic(r){var o=this.nativeEvent;return o.getModifierState?o.getModifierState(r):(r=Oc[r])?!!o[r]:!1}function da(){return Ic}var Dc=W({},rt,{key:function(r){if(r.key){var o=Bc[r.key]||r.key;if(o!=="Unidentified")return o}return r.type==="keypress"?(r=Ct(r),r===13?"Enter":String.fromCharCode(r)):r.type==="keydown"||r.type==="keyup"?Mc[r.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:da,charCode:function(r){return r.type==="keypress"?Ct(r):0},keyCode:function(r){return r.type==="keydown"||r.type==="keyup"?r.keyCode:0},which:function(r){return r.type==="keypress"?Ct(r):r.type==="keydown"||r.type==="keyup"?r.keyCode:0}}),$c=kr(Dc),Wc=W({},dn,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),il=kr(Wc),Hc=W({},rt,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:da}),Vc=kr(Hc),Yc=W({},ce,{propertyName:0,elapsedTime:0,pseudoElement:0}),Xc=kr(Yc),Qc=W({},dn,{deltaX:function(r){return"deltaX"in r?r.deltaX:"wheelDeltaX"in r?-r.wheelDeltaX:0},deltaY:function(r){return"deltaY"in r?r.deltaY:"wheelDeltaY"in r?-r.wheelDeltaY:"wheelDelta"in r?-r.wheelDelta:0},deltaZ:0,deltaMode:0}),Gc=kr(Qc),Kc=[9,13,27,32],sa=Qr&&"CompositionEvent"in window,Ae=null;Qr&&"documentMode"in document&&(Ae=document.documentMode);var Jc=Qr&&"TextEvent"in window&&!Ae,Wd=Qr&&(!sa||Ae&&8<Ae&&11>=Ae),al=" ",ll=!1;function Hd(r,o){switch(r){case"keyup":return Kc.indexOf(o.keyCode)!==-1;case"keydown":return o.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function Vd(r){return r=r.detail,typeof r=="object"&&"data"in r?r.data:null}var Oo=!1;function Zc(r,o){switch(r){case"compositionend":return Vd(o);case"keypress":return o.which!==32?null:(ll=!0,al);case"textInput":return r=o.data,r===al&&ll?null:r;default:return null}}function qc(r,o){if(Oo)return r==="compositionend"||!sa&&Hd(r,o)?(r=$d(),St=aa=no=null,Oo=!1,r):null;switch(r){case"paste":return null;case"keypress":if(!(o.ctrlKey||o.altKey||o.metaKey)||o.ctrlKey&&o.altKey){if(o.char&&1<o.char.length)return o.char;if(o.which)return String.fromCharCode(o.which)}return null;case"compositionend":return Wd&&o.locale!=="ko"?null:o.data;default:return null}}var rg={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function dl(r){var o=r&&r.nodeName&&r.nodeName.toLowerCase();return o==="input"?!!rg[r.type]:o==="textarea"}function Yd(r,o,e,t){jd(t),o=$t(o,"onChange"),0<o.length&&(e=new la("onChange","change",null,e,t),r.push({event:e,listeners:o}))}var Ee=null,De=null;function og(r){t0(r,0)}function sn(r){var o=$o(r);if(wd(o))return r}function eg(r,o){if(r==="change")return o}var Xd=!1;if(Qr){var Ln;if(Qr){var Rn="oninput"in document;if(!Rn){var sl=document.createElement("div");sl.setAttribute("oninput","return;"),Rn=typeof sl.oninput=="function"}Ln=Rn}else Ln=!1;Xd=Ln&&(!document.documentMode||9<document.documentMode)}function cl(){Ee&&(Ee.detachEvent("onpropertychange",Qd),De=Ee=null)}function Qd(r){if(r.propertyName==="value"&&sn(De)){var o=[];Yd(o,De,r,oa(r)),Cd(og,o)}}function tg(r,o,e){r==="focusin"?(cl(),Ee=o,De=e,Ee.attachEvent("onpropertychange",Qd)):r==="focusout"&&cl()}function ng(r){if(r==="selectionchange"||r==="keyup"||r==="keydown")return sn(De)}function ig(r,o){if(r==="click")return sn(o)}function ag(r,o){if(r==="input"||r==="change")return sn(o)}function lg(r,o){return r===o&&(r!==0||1/r===1/o)||r!==r&&o!==o}var Br=typeof Object.is=="function"?Object.is:lg;function $e(r,o){if(Br(r,o))return!0;if(typeof r!="object"||r===null||typeof o!="object"||o===null)return!1;var e=Object.keys(r),t=Object.keys(o);if(e.length!==t.length)return!1;for(t=0;t<e.length;t++){var n=e[t];if(!Jn.call(o,n)||!Br(r[n],o[n]))return!1}return!0}function gl(r){for(;r&&r.firstChild;)r=r.firstChild;return r}function bl(r,o){var e=gl(r);r=0;for(var t;e;){if(e.nodeType===3){if(t=r+e.textContent.length,r<=o&&t>=o)return{node:e,offset:o-r};r=t}r:{for(;e;){if(e.nextSibling){e=e.nextSibling;break r}e=e.parentNode}e=void 0}e=gl(e)}}function Gd(r,o){return r&&o?r===o?!0:r&&r.nodeType===3?!1:o&&o.nodeType===3?Gd(r,o.parentNode):"contains"in r?r.contains(o):r.compareDocumentPosition?!!(r.compareDocumentPosition(o)&16):!1:!1}function Kd(){for(var r=window,o=Rt();o instanceof r.HTMLIFrameElement;){try{var e=typeof o.contentWindow.location.href=="string"}catch{e=!1}if(e)r=o.contentWindow;else break;o=Rt(r.document)}return o}function ca(r){var o=r&&r.nodeName&&r.nodeName.toLowerCase();return o&&(o==="input"&&(r.type==="text"||r.type==="search"||r.type==="tel"||r.type==="url"||r.type==="password")||o==="textarea"||r.contentEditable==="true")}function dg(r){var o=Kd(),e=r.focusedElem,t=r.selectionRange;if(o!==e&&e&&e.ownerDocument&&Gd(e.ownerDocument.documentElement,e)){if(t!==null&&ca(e)){if(o=t.start,r=t.end,r===void 0&&(r=o),"selectionStart"in e)e.selectionStart=o,e.selectionEnd=Math.min(r,e.value.length);else if(r=(o=e.ownerDocument||document)&&o.defaultView||window,r.getSelection){r=r.getSelection();var n=e.textContent.length,a=Math.min(t.start,n);t=t.end===void 0?a:Math.min(t.end,n),!r.extend&&a>t&&(n=t,t=a,a=n),n=bl(e,a);var l=bl(e,t);n&&l&&(r.rangeCount!==1||r.anchorNode!==n.node||r.anchorOffset!==n.offset||r.focusNode!==l.node||r.focusOffset!==l.offset)&&(o=o.createRange(),o.setStart(n.node,n.offset),r.removeAllRanges(),a>t?(r.addRange(o),r.extend(l.node,l.offset)):(o.setEnd(l.node,l.offset),r.addRange(o)))}}for(o=[],r=e;r=r.parentNode;)r.nodeType===1&&o.push({element:r,left:r.scrollLeft,top:r.scrollTop});for(typeof e.focus=="function"&&e.focus(),e=0;e<o.length;e++)r=o[e],r.element.scrollLeft=r.left,r.element.scrollTop=r.top}}var sg=Qr&&"documentMode"in document&&11>=document.documentMode,Io=null,wi=null,Te=null,ui=!1;function pl(r,o,e){var t=e.window===e?e.document:e.nodeType===9?e:e.ownerDocument;ui||Io==null||Io!==Rt(t)||(t=Io,"selectionStart"in t&&ca(t)?t={start:t.selectionStart,end:t.selectionEnd}:(t=(t.ownerDocument&&t.ownerDocument.defaultView||window).getSelection(),t={anchorNode:t.anchorNode,anchorOffset:t.anchorOffset,focusNode:t.focusNode,focusOffset:t.focusOffset}),Te&&$e(Te,t)||(Te=t,t=$t(wi,"onSelect"),0<t.length&&(o=new la("onSelect","select",null,o,e),r.push({event:o,listeners:t}),o.target=Io)))}function pt(r,o){var e={};return e[r.toLowerCase()]=o.toLowerCase(),e["Webkit"+r]="webkit"+o,e["Moz"+r]="moz"+o,e}var Do={animationend:pt("Animation","AnimationEnd"),animationiteration:pt("Animation","AnimationIteration"),animationstart:pt("Animation","AnimationStart"),transitionend:pt("Transition","TransitionEnd")},Fn={},Jd={};Qr&&(Jd=document.createElement("div").style,"AnimationEvent"in window||(delete Do.animationend.animation,delete Do.animationiteration.animation,delete Do.animationstart.animation),"TransitionEvent"in window||delete Do.transitionend.transition);function cn(r){if(Fn[r])return Fn[r];if(!Do[r])return r;var o=Do[r],e;for(e in o)if(o.hasOwnProperty(e)&&e in Jd)return Fn[r]=o[e];return r}var Zd=cn("animationend"),qd=cn("animationiteration"),r0=cn("animationstart"),o0=cn("transitionend"),e0=new Map,ml="abort auxClick cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");function uo(r,o){e0.set(r,o),Lo(o,[r])}for(var Bn=0;Bn<ml.length;Bn++){var Mn=ml[Bn],cg=Mn.toLowerCase(),gg=Mn[0].toUpperCase()+Mn.slice(1);uo(cg,"on"+gg)}uo(Zd,"onAnimationEnd");uo(qd,"onAnimationIteration");uo(r0,"onAnimationStart");uo("dblclick","onDoubleClick");uo("focusin","onFocus");uo("focusout","onBlur");uo(o0,"onTransitionEnd");ee("onMouseEnter",["mouseout","mouseover"]);ee("onMouseLeave",["mouseout","mouseover"]);ee("onPointerEnter",["pointerout","pointerover"]);ee("onPointerLeave",["pointerout","pointerover"]);Lo("onChange","change click focusin focusout input keydown keyup selectionchange".split(" "));Lo("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" "));Lo("onBeforeInput",["compositionend","keypress","textInput","paste"]);Lo("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" "));Lo("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" "));Lo("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var ze="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),bg=new Set("cancel close invalid load scroll toggle".split(" ").concat(ze));function fl(r,o,e){var t=r.type||"unknown-event";r.currentTarget=e,cc(t,o,void 0,r),r.currentTarget=null}function t0(r,o){o=(o&4)!==0;for(var e=0;e<r.length;e++){var t=r[e],n=t.event;t=t.listeners;r:{var a=void 0;if(o)for(var l=t.length-1;0<=l;l--){var d=t[l],s=d.instance,g=d.currentTarget;if(d=d.listener,s!==a&&n.isPropagationStopped())break r;fl(n,d,g),a=s}else for(l=0;l<t.length;l++){if(d=t[l],s=d.instance,g=d.currentTarget,d=d.listener,s!==a&&n.isPropagationStopped())break r;fl(n,d,g),a=s}}}if(Bt)throw r=bi,Bt=!1,bi=null,r}function M(r,o){var e=o[ki];e===void 0&&(e=o[ki]=new Set);var t=r+"__bubble";e.has(t)||(n0(o,r,2,!1),e.add(t))}function On(r,o,e){var t=0;o&&(t|=4),n0(e,r,t,o)}var mt="_reactListening"+Math.random().toString(36).slice(2);function We(r){if(!r[mt]){r[mt]=!0,gd.forEach(function(e){e!=="selectionchange"&&(bg.has(e)||On(e,!1,r),On(e,!0,r))});var o=r.nodeType===9?r:r.ownerDocument;o===null||o[mt]||(o[mt]=!0,On("selectionchange",!1,o))}}function n0(r,o,e,t){switch(Dd(o)){case 1:var n=Sc;break;case 4:n=Cc;break;default:n=ia}e=n.bind(null,o,e,r),n=void 0,!gi||o!=="touchstart"&&o!=="touchmove"&&o!=="wheel"||(n=!0),t?n!==void 0?r.addEventListener(o,e,{capture:!0,passive:n}):r.addEventListener(o,e,!0):n!==void 0?r.addEventListener(o,e,{passive:n}):r.addEventListener(o,e,!1)}function In(r,o,e,t,n){var a=t;if(!(o&1)&&!(o&2)&&t!==null)r:for(;;){if(t===null)return;var l=t.tag;if(l===3||l===4){var d=t.stateNode.containerInfo;if(d===n||d.nodeType===8&&d.parentNode===n)break;if(l===4)for(l=t.return;l!==null;){var s=l.tag;if((s===3||s===4)&&(s=l.stateNode.containerInfo,s===n||s.nodeType===8&&s.parentNode===n))return;l=l.return}for(;d!==null;){if(l=No(d),l===null)return;if(s=l.tag,s===5||s===6){t=a=l;continue r}d=d.parentNode}}t=t.return}Cd(function(){var g=a,u=oa(e),w=[];r:{var f=e0.get(r);if(f!==void 0){var v=la,y=r;switch(r){case"keypress":if(Ct(e)===0)break r;case"keydown":case"keyup":v=$c;break;case"focusin":y="focus",v=Pn;break;case"focusout":y="blur",v=Pn;break;case"beforeblur":case"afterblur":v=Pn;break;case"click":if(e.button===2)break r;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":v=tl;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":v=Tc;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":v=Vc;break;case Zd:case qd:case r0:v=Pc;break;case o0:v=Xc;break;case"scroll":v=Ac;break;case"wheel":v=Gc;break;case"copy":case"cut":case"paste":v=Rc;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":v=il}var k=(o&4)!==0,F=!k&&r==="scroll",b=k?f!==null?f+"Capture":null:f;k=[];for(var c=g,p;c!==null;){p=c;var x=p.stateNode;if(p.tag===5&&x!==null&&(p=x,b!==null&&(x=Be(c,b),x!=null&&k.push(He(c,x,p)))),F)break;c=c.return}0<k.length&&(f=new v(f,y,null,e,u),w.push({event:f,listeners:k}))}}if(!(o&7)){r:{if(f=r==="mouseover"||r==="pointerover",v=r==="mouseout"||r==="pointerout",f&&e!==si&&(y=e.relatedTarget||e.fromElement)&&(No(y)||y[Gr]))break r;if((v||f)&&(f=u.window===u?u:(f=u.ownerDocument)?f.defaultView||f.parentWindow:window,v?(y=e.relatedTarget||e.toElement,v=g,y=y?No(y):null,y!==null&&(F=Ro(y),y!==F||y.tag!==5&&y.tag!==6)&&(y=null)):(v=null,y=g),v!==y)){if(k=tl,x="onMouseLeave",b="onMouseEnter",c="mouse",(r==="pointerout"||r==="pointerover")&&(k=il,x="onPointerLeave",b="onPointerEnter",c="pointer"),F=v==null?f:$o(v),p=y==null?f:$o(y),f=new k(x,c+"leave",v,e,u),f.target=F,f.relatedTarget=p,x=null,No(u)===g&&(k=new k(b,c+"enter",y,e,u),k.target=p,k.relatedTarget=F,x=k),F=x,v&&y)o:{for(k=v,b=y,c=0,p=k;p;p=Fo(p))c++;for(p=0,x=b;x;x=Fo(x))p++;for(;0<c-p;)k=Fo(k),c--;for(;0<p-c;)b=Fo(b),p--;for(;c--;){if(k===b||b!==null&&k===b.alternate)break o;k=Fo(k),b=Fo(b)}k=null}else k=null;v!==null&&wl(w,f,v,k,!1),y!==null&&F!==null&&wl(w,F,y,k,!0)}}r:{if(f=g?$o(g):window,v=f.nodeName&&f.nodeName.toLowerCase(),v==="select"||v==="input"&&f.type==="file")var N=eg;else if(dl(f))if(Xd)N=ag;else{N=ng;var S=tg}else(v=f.nodeName)&&v.toLowerCase()==="input"&&(f.type==="checkbox"||f.type==="radio")&&(N=ig);if(N&&(N=N(r,g))){Yd(w,N,e,u);break r}S&&S(r,f,g),r==="focusout"&&(S=f._wrapperState)&&S.controlled&&f.type==="number"&&ni(f,"number",f.value)}switch(S=g?$o(g):window,r){case"focusin":(dl(S)||S.contentEditable==="true")&&(Io=S,wi=g,Te=null);break;case"focusout":Te=wi=Io=null;break;case"mousedown":ui=!0;break;case"contextmenu":case"mouseup":case"dragend":ui=!1,pl(w,e,u);break;case"selectionchange":if(sg)break;case"keydown":case"keyup":pl(w,e,u)}var C;if(sa)r:{switch(r){case"compositionstart":var A="onCompositionStart";break r;case"compositionend":A="onCompositionEnd";break r;case"compositionupdate":A="onCompositionUpdate";break r}A=void 0}else Oo?Hd(r,e)&&(A="onCompositionEnd"):r==="keydown"&&e.keyCode===229&&(A="onCompositionStart");A&&(Wd&&e.locale!=="ko"&&(Oo||A!=="onCompositionStart"?A==="onCompositionEnd"&&Oo&&(C=$d()):(no=u,aa="value"in no?no.value:no.textContent,Oo=!0)),S=$t(g,A),0<S.length&&(A=new nl(A,r,null,e,u),w.push({event:A,listeners:S}),C?A.data=C:(C=Vd(e),C!==null&&(A.data=C)))),(C=Jc?Zc(r,e):qc(r,e))&&(g=$t(g,"onBeforeInput"),0<g.length&&(u=new nl("onBeforeInput","beforeinput",null,e,u),w.push({event:u,listeners:g}),u.data=C))}t0(w,o)})}function He(r,o,e){return{instance:r,listener:o,currentTarget:e}}function $t(r,o){for(var e=o+"Capture",t=[];r!==null;){var n=r,a=n.stateNode;n.tag===5&&a!==null&&(n=a,a=Be(r,e),a!=null&&t.unshift(He(r,a,n)),a=Be(r,o),a!=null&&t.push(He(r,a,n))),r=r.return}return t}function Fo(r){if(r===null)return null;do r=r.return;while(r&&r.tag!==5);return r||null}function wl(r,o,e,t,n){for(var a=o._reactName,l=[];e!==null&&e!==t;){var d=e,s=d.alternate,g=d.stateNode;if(s!==null&&s===t)break;d.tag===5&&g!==null&&(d=g,n?(s=Be(e,a),s!=null&&l.unshift(He(e,s,d))):n||(s=Be(e,a),s!=null&&l.push(He(e,s,d)))),e=e.return}l.length!==0&&r.push({event:o,listeners:l})}var pg=/\r\n?/g,mg=/\u0000|\uFFFD/g;function ul(r){return(typeof r=="string"?r:""+r).replace(pg,`
`).replace(mg,"")}function ft(r,o,e){if(o=ul(o),ul(r)!==o&&e)throw Error(h(425))}function Wt(){}var xi=null,hi=null;function vi(r,o){return r==="textarea"||r==="noscript"||typeof o.children=="string"||typeof o.children=="number"||typeof o.dangerouslySetInnerHTML=="object"&&o.dangerouslySetInnerHTML!==null&&o.dangerouslySetInnerHTML.__html!=null}var yi=typeof setTimeout=="function"?setTimeout:void 0,fg=typeof clearTimeout=="function"?clearTimeout:void 0,xl=typeof Promise=="function"?Promise:void 0,wg=typeof queueMicrotask=="function"?queueMicrotask:typeof xl<"u"?function(r){return xl.resolve(null).then(r).catch(ug)}:yi;function ug(r){setTimeout(function(){throw r})}function Dn(r,o){var e=o,t=0;do{var n=e.nextSibling;if(r.removeChild(e),n&&n.nodeType===8)if(e=n.data,e==="/$"){if(t===0){r.removeChild(n),Ie(o);return}t--}else e!=="$"&&e!=="$?"&&e!=="$!"||t++;e=n}while(e);Ie(o)}function co(r){for(;r!=null;r=r.nextSibling){var o=r.nodeType;if(o===1||o===3)break;if(o===8){if(o=r.data,o==="$"||o==="$!"||o==="$?")break;if(o==="/$")return null}}return r}function hl(r){r=r.previousSibling;for(var o=0;r;){if(r.nodeType===8){var e=r.data;if(e==="$"||e==="$!"||e==="$?"){if(o===0)return r;o--}else e==="/$"&&o++}r=r.previousSibling}return null}var ge=Math.random().toString(36).slice(2),Ir="__reactFiber$"+ge,Ve="__reactProps$"+ge,Gr="__reactContainer$"+ge,ki="__reactEvents$"+ge,xg="__reactListeners$"+ge,hg="__reactHandles$"+ge;function No(r){var o=r[Ir];if(o)return o;for(var e=r.parentNode;e;){if(o=e[Gr]||e[Ir]){if(e=o.alternate,o.child!==null||e!==null&&e.child!==null)for(r=hl(r);r!==null;){if(e=r[Ir])return e;r=hl(r)}return o}r=e,e=r.parentNode}return null}function ot(r){return r=r[Ir]||r[Gr],!r||r.tag!==5&&r.tag!==6&&r.tag!==13&&r.tag!==3?null:r}function $o(r){if(r.tag===5||r.tag===6)return r.stateNode;throw Error(h(33))}function gn(r){return r[Ve]||null}var ji=[],Wo=-1;function xo(r){return{current:r}}function O(r){0>Wo||(r.current=ji[Wo],ji[Wo]=null,Wo--)}function B(r,o){Wo++,ji[Wo]=r.current,r.current=o}var wo={},lr=xo(wo),mr=xo(!1),Eo=wo;function te(r,o){var e=r.type.contextTypes;if(!e)return wo;var t=r.stateNode;if(t&&t.__reactInternalMemoizedUnmaskedChildContext===o)return t.__reactInternalMemoizedMaskedChildContext;var n={},a;for(a in e)n[a]=o[a];return t&&(r=r.stateNode,r.__reactInternalMemoizedUnmaskedChildContext=o,r.__reactInternalMemoizedMaskedChildContext=n),n}function fr(r){return r=r.childContextTypes,r!=null}function Ht(){O(mr),O(lr)}function vl(r,o,e){if(lr.current!==wo)throw Error(h(168));B(lr,o),B(mr,e)}function i0(r,o,e){var t=r.stateNode;if(o=o.childContextTypes,typeof t.getChildContext!="function")return e;t=t.getChildContext();for(var n in t)if(!(n in o))throw Error(h(108,tc(r)||"Unknown",n));return W({},e,t)}function Vt(r){return r=(r=r.stateNode)&&r.__reactInternalMemoizedMergedChildContext||wo,Eo=lr.current,B(lr,r),B(mr,mr.current),!0}function yl(r,o,e){var t=r.stateNode;if(!t)throw Error(h(169));e?(r=i0(r,o,Eo),t.__reactInternalMemoizedMergedChildContext=r,O(mr),O(lr),B(lr,r)):O(mr),B(mr,e)}var Hr=null,bn=!1,$n=!1;function a0(r){Hr===null?Hr=[r]:Hr.push(r)}function vg(r){bn=!0,a0(r)}function ho(){if(!$n&&Hr!==null){$n=!0;var r=0,o=R;try{var e=Hr;for(R=1;r<e.length;r++){var t=e[r];do t=t(!0);while(t!==null)}Hr=null,bn=!1}catch(n){throw Hr!==null&&(Hr=Hr.slice(r+1)),_d(ea,ho),n}finally{R=o,$n=!1}}return null}var Ho=[],Vo=0,Yt=null,Xt=0,Nr=[],zr=0,To=null,Vr=1,Yr="";function ko(r,o){Ho[Vo++]=Xt,Ho[Vo++]=Yt,Yt=r,Xt=o}function l0(r,o,e){Nr[zr++]=Vr,Nr[zr++]=Yr,Nr[zr++]=To,To=r;var t=Vr;r=Yr;var n=32-Rr(t)-1;t&=~(1<<n),e+=1;var a=32-Rr(o)+n;if(30<a){var l=n-n%5;a=(t&(1<<l)-1).toString(32),t>>=l,n-=l,Vr=1<<32-Rr(o)+n|e<<n|t,Yr=a+r}else Vr=1<<a|e<<n|t,Yr=r}function ga(r){r.return!==null&&(ko(r,1),l0(r,1,0))}function ba(r){for(;r===Yt;)Yt=Ho[--Vo],Ho[Vo]=null,Xt=Ho[--Vo],Ho[Vo]=null;for(;r===To;)To=Nr[--zr],Nr[zr]=null,Yr=Nr[--zr],Nr[zr]=null,Vr=Nr[--zr],Nr[zr]=null}var hr=null,xr=null,I=!1,Lr=null;function d0(r,o){var e=Sr(5,null,null,0);e.elementType="DELETED",e.stateNode=o,e.return=r,o=r.deletions,o===null?(r.deletions=[e],r.flags|=16):o.push(e)}function kl(r,o){switch(r.tag){case 5:var e=r.type;return o=o.nodeType!==1||e.toLowerCase()!==o.nodeName.toLowerCase()?null:o,o!==null?(r.stateNode=o,hr=r,xr=co(o.firstChild),!0):!1;case 6:return o=r.pendingProps===""||o.nodeType!==3?null:o,o!==null?(r.stateNode=o,hr=r,xr=null,!0):!1;case 13:return o=o.nodeType!==8?null:o,o!==null?(e=To!==null?{id:Vr,overflow:Yr}:null,r.memoizedState={dehydrated:o,treeContext:e,retryLane:1073741824},e=Sr(18,null,null,0),e.stateNode=o,e.return=r,r.child=e,hr=r,xr=null,!0):!1;default:return!1}}function Ni(r){return(r.mode&1)!==0&&(r.flags&128)===0}function zi(r){if(I){var o=xr;if(o){var e=o;if(!kl(r,o)){if(Ni(r))throw Error(h(418));o=co(e.nextSibling);var t=hr;o&&kl(r,o)?d0(t,e):(r.flags=r.flags&-4097|2,I=!1,hr=r)}}else{if(Ni(r))throw Error(h(418));r.flags=r.flags&-4097|2,I=!1,hr=r}}}function jl(r){for(r=r.return;r!==null&&r.tag!==5&&r.tag!==3&&r.tag!==13;)r=r.return;hr=r}function wt(r){if(r!==hr)return!1;if(!I)return jl(r),I=!0,!1;var o;if((o=r.tag!==3)&&!(o=r.tag!==5)&&(o=r.type,o=o!=="head"&&o!=="body"&&!vi(r.type,r.memoizedProps)),o&&(o=xr)){if(Ni(r))throw s0(),Error(h(418));for(;o;)d0(r,o),o=co(o.nextSibling)}if(jl(r),r.tag===13){if(r=r.memoizedState,r=r!==null?r.dehydrated:null,!r)throw Error(h(317));r:{for(r=r.nextSibling,o=0;r;){if(r.nodeType===8){var e=r.data;if(e==="/$"){if(o===0){xr=co(r.nextSibling);break r}o--}else e!=="$"&&e!=="$!"&&e!=="$?"||o++}r=r.nextSibling}xr=null}}else xr=hr?co(r.stateNode.nextSibling):null;return!0}function s0(){for(var r=xr;r;)r=co(r.nextSibling)}function ne(){xr=hr=null,I=!1}function pa(r){Lr===null?Lr=[r]:Lr.push(r)}var yg=Zr.ReactCurrentBatchConfig;function he(r,o,e){if(r=e.ref,r!==null&&typeof r!="function"&&typeof r!="object"){if(e._owner){if(e=e._owner,e){if(e.tag!==1)throw Error(h(309));var t=e.stateNode}if(!t)throw Error(h(147,r));var n=t,a=""+r;return o!==null&&o.ref!==null&&typeof o.ref=="function"&&o.ref._stringRef===a?o.ref:(o=function(l){var d=n.refs;l===null?delete d[a]:d[a]=l},o._stringRef=a,o)}if(typeof r!="string")throw Error(h(284));if(!e._owner)throw Error(h(290,r))}return r}function ut(r,o){throw r=Object.prototype.toString.call(o),Error(h(31,r==="[object Object]"?"object with keys {"+Object.keys(o).join(", ")+"}":r))}function Nl(r){var o=r._init;return o(r._payload)}function c0(r){function o(b,c){if(r){var p=b.deletions;p===null?(b.deletions=[c],b.flags|=16):p.push(c)}}function e(b,c){if(!r)return null;for(;c!==null;)o(b,c),c=c.sibling;return null}function t(b,c){for(b=new Map;c!==null;)c.key!==null?b.set(c.key,c):b.set(c.index,c),c=c.sibling;return b}function n(b,c){return b=mo(b,c),b.index=0,b.sibling=null,b}function a(b,c,p){return b.index=p,r?(p=b.alternate,p!==null?(p=p.index,p<c?(b.flags|=2,c):p):(b.flags|=2,c)):(b.flags|=1048576,c)}function l(b){return r&&b.alternate===null&&(b.flags|=2),b}function d(b,c,p,x){return c===null||c.tag!==6?(c=Gn(p,b.mode,x),c.return=b,c):(c=n(c,p),c.return=b,c)}function s(b,c,p,x){var N=p.type;return N===Mo?u(b,c,p.props.children,x,p.key):c!==null&&(c.elementType===N||typeof N=="object"&&N!==null&&N.$$typeof===ro&&Nl(N)===c.type)?(x=n(c,p.props),x.ref=he(b,c,p),x.return=b,x):(x=Lt(p.type,p.key,p.props,null,b.mode,x),x.ref=he(b,c,p),x.return=b,x)}function g(b,c,p,x){return c===null||c.tag!==4||c.stateNode.containerInfo!==p.containerInfo||c.stateNode.implementation!==p.implementation?(c=Kn(p,b.mode,x),c.return=b,c):(c=n(c,p.children||[]),c.return=b,c)}function u(b,c,p,x,N){return c===null||c.tag!==7?(c=Ao(p,b.mode,x,N),c.return=b,c):(c=n(c,p),c.return=b,c)}function w(b,c,p){if(typeof c=="string"&&c!==""||typeof c=="number")return c=Gn(""+c,b.mode,p),c.return=b,c;if(typeof c=="object"&&c!==null){switch(c.$$typeof){case at:return p=Lt(c.type,c.key,c.props,null,b.mode,p),p.ref=he(b,null,c),p.return=b,p;case Bo:return c=Kn(c,b.mode,p),c.return=b,c;case ro:var x=c._init;return w(b,x(c._payload),p)}if(je(c)||me(c))return c=Ao(c,b.mode,p,null),c.return=b,c;ut(b,c)}return null}function f(b,c,p,x){var N=c!==null?c.key:null;if(typeof p=="string"&&p!==""||typeof p=="number")return N!==null?null:d(b,c,""+p,x);if(typeof p=="object"&&p!==null){switch(p.$$typeof){case at:return p.key===N?s(b,c,p,x):null;case Bo:return p.key===N?g(b,c,p,x):null;case ro:return N=p._init,f(b,c,N(p._payload),x)}if(je(p)||me(p))return N!==null?null:u(b,c,p,x,null);ut(b,p)}return null}function v(b,c,p,x,N){if(typeof x=="string"&&x!==""||typeof x=="number")return b=b.get(p)||null,d(c,b,""+x,N);if(typeof x=="object"&&x!==null){switch(x.$$typeof){case at:return b=b.get(x.key===null?p:x.key)||null,s(c,b,x,N);case Bo:return b=b.get(x.key===null?p:x.key)||null,g(c,b,x,N);case ro:var S=x._init;return v(b,c,p,S(x._payload),N)}if(je(x)||me(x))return b=b.get(p)||null,u(c,b,x,N,null);ut(c,x)}return null}function y(b,c,p,x){for(var N=null,S=null,C=c,A=c=0,V=null;C!==null&&A<p.length;A++){C.index>A?(V=C,C=null):V=C.sibling;var P=f(b,C,p[A],x);if(P===null){C===null&&(C=V);break}r&&C&&P.alternate===null&&o(b,C),c=a(P,c,A),S===null?N=P:S.sibling=P,S=P,C=V}if(A===p.length)return e(b,C),I&&ko(b,A),N;if(C===null){for(;A<p.length;A++)C=w(b,p[A],x),C!==null&&(c=a(C,c,A),S===null?N=C:S.sibling=C,S=C);return I&&ko(b,A),N}for(C=t(b,C);A<p.length;A++)V=v(C,b,A,p[A],x),V!==null&&(r&&V.alternate!==null&&C.delete(V.key===null?A:V.key),c=a(V,c,A),S===null?N=V:S.sibling=V,S=V);return r&&C.forEach(function(Tr){return o(b,Tr)}),I&&ko(b,A),N}function k(b,c,p,x){var N=me(p);if(typeof N!="function")throw Error(h(150));if(p=N.call(p),p==null)throw Error(h(151));for(var S=N=null,C=c,A=c=0,V=null,P=p.next();C!==null&&!P.done;A++,P=p.next()){C.index>A?(V=C,C=null):V=C.sibling;var Tr=f(b,C,P.value,x);if(Tr===null){C===null&&(C=V);break}r&&C&&Tr.alternate===null&&o(b,C),c=a(Tr,c,A),S===null?N=Tr:S.sibling=Tr,S=Tr,C=V}if(P.done)return e(b,C),I&&ko(b,A),N;if(C===null){for(;!P.done;A++,P=p.next())P=w(b,P.value,x),P!==null&&(c=a(P,c,A),S===null?N=P:S.sibling=P,S=P);return I&&ko(b,A),N}for(C=t(b,C);!P.done;A++,P=p.next())P=v(C,b,A,P.value,x),P!==null&&(r&&P.alternate!==null&&C.delete(P.key===null?A:P.key),c=a(P,c,A),S===null?N=P:S.sibling=P,S=P);return r&&C.forEach(function(be){return o(b,be)}),I&&ko(b,A),N}function F(b,c,p,x){if(typeof p=="object"&&p!==null&&p.type===Mo&&p.key===null&&(p=p.props.children),typeof p=="object"&&p!==null){switch(p.$$typeof){case at:r:{for(var N=p.key,S=c;S!==null;){if(S.key===N){if(N=p.type,N===Mo){if(S.tag===7){e(b,S.sibling),c=n(S,p.props.children),c.return=b,b=c;break r}}else if(S.elementType===N||typeof N=="object"&&N!==null&&N.$$typeof===ro&&Nl(N)===S.type){e(b,S.sibling),c=n(S,p.props),c.ref=he(b,S,p),c.return=b,b=c;break r}e(b,S);break}else o(b,S);S=S.sibling}p.type===Mo?(c=Ao(p.props.children,b.mode,x,p.key),c.return=b,b=c):(x=Lt(p.type,p.key,p.props,null,b.mode,x),x.ref=he(b,c,p),x.return=b,b=x)}return l(b);case Bo:r:{for(S=p.key;c!==null;){if(c.key===S)if(c.tag===4&&c.stateNode.containerInfo===p.containerInfo&&c.stateNode.implementation===p.implementation){e(b,c.sibling),c=n(c,p.children||[]),c.return=b,b=c;break r}else{e(b,c);break}else o(b,c);c=c.sibling}c=Kn(p,b.mode,x),c.return=b,b=c}return l(b);case ro:return S=p._init,F(b,c,S(p._payload),x)}if(je(p))return y(b,c,p,x);if(me(p))return k(b,c,p,x);ut(b,p)}return typeof p=="string"&&p!==""||typeof p=="number"?(p=""+p,c!==null&&c.tag===6?(e(b,c.sibling),c=n(c,p),c.return=b,b=c):(e(b,c),c=Gn(p,b.mode,x),c.return=b,b=c),l(b)):e(b,c)}return F}var ie=c0(!0),g0=c0(!1),Qt=xo(null),Gt=null,Yo=null,ma=null;function fa(){ma=Yo=Gt=null}function wa(r){var o=Qt.current;O(Qt),r._currentValue=o}function Si(r,o,e){for(;r!==null;){var t=r.alternate;if((r.childLanes&o)!==o?(r.childLanes|=o,t!==null&&(t.childLanes|=o)):t!==null&&(t.childLanes&o)!==o&&(t.childLanes|=o),r===e)break;r=r.return}}function re(r,o){Gt=r,ma=Yo=null,r=r.dependencies,r!==null&&r.firstContext!==null&&(r.lanes&o&&(pr=!0),r.firstContext=null)}function Ar(r){var o=r._currentValue;if(ma!==r)if(r={context:r,memoizedValue:o,next:null},Yo===null){if(Gt===null)throw Error(h(308));Yo=r,Gt.dependencies={lanes:0,firstContext:r}}else Yo=Yo.next=r;return o}var zo=null;function ua(r){zo===null?zo=[r]:zo.push(r)}function b0(r,o,e,t){var n=o.interleaved;return n===null?(e.next=e,ua(o)):(e.next=n.next,n.next=e),o.interleaved=e,Kr(r,t)}function Kr(r,o){r.lanes|=o;var e=r.alternate;for(e!==null&&(e.lanes|=o),e=r,r=r.return;r!==null;)r.childLanes|=o,e=r.alternate,e!==null&&(e.childLanes|=o),e=r,r=r.return;return e.tag===3?e.stateNode:null}var oo=!1;function xa(r){r.updateQueue={baseState:r.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null,interleaved:null,lanes:0},effects:null}}function p0(r,o){r=r.updateQueue,o.updateQueue===r&&(o.updateQueue={baseState:r.baseState,firstBaseUpdate:r.firstBaseUpdate,lastBaseUpdate:r.lastBaseUpdate,shared:r.shared,effects:r.effects})}function Xr(r,o){return{eventTime:r,lane:o,tag:0,payload:null,callback:null,next:null}}function go(r,o,e){var t=r.updateQueue;if(t===null)return null;if(t=t.shared,L&2){var n=t.pending;return n===null?o.next=o:(o.next=n.next,n.next=o),t.pending=o,Kr(r,e)}return n=t.interleaved,n===null?(o.next=o,ua(t)):(o.next=n.next,n.next=o),t.interleaved=o,Kr(r,e)}function At(r,o,e){if(o=o.updateQueue,o!==null&&(o=o.shared,(e&4194240)!==0)){var t=o.lanes;t&=r.pendingLanes,e|=t,o.lanes=e,ta(r,e)}}function zl(r,o){var e=r.updateQueue,t=r.alternate;if(t!==null&&(t=t.updateQueue,e===t)){var n=null,a=null;if(e=e.firstBaseUpdate,e!==null){do{var l={eventTime:e.eventTime,lane:e.lane,tag:e.tag,payload:e.payload,callback:e.callback,next:null};a===null?n=a=l:a=a.next=l,e=e.next}while(e!==null);a===null?n=a=o:a=a.next=o}else n=a=o;e={baseState:t.baseState,firstBaseUpdate:n,lastBaseUpdate:a,shared:t.shared,effects:t.effects},r.updateQueue=e;return}r=e.lastBaseUpdate,r===null?e.firstBaseUpdate=o:r.next=o,e.lastBaseUpdate=o}function Kt(r,o,e,t){var n=r.updateQueue;oo=!1;var a=n.firstBaseUpdate,l=n.lastBaseUpdate,d=n.shared.pending;if(d!==null){n.shared.pending=null;var s=d,g=s.next;s.next=null,l===null?a=g:l.next=g,l=s;var u=r.alternate;u!==null&&(u=u.updateQueue,d=u.lastBaseUpdate,d!==l&&(d===null?u.firstBaseUpdate=g:d.next=g,u.lastBaseUpdate=s))}if(a!==null){var w=n.baseState;l=0,u=g=s=null,d=a;do{var f=d.lane,v=d.eventTime;if((t&f)===f){u!==null&&(u=u.next={eventTime:v,lane:0,tag:d.tag,payload:d.payload,callback:d.callback,next:null});r:{var y=r,k=d;switch(f=o,v=e,k.tag){case 1:if(y=k.payload,typeof y=="function"){w=y.call(v,w,f);break r}w=y;break r;case 3:y.flags=y.flags&-65537|128;case 0:if(y=k.payload,f=typeof y=="function"?y.call(v,w,f):y,f==null)break r;w=W({},w,f);break r;case 2:oo=!0}}d.callback!==null&&d.lane!==0&&(r.flags|=64,f=n.effects,f===null?n.effects=[d]:f.push(d))}else v={eventTime:v,lane:f,tag:d.tag,payload:d.payload,callback:d.callback,next:null},u===null?(g=u=v,s=w):u=u.next=v,l|=f;if(d=d.next,d===null){if(d=n.shared.pending,d===null)break;f=d,d=f.next,f.next=null,n.lastBaseUpdate=f,n.shared.pending=null}}while(!0);if(u===null&&(s=w),n.baseState=s,n.firstBaseUpdate=g,n.lastBaseUpdate=u,o=n.shared.interleaved,o!==null){n=o;do l|=n.lane,n=n.next;while(n!==o)}else a===null&&(n.shared.lanes=0);Uo|=l,r.lanes=l,r.memoizedState=w}}function Sl(r,o,e){if(r=o.effects,o.effects=null,r!==null)for(o=0;o<r.length;o++){var t=r[o],n=t.callback;if(n!==null){if(t.callback=null,t=e,typeof n!="function")throw Error(h(191,n));n.call(t)}}}var et={},$r=xo(et),Ye=xo(et),Xe=xo(et);function So(r){if(r===et)throw Error(h(174));return r}function ha(r,o){switch(B(Xe,o),B(Ye,r),B($r,et),r=o.nodeType,r){case 9:case 11:o=(o=o.documentElement)?o.namespaceURI:ai(null,"");break;default:r=r===8?o.parentNode:o,o=r.namespaceURI||null,r=r.tagName,o=ai(o,r)}O($r),B($r,o)}function ae(){O($r),O(Ye),O(Xe)}function m0(r){So(Xe.current);var o=So($r.current),e=ai(o,r.type);o!==e&&(B(Ye,r),B($r,e))}function va(r){Ye.current===r&&(O($r),O(Ye))}var D=xo(0);function Jt(r){for(var o=r;o!==null;){if(o.tag===13){var e=o.memoizedState;if(e!==null&&(e=e.dehydrated,e===null||e.data==="$?"||e.data==="$!"))return o}else if(o.tag===19&&o.memoizedProps.revealOrder!==void 0){if(o.flags&128)return o}else if(o.child!==null){o.child.return=o,o=o.child;continue}if(o===r)break;for(;o.sibling===null;){if(o.return===null||o.return===r)return null;o=o.return}o.sibling.return=o.return,o=o.sibling}return null}var Wn=[];function ya(){for(var r=0;r<Wn.length;r++)Wn[r]._workInProgressVersionPrimary=null;Wn.length=0}var Et=Zr.ReactCurrentDispatcher,Hn=Zr.ReactCurrentBatchConfig,_o=0,$=null,K=null,q=null,Zt=!1,_e=!1,Qe=0,kg=0;function nr(){throw Error(h(321))}function ka(r,o){if(o===null)return!1;for(var e=0;e<o.length&&e<r.length;e++)if(!Br(r[e],o[e]))return!1;return!0}function ja(r,o,e,t,n,a){if(_o=a,$=o,o.memoizedState=null,o.updateQueue=null,o.lanes=0,Et.current=r===null||r.memoizedState===null?Sg:Cg,r=e(t,n),_e){a=0;do{if(_e=!1,Qe=0,25<=a)throw Error(h(301));a+=1,q=K=null,o.updateQueue=null,Et.current=Ag,r=e(t,n)}while(_e)}if(Et.current=qt,o=K!==null&&K.next!==null,_o=0,q=K=$=null,Zt=!1,o)throw Error(h(300));return r}function Na(){var r=Qe!==0;return Qe=0,r}function Or(){var r={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return q===null?$.memoizedState=q=r:q=q.next=r,q}function Er(){if(K===null){var r=$.alternate;r=r!==null?r.memoizedState:null}else r=K.next;var o=q===null?$.memoizedState:q.next;if(o!==null)q=o,K=r;else{if(r===null)throw Error(h(310));K=r,r={memoizedState:K.memoizedState,baseState:K.baseState,baseQueue:K.baseQueue,queue:K.queue,next:null},q===null?$.memoizedState=q=r:q=q.next=r}return q}function Ge(r,o){return typeof o=="function"?o(r):o}function Vn(r){var o=Er(),e=o.queue;if(e===null)throw Error(h(311));e.lastRenderedReducer=r;var t=K,n=t.baseQueue,a=e.pending;if(a!==null){if(n!==null){var l=n.next;n.next=a.next,a.next=l}t.baseQueue=n=a,e.pending=null}if(n!==null){a=n.next,t=t.baseState;var d=l=null,s=null,g=a;do{var u=g.lane;if((_o&u)===u)s!==null&&(s=s.next={lane:0,action:g.action,hasEagerState:g.hasEagerState,eagerState:g.eagerState,next:null}),t=g.hasEagerState?g.eagerState:r(t,g.action);else{var w={lane:u,action:g.action,hasEagerState:g.hasEagerState,eagerState:g.eagerState,next:null};s===null?(d=s=w,l=t):s=s.next=w,$.lanes|=u,Uo|=u}g=g.next}while(g!==null&&g!==a);s===null?l=t:s.next=d,Br(t,o.memoizedState)||(pr=!0),o.memoizedState=t,o.baseState=l,o.baseQueue=s,e.lastRenderedState=t}if(r=e.interleaved,r!==null){n=r;do a=n.lane,$.lanes|=a,Uo|=a,n=n.next;while(n!==r)}else n===null&&(e.lanes=0);return[o.memoizedState,e.dispatch]}function Yn(r){var o=Er(),e=o.queue;if(e===null)throw Error(h(311));e.lastRenderedReducer=r;var t=e.dispatch,n=e.pending,a=o.memoizedState;if(n!==null){e.pending=null;var l=n=n.next;do a=r(a,l.action),l=l.next;while(l!==n);Br(a,o.memoizedState)||(pr=!0),o.memoizedState=a,o.baseQueue===null&&(o.baseState=a),e.lastRenderedState=a}return[a,t]}function f0(){}function w0(r,o){var e=$,t=Er(),n=o(),a=!Br(t.memoizedState,n);if(a&&(t.memoizedState=n,pr=!0),t=t.queue,za(h0.bind(null,e,t,r),[r]),t.getSnapshot!==o||a||q!==null&&q.memoizedState.tag&1){if(e.flags|=2048,Ke(9,x0.bind(null,e,t,n,o),void 0,null),rr===null)throw Error(h(349));_o&30||u0(e,o,n)}return n}function u0(r,o,e){r.flags|=16384,r={getSnapshot:o,value:e},o=$.updateQueue,o===null?(o={lastEffect:null,stores:null},$.updateQueue=o,o.stores=[r]):(e=o.stores,e===null?o.stores=[r]:e.push(r))}function x0(r,o,e,t){o.value=e,o.getSnapshot=t,v0(o)&&y0(r)}function h0(r,o,e){return e(function(){v0(o)&&y0(r)})}function v0(r){var o=r.getSnapshot;r=r.value;try{var e=o();return!Br(r,e)}catch{return!0}}function y0(r){var o=Kr(r,1);o!==null&&Fr(o,r,1,-1)}function Cl(r){var o=Or();return typeof r=="function"&&(r=r()),o.memoizedState=o.baseState=r,r={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:Ge,lastRenderedState:r},o.queue=r,r=r.dispatch=zg.bind(null,$,r),[o.memoizedState,r]}function Ke(r,o,e,t){return r={tag:r,create:o,destroy:e,deps:t,next:null},o=$.updateQueue,o===null?(o={lastEffect:null,stores:null},$.updateQueue=o,o.lastEffect=r.next=r):(e=o.lastEffect,e===null?o.lastEffect=r.next=r:(t=e.next,e.next=r,r.next=t,o.lastEffect=r)),r}function k0(){return Er().memoizedState}function Tt(r,o,e,t){var n=Or();$.flags|=r,n.memoizedState=Ke(1|o,e,void 0,t===void 0?null:t)}function pn(r,o,e,t){var n=Er();t=t===void 0?null:t;var a=void 0;if(K!==null){var l=K.memoizedState;if(a=l.destroy,t!==null&&ka(t,l.deps)){n.memoizedState=Ke(o,e,a,t);return}}$.flags|=r,n.memoizedState=Ke(1|o,e,a,t)}function Al(r,o){return Tt(8390656,8,r,o)}function za(r,o){return pn(2048,8,r,o)}function j0(r,o){return pn(4,2,r,o)}function N0(r,o){return pn(4,4,r,o)}function z0(r,o){if(typeof o=="function")return r=r(),o(r),function(){o(null)};if(o!=null)return r=r(),o.current=r,function(){o.current=null}}function S0(r,o,e){return e=e!=null?e.concat([r]):null,pn(4,4,z0.bind(null,o,r),e)}function Sa(){}function C0(r,o){var e=Er();o=o===void 0?null:o;var t=e.memoizedState;return t!==null&&o!==null&&ka(o,t[1])?t[0]:(e.memoizedState=[r,o],r)}function A0(r,o){var e=Er();o=o===void 0?null:o;var t=e.memoizedState;return t!==null&&o!==null&&ka(o,t[1])?t[0]:(r=r(),e.memoizedState=[r,o],r)}function E0(r,o,e){return _o&21?(Br(e,o)||(e=Ld(),$.lanes|=e,Uo|=e,r.baseState=!0),o):(r.baseState&&(r.baseState=!1,pr=!0),r.memoizedState=e)}function jg(r,o){var e=R;R=e!==0&&4>e?e:4,r(!0);var t=Hn.transition;Hn.transition={};try{r(!1),o()}finally{R=e,Hn.transition=t}}function T0(){return Er().memoizedState}function Ng(r,o,e){var t=po(r);if(e={lane:t,action:e,hasEagerState:!1,eagerState:null,next:null},_0(r))U0(o,e);else if(e=b0(r,o,e,t),e!==null){var n=sr();Fr(e,r,t,n),P0(e,o,t)}}function zg(r,o,e){var t=po(r),n={lane:t,action:e,hasEagerState:!1,eagerState:null,next:null};if(_0(r))U0(o,n);else{var a=r.alternate;if(r.lanes===0&&(a===null||a.lanes===0)&&(a=o.lastRenderedReducer,a!==null))try{var l=o.lastRenderedState,d=a(l,e);if(n.hasEagerState=!0,n.eagerState=d,Br(d,l)){var s=o.interleaved;s===null?(n.next=n,ua(o)):(n.next=s.next,s.next=n),o.interleaved=n;return}}catch{}finally{}e=b0(r,o,n,t),e!==null&&(n=sr(),Fr(e,r,t,n),P0(e,o,t))}}function _0(r){var o=r.alternate;return r===$||o!==null&&o===$}function U0(r,o){_e=Zt=!0;var e=r.pending;e===null?o.next=o:(o.next=e.next,e.next=o),r.pending=o}function P0(r,o,e){if(e&4194240){var t=o.lanes;t&=r.pendingLanes,e|=t,o.lanes=e,ta(r,e)}}var qt={readContext:Ar,useCallback:nr,useContext:nr,useEffect:nr,useImperativeHandle:nr,useInsertionEffect:nr,useLayoutEffect:nr,useMemo:nr,useReducer:nr,useRef:nr,useState:nr,useDebugValue:nr,useDeferredValue:nr,useTransition:nr,useMutableSource:nr,useSyncExternalStore:nr,useId:nr,unstable_isNewReconciler:!1},Sg={readContext:Ar,useCallback:function(r,o){return Or().memoizedState=[r,o===void 0?null:o],r},useContext:Ar,useEffect:Al,useImperativeHandle:function(r,o,e){return e=e!=null?e.concat([r]):null,Tt(4194308,4,z0.bind(null,o,r),e)},useLayoutEffect:function(r,o){return Tt(4194308,4,r,o)},useInsertionEffect:function(r,o){return Tt(4,2,r,o)},useMemo:function(r,o){var e=Or();return o=o===void 0?null:o,r=r(),e.memoizedState=[r,o],r},useReducer:function(r,o,e){var t=Or();return o=e!==void 0?e(o):o,t.memoizedState=t.baseState=o,r={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:r,lastRenderedState:o},t.queue=r,r=r.dispatch=Ng.bind(null,$,r),[t.memoizedState,r]},useRef:function(r){var o=Or();return r={current:r},o.memoizedState=r},useState:Cl,useDebugValue:Sa,useDeferredValue:function(r){return Or().memoizedState=r},useTransition:function(){var r=Cl(!1),o=r[0];return r=jg.bind(null,r[1]),Or().memoizedState=r,[o,r]},useMutableSource:function(){},useSyncExternalStore:function(r,o,e){var t=$,n=Or();if(I){if(e===void 0)throw Error(h(407));e=e()}else{if(e=o(),rr===null)throw Error(h(349));_o&30||u0(t,o,e)}n.memoizedState=e;var a={value:e,getSnapshot:o};return n.queue=a,Al(h0.bind(null,t,a,r),[r]),t.flags|=2048,Ke(9,x0.bind(null,t,a,e,o),void 0,null),e},useId:function(){var r=Or(),o=rr.identifierPrefix;if(I){var e=Yr,t=Vr;e=(t&~(1<<32-Rr(t)-1)).toString(32)+e,o=":"+o+"R"+e,e=Qe++,0<e&&(o+="H"+e.toString(32)),o+=":"}else e=kg++,o=":"+o+"r"+e.toString(32)+":";return r.memoizedState=o},unstable_isNewReconciler:!1},Cg={readContext:Ar,useCallback:C0,useContext:Ar,useEffect:za,useImperativeHandle:S0,useInsertionEffect:j0,useLayoutEffect:N0,useMemo:A0,useReducer:Vn,useRef:k0,useState:function(){return Vn(Ge)},useDebugValue:Sa,useDeferredValue:function(r){var o=Er();return E0(o,K.memoizedState,r)},useTransition:function(){var r=Vn(Ge)[0],o=Er().memoizedState;return[r,o]},useMutableSource:f0,useSyncExternalStore:w0,useId:T0,unstable_isNewReconciler:!1},Ag={readContext:Ar,useCallback:C0,useContext:Ar,useEffect:za,useImperativeHandle:S0,useInsertionEffect:j0,useLayoutEffect:N0,useMemo:A0,useReducer:Yn,useRef:k0,useState:function(){return Yn(Ge)},useDebugValue:Sa,useDeferredValue:function(r){var o=Er();return K===null?o.memoizedState=r:E0(o,K.memoizedState,r)},useTransition:function(){var r=Yn(Ge)[0],o=Er().memoizedState;return[r,o]},useMutableSource:f0,useSyncExternalStore:w0,useId:T0,unstable_isNewReconciler:!1};function Ur(r,o){if(r&&r.defaultProps){o=W({},o),r=r.defaultProps;for(var e in r)o[e]===void 0&&(o[e]=r[e]);return o}return o}function Ci(r,o,e,t){o=r.memoizedState,e=e(t,o),e=e==null?o:W({},o,e),r.memoizedState=e,r.lanes===0&&(r.updateQueue.baseState=e)}var mn={isMounted:function(r){return(r=r._reactInternals)?Ro(r)===r:!1},enqueueSetState:function(r,o,e){r=r._reactInternals;var t=sr(),n=po(r),a=Xr(t,n);a.payload=o,e!=null&&(a.callback=e),o=go(r,a,n),o!==null&&(Fr(o,r,n,t),At(o,r,n))},enqueueReplaceState:function(r,o,e){r=r._reactInternals;var t=sr(),n=po(r),a=Xr(t,n);a.tag=1,a.payload=o,e!=null&&(a.callback=e),o=go(r,a,n),o!==null&&(Fr(o,r,n,t),At(o,r,n))},enqueueForceUpdate:function(r,o){r=r._reactInternals;var e=sr(),t=po(r),n=Xr(e,t);n.tag=2,o!=null&&(n.callback=o),o=go(r,n,t),o!==null&&(Fr(o,r,t,e),At(o,r,t))}};function El(r,o,e,t,n,a,l){return r=r.stateNode,typeof r.shouldComponentUpdate=="function"?r.shouldComponentUpdate(t,a,l):o.prototype&&o.prototype.isPureReactComponent?!$e(e,t)||!$e(n,a):!0}function L0(r,o,e){var t=!1,n=wo,a=o.contextType;return typeof a=="object"&&a!==null?a=Ar(a):(n=fr(o)?Eo:lr.current,t=o.contextTypes,a=(t=t!=null)?te(r,n):wo),o=new o(e,a),r.memoizedState=o.state!==null&&o.state!==void 0?o.state:null,o.updater=mn,r.stateNode=o,o._reactInternals=r,t&&(r=r.stateNode,r.__reactInternalMemoizedUnmaskedChildContext=n,r.__reactInternalMemoizedMaskedChildContext=a),o}function Tl(r,o,e,t){r=o.state,typeof o.componentWillReceiveProps=="function"&&o.componentWillReceiveProps(e,t),typeof o.UNSAFE_componentWillReceiveProps=="function"&&o.UNSAFE_componentWillReceiveProps(e,t),o.state!==r&&mn.enqueueReplaceState(o,o.state,null)}function Ai(r,o,e,t){var n=r.stateNode;n.props=e,n.state=r.memoizedState,n.refs={},xa(r);var a=o.contextType;typeof a=="object"&&a!==null?n.context=Ar(a):(a=fr(o)?Eo:lr.current,n.context=te(r,a)),n.state=r.memoizedState,a=o.getDerivedStateFromProps,typeof a=="function"&&(Ci(r,o,a,e),n.state=r.memoizedState),typeof o.getDerivedStateFromProps=="function"||typeof n.getSnapshotBeforeUpdate=="function"||typeof n.UNSAFE_componentWillMount!="function"&&typeof n.componentWillMount!="function"||(o=n.state,typeof n.componentWillMount=="function"&&n.componentWillMount(),typeof n.UNSAFE_componentWillMount=="function"&&n.UNSAFE_componentWillMount(),o!==n.state&&mn.enqueueReplaceState(n,n.state,null),Kt(r,e,n,t),n.state=r.memoizedState),typeof n.componentDidMount=="function"&&(r.flags|=4194308)}function le(r,o){try{var e="",t=o;do e+=ec(t),t=t.return;while(t);var n=e}catch(a){n=`
Error generating stack: `+a.message+`
`+a.stack}return{value:r,source:o,stack:n,digest:null}}function Xn(r,o,e){return{value:r,source:null,stack:e??null,digest:o??null}}function Ei(r,o){try{console.error(o.value)}catch(e){setTimeout(function(){throw e})}}var Eg=typeof WeakMap=="function"?WeakMap:Map;function R0(r,o,e){e=Xr(-1,e),e.tag=3,e.payload={element:null};var t=o.value;return e.callback=function(){on||(on=!0,Oi=t),Ei(r,o)},e}function F0(r,o,e){e=Xr(-1,e),e.tag=3;var t=r.type.getDerivedStateFromError;if(typeof t=="function"){var n=o.value;e.payload=function(){return t(n)},e.callback=function(){Ei(r,o)}}var a=r.stateNode;return a!==null&&typeof a.componentDidCatch=="function"&&(e.callback=function(){Ei(r,o),typeof t!="function"&&(bo===null?bo=new Set([this]):bo.add(this));var l=o.stack;this.componentDidCatch(o.value,{componentStack:l!==null?l:""})}),e}function _l(r,o,e){var t=r.pingCache;if(t===null){t=r.pingCache=new Eg;var n=new Set;t.set(o,n)}else n=t.get(o),n===void 0&&(n=new Set,t.set(o,n));n.has(e)||(n.add(e),r=Wg.bind(null,r,o,e),o.then(r,r))}function Ul(r){do{var o;if((o=r.tag===13)&&(o=r.memoizedState,o=o!==null?o.dehydrated!==null:!0),o)return r;r=r.return}while(r!==null);return null}function Pl(r,o,e,t,n){return r.mode&1?(r.flags|=65536,r.lanes=n,r):(r===o?r.flags|=65536:(r.flags|=128,e.flags|=131072,e.flags&=-52805,e.tag===1&&(e.alternate===null?e.tag=17:(o=Xr(-1,1),o.tag=2,go(e,o,1))),e.lanes|=1),r)}var Tg=Zr.ReactCurrentOwner,pr=!1;function dr(r,o,e,t){o.child=r===null?g0(o,null,e,t):ie(o,r.child,e,t)}function Ll(r,o,e,t,n){e=e.render;var a=o.ref;return re(o,n),t=ja(r,o,e,t,a,n),e=Na(),r!==null&&!pr?(o.updateQueue=r.updateQueue,o.flags&=-2053,r.lanes&=~n,Jr(r,o,n)):(I&&e&&ga(o),o.flags|=1,dr(r,o,t,n),o.child)}function Rl(r,o,e,t,n){if(r===null){var a=e.type;return typeof a=="function"&&!La(a)&&a.defaultProps===void 0&&e.compare===null&&e.defaultProps===void 0?(o.tag=15,o.type=a,B0(r,o,a,t,n)):(r=Lt(e.type,null,t,o,o.mode,n),r.ref=o.ref,r.return=o,o.child=r)}if(a=r.child,!(r.lanes&n)){var l=a.memoizedProps;if(e=e.compare,e=e!==null?e:$e,e(l,t)&&r.ref===o.ref)return Jr(r,o,n)}return o.flags|=1,r=mo(a,t),r.ref=o.ref,r.return=o,o.child=r}function B0(r,o,e,t,n){if(r!==null){var a=r.memoizedProps;if($e(a,t)&&r.ref===o.ref)if(pr=!1,o.pendingProps=t=a,(r.lanes&n)!==0)r.flags&131072&&(pr=!0);else return o.lanes=r.lanes,Jr(r,o,n)}return Ti(r,o,e,t,n)}function M0(r,o,e){var t=o.pendingProps,n=t.children,a=r!==null?r.memoizedState:null;if(t.mode==="hidden")if(!(o.mode&1))o.memoizedState={baseLanes:0,cachePool:null,transitions:null},B(Qo,ur),ur|=e;else{if(!(e&1073741824))return r=a!==null?a.baseLanes|e:e,o.lanes=o.childLanes=1073741824,o.memoizedState={baseLanes:r,cachePool:null,transitions:null},o.updateQueue=null,B(Qo,ur),ur|=r,null;o.memoizedState={baseLanes:0,cachePool:null,transitions:null},t=a!==null?a.baseLanes:e,B(Qo,ur),ur|=t}else a!==null?(t=a.baseLanes|e,o.memoizedState=null):t=e,B(Qo,ur),ur|=t;return dr(r,o,n,e),o.child}function O0(r,o){var e=o.ref;(r===null&&e!==null||r!==null&&r.ref!==e)&&(o.flags|=512,o.flags|=2097152)}function Ti(r,o,e,t,n){var a=fr(e)?Eo:lr.current;return a=te(o,a),re(o,n),e=ja(r,o,e,t,a,n),t=Na(),r!==null&&!pr?(o.updateQueue=r.updateQueue,o.flags&=-2053,r.lanes&=~n,Jr(r,o,n)):(I&&t&&ga(o),o.flags|=1,dr(r,o,e,n),o.child)}function Fl(r,o,e,t,n){if(fr(e)){var a=!0;Vt(o)}else a=!1;if(re(o,n),o.stateNode===null)_t(r,o),L0(o,e,t),Ai(o,e,t,n),t=!0;else if(r===null){var l=o.stateNode,d=o.memoizedProps;l.props=d;var s=l.context,g=e.contextType;typeof g=="object"&&g!==null?g=Ar(g):(g=fr(e)?Eo:lr.current,g=te(o,g));var u=e.getDerivedStateFromProps,w=typeof u=="function"||typeof l.getSnapshotBeforeUpdate=="function";w||typeof l.UNSAFE_componentWillReceiveProps!="function"&&typeof l.componentWillReceiveProps!="function"||(d!==t||s!==g)&&Tl(o,l,t,g),oo=!1;var f=o.memoizedState;l.state=f,Kt(o,t,l,n),s=o.memoizedState,d!==t||f!==s||mr.current||oo?(typeof u=="function"&&(Ci(o,e,u,t),s=o.memoizedState),(d=oo||El(o,e,d,t,f,s,g))?(w||typeof l.UNSAFE_componentWillMount!="function"&&typeof l.componentWillMount!="function"||(typeof l.componentWillMount=="function"&&l.componentWillMount(),typeof l.UNSAFE_componentWillMount=="function"&&l.UNSAFE_componentWillMount()),typeof l.componentDidMount=="function"&&(o.flags|=4194308)):(typeof l.componentDidMount=="function"&&(o.flags|=4194308),o.memoizedProps=t,o.memoizedState=s),l.props=t,l.state=s,l.context=g,t=d):(typeof l.componentDidMount=="function"&&(o.flags|=4194308),t=!1)}else{l=o.stateNode,p0(r,o),d=o.memoizedProps,g=o.type===o.elementType?d:Ur(o.type,d),l.props=g,w=o.pendingProps,f=l.context,s=e.contextType,typeof s=="object"&&s!==null?s=Ar(s):(s=fr(e)?Eo:lr.current,s=te(o,s));var v=e.getDerivedStateFromProps;(u=typeof v=="function"||typeof l.getSnapshotBeforeUpdate=="function")||typeof l.UNSAFE_componentWillReceiveProps!="function"&&typeof l.componentWillReceiveProps!="function"||(d!==w||f!==s)&&Tl(o,l,t,s),oo=!1,f=o.memoizedState,l.state=f,Kt(o,t,l,n);var y=o.memoizedState;d!==w||f!==y||mr.current||oo?(typeof v=="function"&&(Ci(o,e,v,t),y=o.memoizedState),(g=oo||El(o,e,g,t,f,y,s)||!1)?(u||typeof l.UNSAFE_componentWillUpdate!="function"&&typeof l.componentWillUpdate!="function"||(typeof l.componentWillUpdate=="function"&&l.componentWillUpdate(t,y,s),typeof l.UNSAFE_componentWillUpdate=="function"&&l.UNSAFE_componentWillUpdate(t,y,s)),typeof l.componentDidUpdate=="function"&&(o.flags|=4),typeof l.getSnapshotBeforeUpdate=="function"&&(o.flags|=1024)):(typeof l.componentDidUpdate!="function"||d===r.memoizedProps&&f===r.memoizedState||(o.flags|=4),typeof l.getSnapshotBeforeUpdate!="function"||d===r.memoizedProps&&f===r.memoizedState||(o.flags|=1024),o.memoizedProps=t,o.memoizedState=y),l.props=t,l.state=y,l.context=s,t=g):(typeof l.componentDidUpdate!="function"||d===r.memoizedProps&&f===r.memoizedState||(o.flags|=4),typeof l.getSnapshotBeforeUpdate!="function"||d===r.memoizedProps&&f===r.memoizedState||(o.flags|=1024),t=!1)}return _i(r,o,e,t,a,n)}function _i(r,o,e,t,n,a){O0(r,o);var l=(o.flags&128)!==0;if(!t&&!l)return n&&yl(o,e,!1),Jr(r,o,a);t=o.stateNode,Tg.current=o;var d=l&&typeof e.getDerivedStateFromError!="function"?null:t.render();return o.flags|=1,r!==null&&l?(o.child=ie(o,r.child,null,a),o.child=ie(o,null,d,a)):dr(r,o,d,a),o.memoizedState=t.state,n&&yl(o,e,!0),o.child}function I0(r){var o=r.stateNode;o.pendingContext?vl(r,o.pendingContext,o.pendingContext!==o.context):o.context&&vl(r,o.context,!1),ha(r,o.containerInfo)}function Bl(r,o,e,t,n){return ne(),pa(n),o.flags|=256,dr(r,o,e,t),o.child}var Ui={dehydrated:null,treeContext:null,retryLane:0};function Pi(r){return{baseLanes:r,cachePool:null,transitions:null}}function D0(r,o,e){var t=o.pendingProps,n=D.current,a=!1,l=(o.flags&128)!==0,d;if((d=l)||(d=r!==null&&r.memoizedState===null?!1:(n&2)!==0),d?(a=!0,o.flags&=-129):(r===null||r.memoizedState!==null)&&(n|=1),B(D,n&1),r===null)return zi(o),r=o.memoizedState,r!==null&&(r=r.dehydrated,r!==null)?(o.mode&1?r.data==="$!"?o.lanes=8:o.lanes=1073741824:o.lanes=1,null):(l=t.children,r=t.fallback,a?(t=o.mode,a=o.child,l={mode:"hidden",children:l},!(t&1)&&a!==null?(a.childLanes=0,a.pendingProps=l):a=un(l,t,0,null),r=Ao(r,t,e,null),a.return=o,r.return=o,a.sibling=r,o.child=a,o.child.memoizedState=Pi(e),o.memoizedState=Ui,r):Ca(o,l));if(n=r.memoizedState,n!==null&&(d=n.dehydrated,d!==null))return _g(r,o,l,t,d,n,e);if(a){a=t.fallback,l=o.mode,n=r.child,d=n.sibling;var s={mode:"hidden",children:t.children};return!(l&1)&&o.child!==n?(t=o.child,t.childLanes=0,t.pendingProps=s,o.deletions=null):(t=mo(n,s),t.subtreeFlags=n.subtreeFlags&14680064),d!==null?a=mo(d,a):(a=Ao(a,l,e,null),a.flags|=2),a.return=o,t.return=o,t.sibling=a,o.child=t,t=a,a=o.child,l=r.child.memoizedState,l=l===null?Pi(e):{baseLanes:l.baseLanes|e,cachePool:null,transitions:l.transitions},a.memoizedState=l,a.childLanes=r.childLanes&~e,o.memoizedState=Ui,t}return a=r.child,r=a.sibling,t=mo(a,{mode:"visible",children:t.children}),!(o.mode&1)&&(t.lanes=e),t.return=o,t.sibling=null,r!==null&&(e=o.deletions,e===null?(o.deletions=[r],o.flags|=16):e.push(r)),o.child=t,o.memoizedState=null,t}function Ca(r,o){return o=un({mode:"visible",children:o},r.mode,0,null),o.return=r,r.child=o}function xt(r,o,e,t){return t!==null&&pa(t),ie(o,r.child,null,e),r=Ca(o,o.pendingProps.children),r.flags|=2,o.memoizedState=null,r}function _g(r,o,e,t,n,a,l){if(e)return o.flags&256?(o.flags&=-257,t=Xn(Error(h(422))),xt(r,o,l,t)):o.memoizedState!==null?(o.child=r.child,o.flags|=128,null):(a=t.fallback,n=o.mode,t=un({mode:"visible",children:t.children},n,0,null),a=Ao(a,n,l,null),a.flags|=2,t.return=o,a.return=o,t.sibling=a,o.child=t,o.mode&1&&ie(o,r.child,null,l),o.child.memoizedState=Pi(l),o.memoizedState=Ui,a);if(!(o.mode&1))return xt(r,o,l,null);if(n.data==="$!"){if(t=n.nextSibling&&n.nextSibling.dataset,t)var d=t.dgst;return t=d,a=Error(h(419)),t=Xn(a,t,void 0),xt(r,o,l,t)}if(d=(l&r.childLanes)!==0,pr||d){if(t=rr,t!==null){switch(l&-l){case 4:n=2;break;case 16:n=8;break;case 64:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:case 67108864:n=32;break;case 536870912:n=268435456;break;default:n=0}n=n&(t.suspendedLanes|l)?0:n,n!==0&&n!==a.retryLane&&(a.retryLane=n,Kr(r,n),Fr(t,r,n,-1))}return Pa(),t=Xn(Error(h(421))),xt(r,o,l,t)}return n.data==="$?"?(o.flags|=128,o.child=r.child,o=Hg.bind(null,r),n._reactRetry=o,null):(r=a.treeContext,xr=co(n.nextSibling),hr=o,I=!0,Lr=null,r!==null&&(Nr[zr++]=Vr,Nr[zr++]=Yr,Nr[zr++]=To,Vr=r.id,Yr=r.overflow,To=o),o=Ca(o,t.children),o.flags|=4096,o)}function Ml(r,o,e){r.lanes|=o;var t=r.alternate;t!==null&&(t.lanes|=o),Si(r.return,o,e)}function Qn(r,o,e,t,n){var a=r.memoizedState;a===null?r.memoizedState={isBackwards:o,rendering:null,renderingStartTime:0,last:t,tail:e,tailMode:n}:(a.isBackwards=o,a.rendering=null,a.renderingStartTime=0,a.last=t,a.tail=e,a.tailMode=n)}function $0(r,o,e){var t=o.pendingProps,n=t.revealOrder,a=t.tail;if(dr(r,o,t.children,e),t=D.current,t&2)t=t&1|2,o.flags|=128;else{if(r!==null&&r.flags&128)r:for(r=o.child;r!==null;){if(r.tag===13)r.memoizedState!==null&&Ml(r,e,o);else if(r.tag===19)Ml(r,e,o);else if(r.child!==null){r.child.return=r,r=r.child;continue}if(r===o)break r;for(;r.sibling===null;){if(r.return===null||r.return===o)break r;r=r.return}r.sibling.return=r.return,r=r.sibling}t&=1}if(B(D,t),!(o.mode&1))o.memoizedState=null;else switch(n){case"forwards":for(e=o.child,n=null;e!==null;)r=e.alternate,r!==null&&Jt(r)===null&&(n=e),e=e.sibling;e=n,e===null?(n=o.child,o.child=null):(n=e.sibling,e.sibling=null),Qn(o,!1,n,e,a);break;case"backwards":for(e=null,n=o.child,o.child=null;n!==null;){if(r=n.alternate,r!==null&&Jt(r)===null){o.child=n;break}r=n.sibling,n.sibling=e,e=n,n=r}Qn(o,!0,e,null,a);break;case"together":Qn(o,!1,null,null,void 0);break;default:o.memoizedState=null}return o.child}function _t(r,o){!(o.mode&1)&&r!==null&&(r.alternate=null,o.alternate=null,o.flags|=2)}function Jr(r,o,e){if(r!==null&&(o.dependencies=r.dependencies),Uo|=o.lanes,!(e&o.childLanes))return null;if(r!==null&&o.child!==r.child)throw Error(h(153));if(o.child!==null){for(r=o.child,e=mo(r,r.pendingProps),o.child=e,e.return=o;r.sibling!==null;)r=r.sibling,e=e.sibling=mo(r,r.pendingProps),e.return=o;e.sibling=null}return o.child}function Ug(r,o,e){switch(o.tag){case 3:I0(o),ne();break;case 5:m0(o);break;case 1:fr(o.type)&&Vt(o);break;case 4:ha(o,o.stateNode.containerInfo);break;case 10:var t=o.type._context,n=o.memoizedProps.value;B(Qt,t._currentValue),t._currentValue=n;break;case 13:if(t=o.memoizedState,t!==null)return t.dehydrated!==null?(B(D,D.current&1),o.flags|=128,null):e&o.child.childLanes?D0(r,o,e):(B(D,D.current&1),r=Jr(r,o,e),r!==null?r.sibling:null);B(D,D.current&1);break;case 19:if(t=(e&o.childLanes)!==0,r.flags&128){if(t)return $0(r,o,e);o.flags|=128}if(n=o.memoizedState,n!==null&&(n.rendering=null,n.tail=null,n.lastEffect=null),B(D,D.current),t)break;return null;case 22:case 23:return o.lanes=0,M0(r,o,e)}return Jr(r,o,e)}var W0,Li,H0,V0;W0=function(r,o){for(var e=o.child;e!==null;){if(e.tag===5||e.tag===6)r.appendChild(e.stateNode);else if(e.tag!==4&&e.child!==null){e.child.return=e,e=e.child;continue}if(e===o)break;for(;e.sibling===null;){if(e.return===null||e.return===o)return;e=e.return}e.sibling.return=e.return,e=e.sibling}};Li=function(){};H0=function(r,o,e,t){var n=r.memoizedProps;if(n!==t){r=o.stateNode,So($r.current);var a=null;switch(e){case"input":n=ei(r,n),t=ei(r,t),a=[];break;case"select":n=W({},n,{value:void 0}),t=W({},t,{value:void 0}),a=[];break;case"textarea":n=ii(r,n),t=ii(r,t),a=[];break;default:typeof n.onClick!="function"&&typeof t.onClick=="function"&&(r.onclick=Wt)}li(e,t);var l;e=null;for(g in n)if(!t.hasOwnProperty(g)&&n.hasOwnProperty(g)&&n[g]!=null)if(g==="style"){var d=n[g];for(l in d)d.hasOwnProperty(l)&&(e||(e={}),e[l]="")}else g!=="dangerouslySetInnerHTML"&&g!=="children"&&g!=="suppressContentEditableWarning"&&g!=="suppressHydrationWarning"&&g!=="autoFocus"&&(Re.hasOwnProperty(g)?a||(a=[]):(a=a||[]).push(g,null));for(g in t){var s=t[g];if(d=n!=null?n[g]:void 0,t.hasOwnProperty(g)&&s!==d&&(s!=null||d!=null))if(g==="style")if(d){for(l in d)!d.hasOwnProperty(l)||s&&s.hasOwnProperty(l)||(e||(e={}),e[l]="");for(l in s)s.hasOwnProperty(l)&&d[l]!==s[l]&&(e||(e={}),e[l]=s[l])}else e||(a||(a=[]),a.push(g,e)),e=s;else g==="dangerouslySetInnerHTML"?(s=s?s.__html:void 0,d=d?d.__html:void 0,s!=null&&d!==s&&(a=a||[]).push(g,s)):g==="children"?typeof s!="string"&&typeof s!="number"||(a=a||[]).push(g,""+s):g!=="suppressContentEditableWarning"&&g!=="suppressHydrationWarning"&&(Re.hasOwnProperty(g)?(s!=null&&g==="onScroll"&&M("scroll",r),a||d===s||(a=[])):(a=a||[]).push(g,s))}e&&(a=a||[]).push("style",e);var g=a;(o.updateQueue=g)&&(o.flags|=4)}};V0=function(r,o,e,t){e!==t&&(o.flags|=4)};function ve(r,o){if(!I)switch(r.tailMode){case"hidden":o=r.tail;for(var e=null;o!==null;)o.alternate!==null&&(e=o),o=o.sibling;e===null?r.tail=null:e.sibling=null;break;case"collapsed":e=r.tail;for(var t=null;e!==null;)e.alternate!==null&&(t=e),e=e.sibling;t===null?o||r.tail===null?r.tail=null:r.tail.sibling=null:t.sibling=null}}function ir(r){var o=r.alternate!==null&&r.alternate.child===r.child,e=0,t=0;if(o)for(var n=r.child;n!==null;)e|=n.lanes|n.childLanes,t|=n.subtreeFlags&14680064,t|=n.flags&14680064,n.return=r,n=n.sibling;else for(n=r.child;n!==null;)e|=n.lanes|n.childLanes,t|=n.subtreeFlags,t|=n.flags,n.return=r,n=n.sibling;return r.subtreeFlags|=t,r.childLanes=e,o}function Pg(r,o,e){var t=o.pendingProps;switch(ba(o),o.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return ir(o),null;case 1:return fr(o.type)&&Ht(),ir(o),null;case 3:return t=o.stateNode,ae(),O(mr),O(lr),ya(),t.pendingContext&&(t.context=t.pendingContext,t.pendingContext=null),(r===null||r.child===null)&&(wt(o)?o.flags|=4:r===null||r.memoizedState.isDehydrated&&!(o.flags&256)||(o.flags|=1024,Lr!==null&&($i(Lr),Lr=null))),Li(r,o),ir(o),null;case 5:va(o);var n=So(Xe.current);if(e=o.type,r!==null&&o.stateNode!=null)H0(r,o,e,t,n),r.ref!==o.ref&&(o.flags|=512,o.flags|=2097152);else{if(!t){if(o.stateNode===null)throw Error(h(166));return ir(o),null}if(r=So($r.current),wt(o)){t=o.stateNode,e=o.type;var a=o.memoizedProps;switch(t[Ir]=o,t[Ve]=a,r=(o.mode&1)!==0,e){case"dialog":M("cancel",t),M("close",t);break;case"iframe":case"object":case"embed":M("load",t);break;case"video":case"audio":for(n=0;n<ze.length;n++)M(ze[n],t);break;case"source":M("error",t);break;case"img":case"image":case"link":M("error",t),M("load",t);break;case"details":M("toggle",t);break;case"input":Xa(t,a),M("invalid",t);break;case"select":t._wrapperState={wasMultiple:!!a.multiple},M("invalid",t);break;case"textarea":Ga(t,a),M("invalid",t)}li(e,a),n=null;for(var l in a)if(a.hasOwnProperty(l)){var d=a[l];l==="children"?typeof d=="string"?t.textContent!==d&&(a.suppressHydrationWarning!==!0&&ft(t.textContent,d,r),n=["children",d]):typeof d=="number"&&t.textContent!==""+d&&(a.suppressHydrationWarning!==!0&&ft(t.textContent,d,r),n=["children",""+d]):Re.hasOwnProperty(l)&&d!=null&&l==="onScroll"&&M("scroll",t)}switch(e){case"input":lt(t),Qa(t,a,!0);break;case"textarea":lt(t),Ka(t);break;case"select":case"option":break;default:typeof a.onClick=="function"&&(t.onclick=Wt)}t=n,o.updateQueue=t,t!==null&&(o.flags|=4)}else{l=n.nodeType===9?n:n.ownerDocument,r==="http://www.w3.org/1999/xhtml"&&(r=hd(e)),r==="http://www.w3.org/1999/xhtml"?e==="script"?(r=l.createElement("div"),r.innerHTML="<script><\/script>",r=r.removeChild(r.firstChild)):typeof t.is=="string"?r=l.createElement(e,{is:t.is}):(r=l.createElement(e),e==="select"&&(l=r,t.multiple?l.multiple=!0:t.size&&(l.size=t.size))):r=l.createElementNS(r,e),r[Ir]=o,r[Ve]=t,W0(r,o,!1,!1),o.stateNode=r;r:{switch(l=di(e,t),e){case"dialog":M("cancel",r),M("close",r),n=t;break;case"iframe":case"object":case"embed":M("load",r),n=t;break;case"video":case"audio":for(n=0;n<ze.length;n++)M(ze[n],r);n=t;break;case"source":M("error",r),n=t;break;case"img":case"image":case"link":M("error",r),M("load",r),n=t;break;case"details":M("toggle",r),n=t;break;case"input":Xa(r,t),n=ei(r,t),M("invalid",r);break;case"option":n=t;break;case"select":r._wrapperState={wasMultiple:!!t.multiple},n=W({},t,{value:void 0}),M("invalid",r);break;case"textarea":Ga(r,t),n=ii(r,t),M("invalid",r);break;default:n=t}li(e,n),d=n;for(a in d)if(d.hasOwnProperty(a)){var s=d[a];a==="style"?kd(r,s):a==="dangerouslySetInnerHTML"?(s=s?s.__html:void 0,s!=null&&vd(r,s)):a==="children"?typeof s=="string"?(e!=="textarea"||s!=="")&&Fe(r,s):typeof s=="number"&&Fe(r,""+s):a!=="suppressContentEditableWarning"&&a!=="suppressHydrationWarning"&&a!=="autoFocus"&&(Re.hasOwnProperty(a)?s!=null&&a==="onScroll"&&M("scroll",r):s!=null&&Ji(r,a,s,l))}switch(e){case"input":lt(r),Qa(r,t,!1);break;case"textarea":lt(r),Ka(r);break;case"option":t.value!=null&&r.setAttribute("value",""+fo(t.value));break;case"select":r.multiple=!!t.multiple,a=t.value,a!=null?Ko(r,!!t.multiple,a,!1):t.defaultValue!=null&&Ko(r,!!t.multiple,t.defaultValue,!0);break;default:typeof n.onClick=="function"&&(r.onclick=Wt)}switch(e){case"button":case"input":case"select":case"textarea":t=!!t.autoFocus;break r;case"img":t=!0;break r;default:t=!1}}t&&(o.flags|=4)}o.ref!==null&&(o.flags|=512,o.flags|=2097152)}return ir(o),null;case 6:if(r&&o.stateNode!=null)V0(r,o,r.memoizedProps,t);else{if(typeof t!="string"&&o.stateNode===null)throw Error(h(166));if(e=So(Xe.current),So($r.current),wt(o)){if(t=o.stateNode,e=o.memoizedProps,t[Ir]=o,(a=t.nodeValue!==e)&&(r=hr,r!==null))switch(r.tag){case 3:ft(t.nodeValue,e,(r.mode&1)!==0);break;case 5:r.memoizedProps.suppressHydrationWarning!==!0&&ft(t.nodeValue,e,(r.mode&1)!==0)}a&&(o.flags|=4)}else t=(e.nodeType===9?e:e.ownerDocument).createTextNode(t),t[Ir]=o,o.stateNode=t}return ir(o),null;case 13:if(O(D),t=o.memoizedState,r===null||r.memoizedState!==null&&r.memoizedState.dehydrated!==null){if(I&&xr!==null&&o.mode&1&&!(o.flags&128))s0(),ne(),o.flags|=98560,a=!1;else if(a=wt(o),t!==null&&t.dehydrated!==null){if(r===null){if(!a)throw Error(h(318));if(a=o.memoizedState,a=a!==null?a.dehydrated:null,!a)throw Error(h(317));a[Ir]=o}else ne(),!(o.flags&128)&&(o.memoizedState=null),o.flags|=4;ir(o),a=!1}else Lr!==null&&($i(Lr),Lr=null),a=!0;if(!a)return o.flags&65536?o:null}return o.flags&128?(o.lanes=e,o):(t=t!==null,t!==(r!==null&&r.memoizedState!==null)&&t&&(o.child.flags|=8192,o.mode&1&&(r===null||D.current&1?J===0&&(J=3):Pa())),o.updateQueue!==null&&(o.flags|=4),ir(o),null);case 4:return ae(),Li(r,o),r===null&&We(o.stateNode.containerInfo),ir(o),null;case 10:return wa(o.type._context),ir(o),null;case 17:return fr(o.type)&&Ht(),ir(o),null;case 19:if(O(D),a=o.memoizedState,a===null)return ir(o),null;if(t=(o.flags&128)!==0,l=a.rendering,l===null)if(t)ve(a,!1);else{if(J!==0||r!==null&&r.flags&128)for(r=o.child;r!==null;){if(l=Jt(r),l!==null){for(o.flags|=128,ve(a,!1),t=l.updateQueue,t!==null&&(o.updateQueue=t,o.flags|=4),o.subtreeFlags=0,t=e,e=o.child;e!==null;)a=e,r=t,a.flags&=14680066,l=a.alternate,l===null?(a.childLanes=0,a.lanes=r,a.child=null,a.subtreeFlags=0,a.memoizedProps=null,a.memoizedState=null,a.updateQueue=null,a.dependencies=null,a.stateNode=null):(a.childLanes=l.childLanes,a.lanes=l.lanes,a.child=l.child,a.subtreeFlags=0,a.deletions=null,a.memoizedProps=l.memoizedProps,a.memoizedState=l.memoizedState,a.updateQueue=l.updateQueue,a.type=l.type,r=l.dependencies,a.dependencies=r===null?null:{lanes:r.lanes,firstContext:r.firstContext}),e=e.sibling;return B(D,D.current&1|2),o.child}r=r.sibling}a.tail!==null&&X()>de&&(o.flags|=128,t=!0,ve(a,!1),o.lanes=4194304)}else{if(!t)if(r=Jt(l),r!==null){if(o.flags|=128,t=!0,e=r.updateQueue,e!==null&&(o.updateQueue=e,o.flags|=4),ve(a,!0),a.tail===null&&a.tailMode==="hidden"&&!l.alternate&&!I)return ir(o),null}else 2*X()-a.renderingStartTime>de&&e!==1073741824&&(o.flags|=128,t=!0,ve(a,!1),o.lanes=4194304);a.isBackwards?(l.sibling=o.child,o.child=l):(e=a.last,e!==null?e.sibling=l:o.child=l,a.last=l)}return a.tail!==null?(o=a.tail,a.rendering=o,a.tail=o.sibling,a.renderingStartTime=X(),o.sibling=null,e=D.current,B(D,t?e&1|2:e&1),o):(ir(o),null);case 22:case 23:return Ua(),t=o.memoizedState!==null,r!==null&&r.memoizedState!==null!==t&&(o.flags|=8192),t&&o.mode&1?ur&1073741824&&(ir(o),o.subtreeFlags&6&&(o.flags|=8192)):ir(o),null;case 24:return null;case 25:return null}throw Error(h(156,o.tag))}function Lg(r,o){switch(ba(o),o.tag){case 1:return fr(o.type)&&Ht(),r=o.flags,r&65536?(o.flags=r&-65537|128,o):null;case 3:return ae(),O(mr),O(lr),ya(),r=o.flags,r&65536&&!(r&128)?(o.flags=r&-65537|128,o):null;case 5:return va(o),null;case 13:if(O(D),r=o.memoizedState,r!==null&&r.dehydrated!==null){if(o.alternate===null)throw Error(h(340));ne()}return r=o.flags,r&65536?(o.flags=r&-65537|128,o):null;case 19:return O(D),null;case 4:return ae(),null;case 10:return wa(o.type._context),null;case 22:case 23:return Ua(),null;case 24:return null;default:return null}}var ht=!1,ar=!1,Rg=typeof WeakSet=="function"?WeakSet:Set,j=null;function Xo(r,o){var e=r.ref;if(e!==null)if(typeof e=="function")try{e(null)}catch(t){H(r,o,t)}else e.current=null}function Ri(r,o,e){try{e()}catch(t){H(r,o,t)}}var Ol=!1;function Fg(r,o){if(xi=It,r=Kd(),ca(r)){if("selectionStart"in r)var e={start:r.selectionStart,end:r.selectionEnd};else r:{e=(e=r.ownerDocument)&&e.defaultView||window;var t=e.getSelection&&e.getSelection();if(t&&t.rangeCount!==0){e=t.anchorNode;var n=t.anchorOffset,a=t.focusNode;t=t.focusOffset;try{e.nodeType,a.nodeType}catch{e=null;break r}var l=0,d=-1,s=-1,g=0,u=0,w=r,f=null;o:for(;;){for(var v;w!==e||n!==0&&w.nodeType!==3||(d=l+n),w!==a||t!==0&&w.nodeType!==3||(s=l+t),w.nodeType===3&&(l+=w.nodeValue.length),(v=w.firstChild)!==null;)f=w,w=v;for(;;){if(w===r)break o;if(f===e&&++g===n&&(d=l),f===a&&++u===t&&(s=l),(v=w.nextSibling)!==null)break;w=f,f=w.parentNode}w=v}e=d===-1||s===-1?null:{start:d,end:s}}else e=null}e=e||{start:0,end:0}}else e=null;for(hi={focusedElem:r,selectionRange:e},It=!1,j=o;j!==null;)if(o=j,r=o.child,(o.subtreeFlags&1028)!==0&&r!==null)r.return=o,j=r;else for(;j!==null;){o=j;try{var y=o.alternate;if(o.flags&1024)switch(o.tag){case 0:case 11:case 15:break;case 1:if(y!==null){var k=y.memoizedProps,F=y.memoizedState,b=o.stateNode,c=b.getSnapshotBeforeUpdate(o.elementType===o.type?k:Ur(o.type,k),F);b.__reactInternalSnapshotBeforeUpdate=c}break;case 3:var p=o.stateNode.containerInfo;p.nodeType===1?p.textContent="":p.nodeType===9&&p.documentElement&&p.removeChild(p.documentElement);break;case 5:case 6:case 4:case 17:break;default:throw Error(h(163))}}catch(x){H(o,o.return,x)}if(r=o.sibling,r!==null){r.return=o.return,j=r;break}j=o.return}return y=Ol,Ol=!1,y}function Ue(r,o,e){var t=o.updateQueue;if(t=t!==null?t.lastEffect:null,t!==null){var n=t=t.next;do{if((n.tag&r)===r){var a=n.destroy;n.destroy=void 0,a!==void 0&&Ri(o,e,a)}n=n.next}while(n!==t)}}function fn(r,o){if(o=o.updateQueue,o=o!==null?o.lastEffect:null,o!==null){var e=o=o.next;do{if((e.tag&r)===r){var t=e.create;e.destroy=t()}e=e.next}while(e!==o)}}function Fi(r){var o=r.ref;if(o!==null){var e=r.stateNode;switch(r.tag){case 5:r=e;break;default:r=e}typeof o=="function"?o(r):o.current=r}}function Y0(r){var o=r.alternate;o!==null&&(r.alternate=null,Y0(o)),r.child=null,r.deletions=null,r.sibling=null,r.tag===5&&(o=r.stateNode,o!==null&&(delete o[Ir],delete o[Ve],delete o[ki],delete o[xg],delete o[hg])),r.stateNode=null,r.return=null,r.dependencies=null,r.memoizedProps=null,r.memoizedState=null,r.pendingProps=null,r.stateNode=null,r.updateQueue=null}function X0(r){return r.tag===5||r.tag===3||r.tag===4}function Il(r){r:for(;;){for(;r.sibling===null;){if(r.return===null||X0(r.return))return null;r=r.return}for(r.sibling.return=r.return,r=r.sibling;r.tag!==5&&r.tag!==6&&r.tag!==18;){if(r.flags&2||r.child===null||r.tag===4)continue r;r.child.return=r,r=r.child}if(!(r.flags&2))return r.stateNode}}function Bi(r,o,e){var t=r.tag;if(t===5||t===6)r=r.stateNode,o?e.nodeType===8?e.parentNode.insertBefore(r,o):e.insertBefore(r,o):(e.nodeType===8?(o=e.parentNode,o.insertBefore(r,e)):(o=e,o.appendChild(r)),e=e._reactRootContainer,e!=null||o.onclick!==null||(o.onclick=Wt));else if(t!==4&&(r=r.child,r!==null))for(Bi(r,o,e),r=r.sibling;r!==null;)Bi(r,o,e),r=r.sibling}function Mi(r,o,e){var t=r.tag;if(t===5||t===6)r=r.stateNode,o?e.insertBefore(r,o):e.appendChild(r);else if(t!==4&&(r=r.child,r!==null))for(Mi(r,o,e),r=r.sibling;r!==null;)Mi(r,o,e),r=r.sibling}var or=null,Pr=!1;function qr(r,o,e){for(e=e.child;e!==null;)Q0(r,o,e),e=e.sibling}function Q0(r,o,e){if(Dr&&typeof Dr.onCommitFiberUnmount=="function")try{Dr.onCommitFiberUnmount(ln,e)}catch{}switch(e.tag){case 5:ar||Xo(e,o);case 6:var t=or,n=Pr;or=null,qr(r,o,e),or=t,Pr=n,or!==null&&(Pr?(r=or,e=e.stateNode,r.nodeType===8?r.parentNode.removeChild(e):r.removeChild(e)):or.removeChild(e.stateNode));break;case 18:or!==null&&(Pr?(r=or,e=e.stateNode,r.nodeType===8?Dn(r.parentNode,e):r.nodeType===1&&Dn(r,e),Ie(r)):Dn(or,e.stateNode));break;case 4:t=or,n=Pr,or=e.stateNode.containerInfo,Pr=!0,qr(r,o,e),or=t,Pr=n;break;case 0:case 11:case 14:case 15:if(!ar&&(t=e.updateQueue,t!==null&&(t=t.lastEffect,t!==null))){n=t=t.next;do{var a=n,l=a.destroy;a=a.tag,l!==void 0&&(a&2||a&4)&&Ri(e,o,l),n=n.next}while(n!==t)}qr(r,o,e);break;case 1:if(!ar&&(Xo(e,o),t=e.stateNode,typeof t.componentWillUnmount=="function"))try{t.props=e.memoizedProps,t.state=e.memoizedState,t.componentWillUnmount()}catch(d){H(e,o,d)}qr(r,o,e);break;case 21:qr(r,o,e);break;case 22:e.mode&1?(ar=(t=ar)||e.memoizedState!==null,qr(r,o,e),ar=t):qr(r,o,e);break;default:qr(r,o,e)}}function Dl(r){var o=r.updateQueue;if(o!==null){r.updateQueue=null;var e=r.stateNode;e===null&&(e=r.stateNode=new Rg),o.forEach(function(t){var n=Vg.bind(null,r,t);e.has(t)||(e.add(t),t.then(n,n))})}}function _r(r,o){var e=o.deletions;if(e!==null)for(var t=0;t<e.length;t++){var n=e[t];try{var a=r,l=o,d=l;r:for(;d!==null;){switch(d.tag){case 5:or=d.stateNode,Pr=!1;break r;case 3:or=d.stateNode.containerInfo,Pr=!0;break r;case 4:or=d.stateNode.containerInfo,Pr=!0;break r}d=d.return}if(or===null)throw Error(h(160));Q0(a,l,n),or=null,Pr=!1;var s=n.alternate;s!==null&&(s.return=null),n.return=null}catch(g){H(n,o,g)}}if(o.subtreeFlags&12854)for(o=o.child;o!==null;)G0(o,r),o=o.sibling}function G0(r,o){var e=r.alternate,t=r.flags;switch(r.tag){case 0:case 11:case 14:case 15:if(_r(o,r),Mr(r),t&4){try{Ue(3,r,r.return),fn(3,r)}catch(k){H(r,r.return,k)}try{Ue(5,r,r.return)}catch(k){H(r,r.return,k)}}break;case 1:_r(o,r),Mr(r),t&512&&e!==null&&Xo(e,e.return);break;case 5:if(_r(o,r),Mr(r),t&512&&e!==null&&Xo(e,e.return),r.flags&32){var n=r.stateNode;try{Fe(n,"")}catch(k){H(r,r.return,k)}}if(t&4&&(n=r.stateNode,n!=null)){var a=r.memoizedProps,l=e!==null?e.memoizedProps:a,d=r.type,s=r.updateQueue;if(r.updateQueue=null,s!==null)try{d==="input"&&a.type==="radio"&&a.name!=null&&ud(n,a),di(d,l);var g=di(d,a);for(l=0;l<s.length;l+=2){var u=s[l],w=s[l+1];u==="style"?kd(n,w):u==="dangerouslySetInnerHTML"?vd(n,w):u==="children"?Fe(n,w):Ji(n,u,w,g)}switch(d){case"input":ti(n,a);break;case"textarea":xd(n,a);break;case"select":var f=n._wrapperState.wasMultiple;n._wrapperState.wasMultiple=!!a.multiple;var v=a.value;v!=null?Ko(n,!!a.multiple,v,!1):f!==!!a.multiple&&(a.defaultValue!=null?Ko(n,!!a.multiple,a.defaultValue,!0):Ko(n,!!a.multiple,a.multiple?[]:"",!1))}n[Ve]=a}catch(k){H(r,r.return,k)}}break;case 6:if(_r(o,r),Mr(r),t&4){if(r.stateNode===null)throw Error(h(162));n=r.stateNode,a=r.memoizedProps;try{n.nodeValue=a}catch(k){H(r,r.return,k)}}break;case 3:if(_r(o,r),Mr(r),t&4&&e!==null&&e.memoizedState.isDehydrated)try{Ie(o.containerInfo)}catch(k){H(r,r.return,k)}break;case 4:_r(o,r),Mr(r);break;case 13:_r(o,r),Mr(r),n=r.child,n.flags&8192&&(a=n.memoizedState!==null,n.stateNode.isHidden=a,!a||n.alternate!==null&&n.alternate.memoizedState!==null||(Ta=X())),t&4&&Dl(r);break;case 22:if(u=e!==null&&e.memoizedState!==null,r.mode&1?(ar=(g=ar)||u,_r(o,r),ar=g):_r(o,r),Mr(r),t&8192){if(g=r.memoizedState!==null,(r.stateNode.isHidden=g)&&!u&&r.mode&1)for(j=r,u=r.child;u!==null;){for(w=j=u;j!==null;){switch(f=j,v=f.child,f.tag){case 0:case 11:case 14:case 15:Ue(4,f,f.return);break;case 1:Xo(f,f.return);var y=f.stateNode;if(typeof y.componentWillUnmount=="function"){t=f,e=f.return;try{o=t,y.props=o.memoizedProps,y.state=o.memoizedState,y.componentWillUnmount()}catch(k){H(t,e,k)}}break;case 5:Xo(f,f.return);break;case 22:if(f.memoizedState!==null){Wl(w);continue}}v!==null?(v.return=f,j=v):Wl(w)}u=u.sibling}r:for(u=null,w=r;;){if(w.tag===5){if(u===null){u=w;try{n=w.stateNode,g?(a=n.style,typeof a.setProperty=="function"?a.setProperty("display","none","important"):a.display="none"):(d=w.stateNode,s=w.memoizedProps.style,l=s!=null&&s.hasOwnProperty("display")?s.display:null,d.style.display=yd("display",l))}catch(k){H(r,r.return,k)}}}else if(w.tag===6){if(u===null)try{w.stateNode.nodeValue=g?"":w.memoizedProps}catch(k){H(r,r.return,k)}}else if((w.tag!==22&&w.tag!==23||w.memoizedState===null||w===r)&&w.child!==null){w.child.return=w,w=w.child;continue}if(w===r)break r;for(;w.sibling===null;){if(w.return===null||w.return===r)break r;u===w&&(u=null),w=w.return}u===w&&(u=null),w.sibling.return=w.return,w=w.sibling}}break;case 19:_r(o,r),Mr(r),t&4&&Dl(r);break;case 21:break;default:_r(o,r),Mr(r)}}function Mr(r){var o=r.flags;if(o&2){try{r:{for(var e=r.return;e!==null;){if(X0(e)){var t=e;break r}e=e.return}throw Error(h(160))}switch(t.tag){case 5:var n=t.stateNode;t.flags&32&&(Fe(n,""),t.flags&=-33);var a=Il(r);Mi(r,a,n);break;case 3:case 4:var l=t.stateNode.containerInfo,d=Il(r);Bi(r,d,l);break;default:throw Error(h(161))}}catch(s){H(r,r.return,s)}r.flags&=-3}o&4096&&(r.flags&=-4097)}function Bg(r,o,e){j=r,K0(r)}function K0(r,o,e){for(var t=(r.mode&1)!==0;j!==null;){var n=j,a=n.child;if(n.tag===22&&t){var l=n.memoizedState!==null||ht;if(!l){var d=n.alternate,s=d!==null&&d.memoizedState!==null||ar;d=ht;var g=ar;if(ht=l,(ar=s)&&!g)for(j=n;j!==null;)l=j,s=l.child,l.tag===22&&l.memoizedState!==null?Hl(n):s!==null?(s.return=l,j=s):Hl(n);for(;a!==null;)j=a,K0(a),a=a.sibling;j=n,ht=d,ar=g}$l(r)}else n.subtreeFlags&8772&&a!==null?(a.return=n,j=a):$l(r)}}function $l(r){for(;j!==null;){var o=j;if(o.flags&8772){var e=o.alternate;try{if(o.flags&8772)switch(o.tag){case 0:case 11:case 15:ar||fn(5,o);break;case 1:var t=o.stateNode;if(o.flags&4&&!ar)if(e===null)t.componentDidMount();else{var n=o.elementType===o.type?e.memoizedProps:Ur(o.type,e.memoizedProps);t.componentDidUpdate(n,e.memoizedState,t.__reactInternalSnapshotBeforeUpdate)}var a=o.updateQueue;a!==null&&Sl(o,a,t);break;case 3:var l=o.updateQueue;if(l!==null){if(e=null,o.child!==null)switch(o.child.tag){case 5:e=o.child.stateNode;break;case 1:e=o.child.stateNode}Sl(o,l,e)}break;case 5:var d=o.stateNode;if(e===null&&o.flags&4){e=d;var s=o.memoizedProps;switch(o.type){case"button":case"input":case"select":case"textarea":s.autoFocus&&e.focus();break;case"img":s.src&&(e.src=s.src)}}break;case 6:break;case 4:break;case 12:break;case 13:if(o.memoizedState===null){var g=o.alternate;if(g!==null){var u=g.memoizedState;if(u!==null){var w=u.dehydrated;w!==null&&Ie(w)}}}break;case 19:case 17:case 21:case 22:case 23:case 25:break;default:throw Error(h(163))}ar||o.flags&512&&Fi(o)}catch(f){H(o,o.return,f)}}if(o===r){j=null;break}if(e=o.sibling,e!==null){e.return=o.return,j=e;break}j=o.return}}function Wl(r){for(;j!==null;){var o=j;if(o===r){j=null;break}var e=o.sibling;if(e!==null){e.return=o.return,j=e;break}j=o.return}}function Hl(r){for(;j!==null;){var o=j;try{switch(o.tag){case 0:case 11:case 15:var e=o.return;try{fn(4,o)}catch(s){H(o,e,s)}break;case 1:var t=o.stateNode;if(typeof t.componentDidMount=="function"){var n=o.return;try{t.componentDidMount()}catch(s){H(o,n,s)}}var a=o.return;try{Fi(o)}catch(s){H(o,a,s)}break;case 5:var l=o.return;try{Fi(o)}catch(s){H(o,l,s)}}}catch(s){H(o,o.return,s)}if(o===r){j=null;break}var d=o.sibling;if(d!==null){d.return=o.return,j=d;break}j=o.return}}var Mg=Math.ceil,rn=Zr.ReactCurrentDispatcher,Aa=Zr.ReactCurrentOwner,Cr=Zr.ReactCurrentBatchConfig,L=0,rr=null,Q=null,er=0,ur=0,Qo=xo(0),J=0,Je=null,Uo=0,wn=0,Ea=0,Pe=null,br=null,Ta=0,de=1/0,Wr=null,on=!1,Oi=null,bo=null,vt=!1,io=null,en=0,Le=0,Ii=null,Ut=-1,Pt=0;function sr(){return L&6?X():Ut!==-1?Ut:Ut=X()}function po(r){return r.mode&1?L&2&&er!==0?er&-er:yg.transition!==null?(Pt===0&&(Pt=Ld()),Pt):(r=R,r!==0||(r=window.event,r=r===void 0?16:Dd(r.type)),r):1}function Fr(r,o,e,t){if(50<Le)throw Le=0,Ii=null,Error(h(185));qe(r,e,t),(!(L&2)||r!==rr)&&(r===rr&&(!(L&2)&&(wn|=e),J===4&&to(r,er)),wr(r,t),e===1&&L===0&&!(o.mode&1)&&(de=X()+500,bn&&ho()))}function wr(r,o){var e=r.callbackNode;yc(r,o);var t=Ot(r,r===rr?er:0);if(t===0)e!==null&&qa(e),r.callbackNode=null,r.callbackPriority=0;else if(o=t&-t,r.callbackPriority!==o){if(e!=null&&qa(e),o===1)r.tag===0?vg(Vl.bind(null,r)):a0(Vl.bind(null,r)),wg(function(){!(L&6)&&ho()}),e=null;else{switch(Rd(t)){case 1:e=ea;break;case 4:e=Ud;break;case 16:e=Mt;break;case 536870912:e=Pd;break;default:e=Mt}e=ns(e,J0.bind(null,r))}r.callbackPriority=o,r.callbackNode=e}}function J0(r,o){if(Ut=-1,Pt=0,L&6)throw Error(h(327));var e=r.callbackNode;if(oe()&&r.callbackNode!==e)return null;var t=Ot(r,r===rr?er:0);if(t===0)return null;if(t&30||t&r.expiredLanes||o)o=tn(r,t);else{o=t;var n=L;L|=2;var a=q0();(rr!==r||er!==o)&&(Wr=null,de=X()+500,Co(r,o));do try{Dg();break}catch(d){Z0(r,d)}while(!0);fa(),rn.current=a,L=n,Q!==null?o=0:(rr=null,er=0,o=J)}if(o!==0){if(o===2&&(n=pi(r),n!==0&&(t=n,o=Di(r,n))),o===1)throw e=Je,Co(r,0),to(r,t),wr(r,X()),e;if(o===6)to(r,t);else{if(n=r.current.alternate,!(t&30)&&!Og(n)&&(o=tn(r,t),o===2&&(a=pi(r),a!==0&&(t=a,o=Di(r,a))),o===1))throw e=Je,Co(r,0),to(r,t),wr(r,X()),e;switch(r.finishedWork=n,r.finishedLanes=t,o){case 0:case 1:throw Error(h(345));case 2:jo(r,br,Wr);break;case 3:if(to(r,t),(t&130023424)===t&&(o=Ta+500-X(),10<o)){if(Ot(r,0)!==0)break;if(n=r.suspendedLanes,(n&t)!==t){sr(),r.pingedLanes|=r.suspendedLanes&n;break}r.timeoutHandle=yi(jo.bind(null,r,br,Wr),o);break}jo(r,br,Wr);break;case 4:if(to(r,t),(t&4194240)===t)break;for(o=r.eventTimes,n=-1;0<t;){var l=31-Rr(t);a=1<<l,l=o[l],l>n&&(n=l),t&=~a}if(t=n,t=X()-t,t=(120>t?120:480>t?480:1080>t?1080:1920>t?1920:3e3>t?3e3:4320>t?4320:1960*Mg(t/1960))-t,10<t){r.timeoutHandle=yi(jo.bind(null,r,br,Wr),t);break}jo(r,br,Wr);break;case 5:jo(r,br,Wr);break;default:throw Error(h(329))}}}return wr(r,X()),r.callbackNode===e?J0.bind(null,r):null}function Di(r,o){var e=Pe;return r.current.memoizedState.isDehydrated&&(Co(r,o).flags|=256),r=tn(r,o),r!==2&&(o=br,br=e,o!==null&&$i(o)),r}function $i(r){br===null?br=r:br.push.apply(br,r)}function Og(r){for(var o=r;;){if(o.flags&16384){var e=o.updateQueue;if(e!==null&&(e=e.stores,e!==null))for(var t=0;t<e.length;t++){var n=e[t],a=n.getSnapshot;n=n.value;try{if(!Br(a(),n))return!1}catch{return!1}}}if(e=o.child,o.subtreeFlags&16384&&e!==null)e.return=o,o=e;else{if(o===r)break;for(;o.sibling===null;){if(o.return===null||o.return===r)return!0;o=o.return}o.sibling.return=o.return,o=o.sibling}}return!0}function to(r,o){for(o&=~Ea,o&=~wn,r.suspendedLanes|=o,r.pingedLanes&=~o,r=r.expirationTimes;0<o;){var e=31-Rr(o),t=1<<e;r[e]=-1,o&=~t}}function Vl(r){if(L&6)throw Error(h(327));oe();var o=Ot(r,0);if(!(o&1))return wr(r,X()),null;var e=tn(r,o);if(r.tag!==0&&e===2){var t=pi(r);t!==0&&(o=t,e=Di(r,t))}if(e===1)throw e=Je,Co(r,0),to(r,o),wr(r,X()),e;if(e===6)throw Error(h(345));return r.finishedWork=r.current.alternate,r.finishedLanes=o,jo(r,br,Wr),wr(r,X()),null}function _a(r,o){var e=L;L|=1;try{return r(o)}finally{L=e,L===0&&(de=X()+500,bn&&ho())}}function Po(r){io!==null&&io.tag===0&&!(L&6)&&oe();var o=L;L|=1;var e=Cr.transition,t=R;try{if(Cr.transition=null,R=1,r)return r()}finally{R=t,Cr.transition=e,L=o,!(L&6)&&ho()}}function Ua(){ur=Qo.current,O(Qo)}function Co(r,o){r.finishedWork=null,r.finishedLanes=0;var e=r.timeoutHandle;if(e!==-1&&(r.timeoutHandle=-1,fg(e)),Q!==null)for(e=Q.return;e!==null;){var t=e;switch(ba(t),t.tag){case 1:t=t.type.childContextTypes,t!=null&&Ht();break;case 3:ae(),O(mr),O(lr),ya();break;case 5:va(t);break;case 4:ae();break;case 13:O(D);break;case 19:O(D);break;case 10:wa(t.type._context);break;case 22:case 23:Ua()}e=e.return}if(rr=r,Q=r=mo(r.current,null),er=ur=o,J=0,Je=null,Ea=wn=Uo=0,br=Pe=null,zo!==null){for(o=0;o<zo.length;o++)if(e=zo[o],t=e.interleaved,t!==null){e.interleaved=null;var n=t.next,a=e.pending;if(a!==null){var l=a.next;a.next=n,t.next=l}e.pending=t}zo=null}return r}function Z0(r,o){do{var e=Q;try{if(fa(),Et.current=qt,Zt){for(var t=$.memoizedState;t!==null;){var n=t.queue;n!==null&&(n.pending=null),t=t.next}Zt=!1}if(_o=0,q=K=$=null,_e=!1,Qe=0,Aa.current=null,e===null||e.return===null){J=1,Je=o,Q=null;break}r:{var a=r,l=e.return,d=e,s=o;if(o=er,d.flags|=32768,s!==null&&typeof s=="object"&&typeof s.then=="function"){var g=s,u=d,w=u.tag;if(!(u.mode&1)&&(w===0||w===11||w===15)){var f=u.alternate;f?(u.updateQueue=f.updateQueue,u.memoizedState=f.memoizedState,u.lanes=f.lanes):(u.updateQueue=null,u.memoizedState=null)}var v=Ul(l);if(v!==null){v.flags&=-257,Pl(v,l,d,a,o),v.mode&1&&_l(a,g,o),o=v,s=g;var y=o.updateQueue;if(y===null){var k=new Set;k.add(s),o.updateQueue=k}else y.add(s);break r}else{if(!(o&1)){_l(a,g,o),Pa();break r}s=Error(h(426))}}else if(I&&d.mode&1){var F=Ul(l);if(F!==null){!(F.flags&65536)&&(F.flags|=256),Pl(F,l,d,a,o),pa(le(s,d));break r}}a=s=le(s,d),J!==4&&(J=2),Pe===null?Pe=[a]:Pe.push(a),a=l;do{switch(a.tag){case 3:a.flags|=65536,o&=-o,a.lanes|=o;var b=R0(a,s,o);zl(a,b);break r;case 1:d=s;var c=a.type,p=a.stateNode;if(!(a.flags&128)&&(typeof c.getDerivedStateFromError=="function"||p!==null&&typeof p.componentDidCatch=="function"&&(bo===null||!bo.has(p)))){a.flags|=65536,o&=-o,a.lanes|=o;var x=F0(a,d,o);zl(a,x);break r}}a=a.return}while(a!==null)}os(e)}catch(N){o=N,Q===e&&e!==null&&(Q=e=e.return);continue}break}while(!0)}function q0(){var r=rn.current;return rn.current=qt,r===null?qt:r}function Pa(){(J===0||J===3||J===2)&&(J=4),rr===null||!(Uo&268435455)&&!(wn&268435455)||to(rr,er)}function tn(r,o){var e=L;L|=2;var t=q0();(rr!==r||er!==o)&&(Wr=null,Co(r,o));do try{Ig();break}catch(n){Z0(r,n)}while(!0);if(fa(),L=e,rn.current=t,Q!==null)throw Error(h(261));return rr=null,er=0,J}function Ig(){for(;Q!==null;)rs(Q)}function Dg(){for(;Q!==null&&!bc();)rs(Q)}function rs(r){var o=ts(r.alternate,r,ur);r.memoizedProps=r.pendingProps,o===null?os(r):Q=o,Aa.current=null}function os(r){var o=r;do{var e=o.alternate;if(r=o.return,o.flags&32768){if(e=Lg(e,o),e!==null){e.flags&=32767,Q=e;return}if(r!==null)r.flags|=32768,r.subtreeFlags=0,r.deletions=null;else{J=6,Q=null;return}}else if(e=Pg(e,o,ur),e!==null){Q=e;return}if(o=o.sibling,o!==null){Q=o;return}Q=o=r}while(o!==null);J===0&&(J=5)}function jo(r,o,e){var t=R,n=Cr.transition;try{Cr.transition=null,R=1,$g(r,o,e,t)}finally{Cr.transition=n,R=t}return null}function $g(r,o,e,t){do oe();while(io!==null);if(L&6)throw Error(h(327));e=r.finishedWork;var n=r.finishedLanes;if(e===null)return null;if(r.finishedWork=null,r.finishedLanes=0,e===r.current)throw Error(h(177));r.callbackNode=null,r.callbackPriority=0;var a=e.lanes|e.childLanes;if(kc(r,a),r===rr&&(Q=rr=null,er=0),!(e.subtreeFlags&2064)&&!(e.flags&2064)||vt||(vt=!0,ns(Mt,function(){return oe(),null})),a=(e.flags&15990)!==0,e.subtreeFlags&15990||a){a=Cr.transition,Cr.transition=null;var l=R;R=1;var d=L;L|=4,Aa.current=null,Fg(r,e),G0(e,r),dg(hi),It=!!xi,hi=xi=null,r.current=e,Bg(e),pc(),L=d,R=l,Cr.transition=a}else r.current=e;if(vt&&(vt=!1,io=r,en=n),a=r.pendingLanes,a===0&&(bo=null),wc(e.stateNode),wr(r,X()),o!==null)for(t=r.onRecoverableError,e=0;e<o.length;e++)n=o[e],t(n.value,{componentStack:n.stack,digest:n.digest});if(on)throw on=!1,r=Oi,Oi=null,r;return en&1&&r.tag!==0&&oe(),a=r.pendingLanes,a&1?r===Ii?Le++:(Le=0,Ii=r):Le=0,ho(),null}function oe(){if(io!==null){var r=Rd(en),o=Cr.transition,e=R;try{if(Cr.transition=null,R=16>r?16:r,io===null)var t=!1;else{if(r=io,io=null,en=0,L&6)throw Error(h(331));var n=L;for(L|=4,j=r.current;j!==null;){var a=j,l=a.child;if(j.flags&16){var d=a.deletions;if(d!==null){for(var s=0;s<d.length;s++){var g=d[s];for(j=g;j!==null;){var u=j;switch(u.tag){case 0:case 11:case 15:Ue(8,u,a)}var w=u.child;if(w!==null)w.return=u,j=w;else for(;j!==null;){u=j;var f=u.sibling,v=u.return;if(Y0(u),u===g){j=null;break}if(f!==null){f.return=v,j=f;break}j=v}}}var y=a.alternate;if(y!==null){var k=y.child;if(k!==null){y.child=null;do{var F=k.sibling;k.sibling=null,k=F}while(k!==null)}}j=a}}if(a.subtreeFlags&2064&&l!==null)l.return=a,j=l;else r:for(;j!==null;){if(a=j,a.flags&2048)switch(a.tag){case 0:case 11:case 15:Ue(9,a,a.return)}var b=a.sibling;if(b!==null){b.return=a.return,j=b;break r}j=a.return}}var c=r.current;for(j=c;j!==null;){l=j;var p=l.child;if(l.subtreeFlags&2064&&p!==null)p.return=l,j=p;else r:for(l=c;j!==null;){if(d=j,d.flags&2048)try{switch(d.tag){case 0:case 11:case 15:fn(9,d)}}catch(N){H(d,d.return,N)}if(d===l){j=null;break r}var x=d.sibling;if(x!==null){x.return=d.return,j=x;break r}j=d.return}}if(L=n,ho(),Dr&&typeof Dr.onPostCommitFiberRoot=="function")try{Dr.onPostCommitFiberRoot(ln,r)}catch{}t=!0}return t}finally{R=e,Cr.transition=o}}return!1}function Yl(r,o,e){o=le(e,o),o=R0(r,o,1),r=go(r,o,1),o=sr(),r!==null&&(qe(r,1,o),wr(r,o))}function H(r,o,e){if(r.tag===3)Yl(r,r,e);else for(;o!==null;){if(o.tag===3){Yl(o,r,e);break}else if(o.tag===1){var t=o.stateNode;if(typeof o.type.getDerivedStateFromError=="function"||typeof t.componentDidCatch=="function"&&(bo===null||!bo.has(t))){r=le(e,r),r=F0(o,r,1),o=go(o,r,1),r=sr(),o!==null&&(qe(o,1,r),wr(o,r));break}}o=o.return}}function Wg(r,o,e){var t=r.pingCache;t!==null&&t.delete(o),o=sr(),r.pingedLanes|=r.suspendedLanes&e,rr===r&&(er&e)===e&&(J===4||J===3&&(er&130023424)===er&&500>X()-Ta?Co(r,0):Ea|=e),wr(r,o)}function es(r,o){o===0&&(r.mode&1?(o=ct,ct<<=1,!(ct&130023424)&&(ct=4194304)):o=1);var e=sr();r=Kr(r,o),r!==null&&(qe(r,o,e),wr(r,e))}function Hg(r){var o=r.memoizedState,e=0;o!==null&&(e=o.retryLane),es(r,e)}function Vg(r,o){var e=0;switch(r.tag){case 13:var t=r.stateNode,n=r.memoizedState;n!==null&&(e=n.retryLane);break;case 19:t=r.stateNode;break;default:throw Error(h(314))}t!==null&&t.delete(o),es(r,e)}var ts;ts=function(r,o,e){if(r!==null)if(r.memoizedProps!==o.pendingProps||mr.current)pr=!0;else{if(!(r.lanes&e)&&!(o.flags&128))return pr=!1,Ug(r,o,e);pr=!!(r.flags&131072)}else pr=!1,I&&o.flags&1048576&&l0(o,Xt,o.index);switch(o.lanes=0,o.tag){case 2:var t=o.type;_t(r,o),r=o.pendingProps;var n=te(o,lr.current);re(o,e),n=ja(null,o,t,r,n,e);var a=Na();return o.flags|=1,typeof n=="object"&&n!==null&&typeof n.render=="function"&&n.$$typeof===void 0?(o.tag=1,o.memoizedState=null,o.updateQueue=null,fr(t)?(a=!0,Vt(o)):a=!1,o.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,xa(o),n.updater=mn,o.stateNode=n,n._reactInternals=o,Ai(o,t,r,e),o=_i(null,o,t,!0,a,e)):(o.tag=0,I&&a&&ga(o),dr(null,o,n,e),o=o.child),o;case 16:t=o.elementType;r:{switch(_t(r,o),r=o.pendingProps,n=t._init,t=n(t._payload),o.type=t,n=o.tag=Xg(t),r=Ur(t,r),n){case 0:o=Ti(null,o,t,r,e);break r;case 1:o=Fl(null,o,t,r,e);break r;case 11:o=Ll(null,o,t,r,e);break r;case 14:o=Rl(null,o,t,Ur(t.type,r),e);break r}throw Error(h(306,t,""))}return o;case 0:return t=o.type,n=o.pendingProps,n=o.elementType===t?n:Ur(t,n),Ti(r,o,t,n,e);case 1:return t=o.type,n=o.pendingProps,n=o.elementType===t?n:Ur(t,n),Fl(r,o,t,n,e);case 3:r:{if(I0(o),r===null)throw Error(h(387));t=o.pendingProps,a=o.memoizedState,n=a.element,p0(r,o),Kt(o,t,null,e);var l=o.memoizedState;if(t=l.element,a.isDehydrated)if(a={element:t,isDehydrated:!1,cache:l.cache,pendingSuspenseBoundaries:l.pendingSuspenseBoundaries,transitions:l.transitions},o.updateQueue.baseState=a,o.memoizedState=a,o.flags&256){n=le(Error(h(423)),o),o=Bl(r,o,t,e,n);break r}else if(t!==n){n=le(Error(h(424)),o),o=Bl(r,o,t,e,n);break r}else for(xr=co(o.stateNode.containerInfo.firstChild),hr=o,I=!0,Lr=null,e=g0(o,null,t,e),o.child=e;e;)e.flags=e.flags&-3|4096,e=e.sibling;else{if(ne(),t===n){o=Jr(r,o,e);break r}dr(r,o,t,e)}o=o.child}return o;case 5:return m0(o),r===null&&zi(o),t=o.type,n=o.pendingProps,a=r!==null?r.memoizedProps:null,l=n.children,vi(t,n)?l=null:a!==null&&vi(t,a)&&(o.flags|=32),O0(r,o),dr(r,o,l,e),o.child;case 6:return r===null&&zi(o),null;case 13:return D0(r,o,e);case 4:return ha(o,o.stateNode.containerInfo),t=o.pendingProps,r===null?o.child=ie(o,null,t,e):dr(r,o,t,e),o.child;case 11:return t=o.type,n=o.pendingProps,n=o.elementType===t?n:Ur(t,n),Ll(r,o,t,n,e);case 7:return dr(r,o,o.pendingProps,e),o.child;case 8:return dr(r,o,o.pendingProps.children,e),o.child;case 12:return dr(r,o,o.pendingProps.children,e),o.child;case 10:r:{if(t=o.type._context,n=o.pendingProps,a=o.memoizedProps,l=n.value,B(Qt,t._currentValue),t._currentValue=l,a!==null)if(Br(a.value,l)){if(a.children===n.children&&!mr.current){o=Jr(r,o,e);break r}}else for(a=o.child,a!==null&&(a.return=o);a!==null;){var d=a.dependencies;if(d!==null){l=a.child;for(var s=d.firstContext;s!==null;){if(s.context===t){if(a.tag===1){s=Xr(-1,e&-e),s.tag=2;var g=a.updateQueue;if(g!==null){g=g.shared;var u=g.pending;u===null?s.next=s:(s.next=u.next,u.next=s),g.pending=s}}a.lanes|=e,s=a.alternate,s!==null&&(s.lanes|=e),Si(a.return,e,o),d.lanes|=e;break}s=s.next}}else if(a.tag===10)l=a.type===o.type?null:a.child;else if(a.tag===18){if(l=a.return,l===null)throw Error(h(341));l.lanes|=e,d=l.alternate,d!==null&&(d.lanes|=e),Si(l,e,o),l=a.sibling}else l=a.child;if(l!==null)l.return=a;else for(l=a;l!==null;){if(l===o){l=null;break}if(a=l.sibling,a!==null){a.return=l.return,l=a;break}l=l.return}a=l}dr(r,o,n.children,e),o=o.child}return o;case 9:return n=o.type,t=o.pendingProps.children,re(o,e),n=Ar(n),t=t(n),o.flags|=1,dr(r,o,t,e),o.child;case 14:return t=o.type,n=Ur(t,o.pendingProps),n=Ur(t.type,n),Rl(r,o,t,n,e);case 15:return B0(r,o,o.type,o.pendingProps,e);case 17:return t=o.type,n=o.pendingProps,n=o.elementType===t?n:Ur(t,n),_t(r,o),o.tag=1,fr(t)?(r=!0,Vt(o)):r=!1,re(o,e),L0(o,t,n),Ai(o,t,n,e),_i(null,o,t,!0,r,e);case 19:return $0(r,o,e);case 22:return M0(r,o,e)}throw Error(h(156,o.tag))};function ns(r,o){return _d(r,o)}function Yg(r,o,e,t){this.tag=r,this.key=e,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=o,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=t,this.subtreeFlags=this.flags=0,this.deletions=null,this.childLanes=this.lanes=0,this.alternate=null}function Sr(r,o,e,t){return new Yg(r,o,e,t)}function La(r){return r=r.prototype,!(!r||!r.isReactComponent)}function Xg(r){if(typeof r=="function")return La(r)?1:0;if(r!=null){if(r=r.$$typeof,r===qi)return 11;if(r===ra)return 14}return 2}function mo(r,o){var e=r.alternate;return e===null?(e=Sr(r.tag,o,r.key,r.mode),e.elementType=r.elementType,e.type=r.type,e.stateNode=r.stateNode,e.alternate=r,r.alternate=e):(e.pendingProps=o,e.type=r.type,e.flags=0,e.subtreeFlags=0,e.deletions=null),e.flags=r.flags&14680064,e.childLanes=r.childLanes,e.lanes=r.lanes,e.child=r.child,e.memoizedProps=r.memoizedProps,e.memoizedState=r.memoizedState,e.updateQueue=r.updateQueue,o=r.dependencies,e.dependencies=o===null?null:{lanes:o.lanes,firstContext:o.firstContext},e.sibling=r.sibling,e.index=r.index,e.ref=r.ref,e}function Lt(r,o,e,t,n,a){var l=2;if(t=r,typeof r=="function")La(r)&&(l=1);else if(typeof r=="string")l=5;else r:switch(r){case Mo:return Ao(e.children,n,a,o);case Zi:l=8,n|=8;break;case Zn:return r=Sr(12,e,o,n|2),r.elementType=Zn,r.lanes=a,r;case qn:return r=Sr(13,e,o,n),r.elementType=qn,r.lanes=a,r;case ri:return r=Sr(19,e,o,n),r.elementType=ri,r.lanes=a,r;case md:return un(e,n,a,o);default:if(typeof r=="object"&&r!==null)switch(r.$$typeof){case bd:l=10;break r;case pd:l=9;break r;case qi:l=11;break r;case ra:l=14;break r;case ro:l=16,t=null;break r}throw Error(h(130,r==null?r:typeof r,""))}return o=Sr(l,e,o,n),o.elementType=r,o.type=t,o.lanes=a,o}function Ao(r,o,e,t){return r=Sr(7,r,t,o),r.lanes=e,r}function un(r,o,e,t){return r=Sr(22,r,t,o),r.elementType=md,r.lanes=e,r.stateNode={isHidden:!1},r}function Gn(r,o,e){return r=Sr(6,r,null,o),r.lanes=e,r}function Kn(r,o,e){return o=Sr(4,r.children!==null?r.children:[],r.key,o),o.lanes=e,o.stateNode={containerInfo:r.containerInfo,pendingChildren:null,implementation:r.implementation},o}function Qg(r,o,e,t,n){this.tag=o,this.containerInfo=r,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.pendingContext=this.context=null,this.callbackPriority=0,this.eventTimes=Tn(0),this.expirationTimes=Tn(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Tn(0),this.identifierPrefix=t,this.onRecoverableError=n,this.mutableSourceEagerHydrationData=null}function Ra(r,o,e,t,n,a,l,d,s){return r=new Qg(r,o,e,d,s),o===1?(o=1,a===!0&&(o|=8)):o=0,a=Sr(3,null,null,o),r.current=a,a.stateNode=r,a.memoizedState={element:t,isDehydrated:e,cache:null,transitions:null,pendingSuspenseBoundaries:null},xa(a),r}function Gg(r,o,e){var t=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:Bo,key:t==null?null:""+t,children:r,containerInfo:o,implementation:e}}function is(r){if(!r)return wo;r=r._reactInternals;r:{if(Ro(r)!==r||r.tag!==1)throw Error(h(170));var o=r;do{switch(o.tag){case 3:o=o.stateNode.context;break r;case 1:if(fr(o.type)){o=o.stateNode.__reactInternalMemoizedMergedChildContext;break r}}o=o.return}while(o!==null);throw Error(h(171))}if(r.tag===1){var e=r.type;if(fr(e))return i0(r,e,o)}return o}function as(r,o,e,t,n,a,l,d,s){return r=Ra(e,t,!0,r,n,a,l,d,s),r.context=is(null),e=r.current,t=sr(),n=po(e),a=Xr(t,n),a.callback=o??null,go(e,a,n),r.current.lanes=n,qe(r,n,t),wr(r,t),r}function xn(r,o,e,t){var n=o.current,a=sr(),l=po(n);return e=is(e),o.context===null?o.context=e:o.pendingContext=e,o=Xr(a,l),o.payload={element:r},t=t===void 0?null:t,t!==null&&(o.callback=t),r=go(n,o,l),r!==null&&(Fr(r,n,l,a),At(r,n,l)),l}function nn(r){if(r=r.current,!r.child)return null;switch(r.child.tag){case 5:return r.child.stateNode;default:return r.child.stateNode}}function Xl(r,o){if(r=r.memoizedState,r!==null&&r.dehydrated!==null){var e=r.retryLane;r.retryLane=e!==0&&e<o?e:o}}function Fa(r,o){Xl(r,o),(r=r.alternate)&&Xl(r,o)}function Kg(){return null}var ls=typeof reportError=="function"?reportError:function(r){console.error(r)};function Ba(r){this._internalRoot=r}hn.prototype.render=Ba.prototype.render=function(r){var o=this._internalRoot;if(o===null)throw Error(h(409));xn(r,o,null,null)};hn.prototype.unmount=Ba.prototype.unmount=function(){var r=this._internalRoot;if(r!==null){this._internalRoot=null;var o=r.containerInfo;Po(function(){xn(null,r,null,null)}),o[Gr]=null}};function hn(r){this._internalRoot=r}hn.prototype.unstable_scheduleHydration=function(r){if(r){var o=Md();r={blockedOn:null,target:r,priority:o};for(var e=0;e<eo.length&&o!==0&&o<eo[e].priority;e++);eo.splice(e,0,r),e===0&&Id(r)}};function Ma(r){return!(!r||r.nodeType!==1&&r.nodeType!==9&&r.nodeType!==11)}function vn(r){return!(!r||r.nodeType!==1&&r.nodeType!==9&&r.nodeType!==11&&(r.nodeType!==8||r.nodeValue!==" react-mount-point-unstable "))}function Ql(){}function Jg(r,o,e,t,n){if(n){if(typeof t=="function"){var a=t;t=function(){var g=nn(l);a.call(g)}}var l=as(o,t,r,0,null,!1,!1,"",Ql);return r._reactRootContainer=l,r[Gr]=l.current,We(r.nodeType===8?r.parentNode:r),Po(),l}for(;n=r.lastChild;)r.removeChild(n);if(typeof t=="function"){var d=t;t=function(){var g=nn(s);d.call(g)}}var s=Ra(r,0,!1,null,null,!1,!1,"",Ql);return r._reactRootContainer=s,r[Gr]=s.current,We(r.nodeType===8?r.parentNode:r),Po(function(){xn(o,s,e,t)}),s}function yn(r,o,e,t,n){var a=e._reactRootContainer;if(a){var l=a;if(typeof n=="function"){var d=n;n=function(){var s=nn(l);d.call(s)}}xn(o,l,r,n)}else l=Jg(e,o,r,n,t);return nn(l)}Fd=function(r){switch(r.tag){case 3:var o=r.stateNode;if(o.current.memoizedState.isDehydrated){var e=Ne(o.pendingLanes);e!==0&&(ta(o,e|1),wr(o,X()),!(L&6)&&(de=X()+500,ho()))}break;case 13:Po(function(){var t=Kr(r,1);if(t!==null){var n=sr();Fr(t,r,1,n)}}),Fa(r,1)}};na=function(r){if(r.tag===13){var o=Kr(r,134217728);if(o!==null){var e=sr();Fr(o,r,134217728,e)}Fa(r,134217728)}};Bd=function(r){if(r.tag===13){var o=po(r),e=Kr(r,o);if(e!==null){var t=sr();Fr(e,r,o,t)}Fa(r,o)}};Md=function(){return R};Od=function(r,o){var e=R;try{return R=r,o()}finally{R=e}};ci=function(r,o,e){switch(o){case"input":if(ti(r,e),o=e.name,e.type==="radio"&&o!=null){for(e=r;e.parentNode;)e=e.parentNode;for(e=e.querySelectorAll("input[name="+JSON.stringify(""+o)+'][type="radio"]'),o=0;o<e.length;o++){var t=e[o];if(t!==r&&t.form===r.form){var n=gn(t);if(!n)throw Error(h(90));wd(t),ti(t,n)}}}break;case"textarea":xd(r,e);break;case"select":o=e.value,o!=null&&Ko(r,!!e.multiple,o,!1)}};zd=_a;Sd=Po;var Zg={usingClientEntryPoint:!1,Events:[ot,$o,gn,jd,Nd,_a]},ye={findFiberByHostInstance:No,bundleType:0,version:"18.3.1",rendererPackageName:"react-dom"},qg={bundleType:ye.bundleType,version:ye.version,rendererPackageName:ye.rendererPackageName,rendererConfig:ye.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setErrorHandler:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:Zr.ReactCurrentDispatcher,findHostInstanceByFiber:function(r){return r=Ed(r),r===null?null:r.stateNode},findFiberByHostInstance:ye.findFiberByHostInstance||Kg,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null,reconcilerVersion:"18.3.1-next-f1338f8080-20240426"};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"){var yt=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!yt.isDisabled&&yt.supportsFiber)try{ln=yt.inject(qg),Dr=yt}catch{}}yr.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Zg;yr.createPortal=function(r,o){var e=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!Ma(o))throw Error(h(200));return Gg(r,o,null,e)};yr.createRoot=function(r,o){if(!Ma(r))throw Error(h(299));var e=!1,t="",n=ls;return o!=null&&(o.unstable_strictMode===!0&&(e=!0),o.identifierPrefix!==void 0&&(t=o.identifierPrefix),o.onRecoverableError!==void 0&&(n=o.onRecoverableError)),o=Ra(r,1,!1,null,null,e,!1,t,n),r[Gr]=o.current,We(r.nodeType===8?r.parentNode:r),new Ba(o)};yr.findDOMNode=function(r){if(r==null)return null;if(r.nodeType===1)return r;var o=r._reactInternals;if(o===void 0)throw typeof r.render=="function"?Error(h(188)):(r=Object.keys(r).join(","),Error(h(268,r)));return r=Ed(o),r=r===null?null:r.stateNode,r};yr.flushSync=function(r){return Po(r)};yr.hydrate=function(r,o,e){if(!vn(o))throw Error(h(200));return yn(null,r,o,!0,e)};yr.hydrateRoot=function(r,o,e){if(!Ma(r))throw Error(h(405));var t=e!=null&&e.hydratedSources||null,n=!1,a="",l=ls;if(e!=null&&(e.unstable_strictMode===!0&&(n=!0),e.identifierPrefix!==void 0&&(a=e.identifierPrefix),e.onRecoverableError!==void 0&&(l=e.onRecoverableError)),o=as(o,null,r,1,e??null,n,!1,a,l),r[Gr]=o.current,We(r),t)for(r=0;r<t.length;r++)e=t[r],n=e._getVersion,n=n(e._source),o.mutableSourceEagerHydrationData==null?o.mutableSourceEagerHydrationData=[e,n]:o.mutableSourceEagerHydrationData.push(e,n);return new hn(o)};yr.render=function(r,o,e){if(!vn(o))throw Error(h(200));return yn(null,r,o,!1,e)};yr.unmountComponentAtNode=function(r){if(!vn(r))throw Error(h(40));return r._reactRootContainer?(Po(function(){yn(null,null,r,!1,function(){r._reactRootContainer=null,r[Gr]=null})}),!0):!1};yr.unstable_batchedUpdates=_a;yr.unstable_renderSubtreeIntoContainer=function(r,o,e,t){if(!vn(e))throw Error(h(200));if(r==null||r._reactInternals===void 0)throw Error(h(38));return yn(r,o,e,!1,t)};yr.version="18.3.1-next-f1338f8080-20240426";function ds(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(ds)}catch(r){console.error(r)}}ds(),dd.exports=yr;var rb=dd.exports,ss,Gl=rb;ss=Gl.createRoot,Gl.hydrateRoot;const Oa=G.createContext({}),ob=({children:r})=>{const[o,e]=G.useState(!1);return i.jsx(Oa.Provider,{value:{shouldExpandAll:o,setShouldExpandAll:e},children:r})},eb=({className:r})=>i.jsx("svg",{className:r,xmlns:"http://www.w3.org/2000/svg",height:"24px",viewBox:"0 -960 960 960",width:"24px",children:i.jsx("path",{d:"M480-528 296-344l-56-56 240-240 240 240-56 56-184-184Z"})}),tb=({className:r})=>i.jsx("svg",{className:r,xmlns:"http://www.w3.org/2000/svg",height:"24px",viewBox:"0 -960 960 960",width:"24px",children:i.jsx("path",{d:"M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"})}),nb=({className:r})=>i.jsx("svg",{className:r,xmlns:"http://www.w3.org/2000/svg",height:"24px",viewBox:"0 -960 960 960",width:"24px",children:i.jsx("path",{d:"M480-120 300-300l58-58 122 122 122-122 58 58-180 180ZM358-598l-58-58 180-180 180 180-58 58-122-122-122 122Z"})}),ib=({className:r})=>i.jsx("svg",{className:r,xmlns:"http://www.w3.org/2000/svg",height:"24px",viewBox:"0 -960 960 960",width:"24px",children:i.jsx("path",{d:"m356-160-56-56 180-180 180 180-56 56-124-124-124 124Zm124-404L300-744l56-56 124 124 124-124 56 56-180 180Z"})}),ab=({className:r})=>i.jsx("svg",{className:r,xmlns:"http://www.w3.org/2000/svg",height:"24px",viewBox:"0 -960 960 960",width:"24px",children:i.jsx("path",{d:"M440-280H280q-83 0-141.5-58.5T80-480q0-83 58.5-141.5T280-680h160v80H280q-50 0-85 35t-35 85q0 50 35 85t85 35h160v80ZM320-440v-80h320v80H320Zm200 160v-80h160q50 0 85-35t35-85q0-50-35-85t-85-35H520v-80h160q83 0 141.5 58.5T880-480q0 83-58.5 141.5T680-280H520Z"})}),lb=({className:r})=>i.jsx("svg",{className:r,xmlns:"http://www.w3.org/2000/svg",height:"24px",viewBox:"0 -960 960 960",width:"24px",children:i.jsx("path",{d:"M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"})}),db=({className:r})=>i.jsx("svg",{className:r,xmlns:"http://www.w3.org/2000/svg",height:"24px",viewBox:"0 -960 960 960",width:"24px",children:i.jsx("path",{d:"m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"})}),Wi=({className:r,Icon:o,text:e,onClick:t})=>i.jsxs("button",{className:`flex justify-center rounded-full border-2 border-neutral-500 bg-neutral-50 transition hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 ${r??""}`,onClick:t,children:[o,i.jsx("p",{children:e})]}),sb=({category:r,detailedDocumentations:o})=>i.jsx("div",{className:"mb-8 inline-block w-full",children:i.jsxs(cb,{children:[i.jsx(gb,{category:r}),o.map(e=>i.jsx(bb,{detailedDocumentation:e},e.entry))]})}),cb=({children:r})=>i.jsx("div",{className:"rounded-xl bg-neutral-50 shadow-md shadow-neutral-400 dark:bg-neutral-700 dark:shadow-neutral-950",children:r}),gb=({category:r})=>i.jsx("h2",{className:"whitespace-pre-line break-keep p-2 text-center text-xl font-bold text-orange-500",children:r}),bb=({detailedDocumentation:r})=>{const[o,e]=G.useState(!1),{shouldExpandAll:t,setShouldExpandAll:n}=G.useContext(Oa);G.useEffect(()=>{t!=null&&e(t)},[t]);const a=()=>{e(!o),n(null)};return i.jsxs("div",{children:[i.jsx(pb,{detailedDocumentation:r,handleEntryClick:a}),i.jsxs("div",{className:"space-y-2 p-2",children:[i.jsx(mb,{detailedDocumentation:r}),o&&i.jsxs(i.Fragment,{children:[r.detail,i.jsx(fb,{detailedDocumentation:r})]})]})]})},pb=({detailedDocumentation:r,handleEntryClick:o})=>i.jsxs("div",{className:"flex cursor-pointer justify-between whitespace-pre-line border-t-2 border-neutral-500 bg-neutral-200 p-2 transition hover:bg-neutral-300 dark:bg-neutral-800 dark:hover:bg-neutral-600",onClick:o,children:[i.jsx("h3",{children:r.entry}),i.jsx("a",{className:"content-center",href:r.url,target:"_blank",onClick:e=>{e.stopPropagation()},children:i.jsx(ab,{className:"w-10 rounded-full fill-neutral-500 transition hover:bg-neutral-200 hover:fill-sky-400 dark:hover:bg-neutral-500"})})]}),mb=({detailedDocumentation:r})=>i.jsx("p",{className:"whitespace-pre-line text-sm",children:r.description}),fb=({detailedDocumentation:r})=>{const[o,e]=G.useState(!1),[t,n]=G.useState(!1),a=G.useRef(null);return G.useEffect(()=>{var d;const l=(d=a.current)==null?void 0:d.getBoundingClientRect().height;l!=null&&l>192&&n(!0)},[]),i.jsxs(i.Fragment,{children:[i.jsx("div",{className:`overflow-clip ${o?"":"max-h-[192px]"}`,children:i.jsx("table",{className:"w-full table-fixed border-collapse overflow-clip whitespace-pre-line rounded-lg outline outline-2 -outline-offset-2 outline-stone-400 dark:outline-stone-500",ref:a,children:r.entry.includes("Container")?i.jsx(ub,{documentation:r}):i.jsx(wb,{documentation:r,shouldExpand:o})})}),t&&i.jsx(Wi,{className:"w-full",Icon:o?i.jsx(eb,{className:"fill-neutral-500"}):i.jsx(tb,{className:"fill-neutral-500"}),text:"",onClick:()=>e(!o)})]})},wb=({documentation:r,shouldExpand:o})=>i.jsx("tbody",{children:r.parameters.filter((e,t)=>o?!0:t<9).map((e,t)=>i.jsx("tr",{className:"odd:bg-stone-100 even:bg-stone-200 dark:odd:bg-stone-700 dark:even:bg-stone-800",children:e.map(n=>i.jsx("td",{className:"px-2 py-1 text-xs text-neutral-700 first:text-blue-700 last:text-green-700 dark:text-neutral-300 dark:first:text-blue-300 dark:last:text-green-300",children:n},n))},t))}),ub=({documentation:r})=>i.jsx("tbody",{children:r.parameters.map((o,e)=>i.jsx("tr",{className:"odd:bg-neutral-100 even:bg-stone-200 dark:odd:bg-stone-700 dark:even:bg-stone-800",children:o.map((t,n)=>i.jsx("td",{className:`px-2 py-1 text-xs text-neutral-700 last:text-green-700 dark:text-neutral-300 dark:last:text-green-300 ${e===0?"first:text-blue-700 dark:first:text-blue-300":""}`,rowSpan:e===0&&n===0?6:void 0,children:t},t))},e))}),xb="v3.4.13",cs=[{url:"https://tailwindcss.com/docs/aspect-ratio",entry:"Aspect Ratio",description:"Utilities for controlling the aspect ratio of an element.",parameters:[["aspect-auto",`aspect-ratio: auto;
...
`]]}],bs=[{url:"https://tailwindcss.com/docs/padding",entry:"Padding",description:"Utilities for controlling an element's padding.",parameters:[["p-0",`padding: 0px;
...
`]]}],ps=[{url:"https://tailwindcss.com/docs/width",entry:"Width",description:"Utilities for setting the width of an element.",parameters:[["w-0",`width: 0px;
`],["w-px",`width: 1px;
...
height: fit-content;
`]]}],ms=[{url:"https://tailwindcss.com/docs/font-family",entry:"Font Family",description:"Utilities for controlling the font family of an element.",parameters:[["font-sans",`font-family: ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
...
`]]}],fs=[{url:"https://tailwindcss.com/docs/background-attachment",entry:"Background Attachment",description:"Utilities for controlling how a background image behaves when scrolling.",parameters:[["bg-fixed",`background-attachment: fixed;
...
`,""]]}],ws=[{url:"https://tailwindcss.com/docs/border-radius",entry:"Border Radius",description:"Utilities for controlling the border radius of an element.",parameters:[["rounded-none",`border-radius: 0px;
...
box-shadow: 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color), var(--tw-ring-shadow);
`]]}],us=[{url:"https://tailwindcss.com/docs/box-shadow",entry:"Box Shadow",description:"Utilities for controlling the box shadow of an element.",parameters:[["shadow-sm",`box-shadow: 0 1px 2px 0 rgb(0 0 0 / 0.05);
...
`]]}],xs=[{url:"https://tailwindcss.com/docs/blur",entry:"Blur",description:"Utilities for applying blur filters to an element.",parameters:[["blur-none",`filter:  ;
...
`]]}],hs=[{url:"https://tailwindcss.com/docs/border-collapse",entry:"Border Collapse",description:"Utilities for controlling whether table borders should collapse or be separated.",parameters:[["border-collapse",`border-collapse: collapse;
...
`]]}],vs=[{url:"https://tailwindcss.com/docs/transition-property",entry:"Transition Property",description:"Utilities for controlling which CSS properties transition.",parameters:[["transition-none",`transition-property: none;
...
}`]]}],ys=[{url:"https://tailwindcss.com/docs/scale",entry:"Scale",description:"Utilities for scaling elements with transform.",parameters:[["scale-0",`transform: scale(0);
...
`]]}],ks=[{url:"https://tailwindcss.com/docs/accent-color",entry:"Accent Color",description:"Utilities for controlling the accented color of a form control.",parameters:[["accent-inherit",`accent-color: inherit;
...
`]]}],js=[{url:"https://tailwindcss.com/docs/fill",entry:"Fill",description:"Utilities for styling the fill of SVG elements.",parameters:[["fill-none",`fill: none;
...
`]]}],Ns=[{url:"https://tailwindcss.com/docs/screen-readers",entry:"Screen Readers",description:"Utilities for improving accessibility with screen readers.",parameters:[["sr-only",`position: absolute;
width: 1px;
height: 1px;
padding: 0;
margin: -1px;
...
`]]}],m=({value:r})=>i.jsx("table",{className:"border-separate border-spacing-y-1 text-sm leading-4 text-gray-500 dark:text-gray-300",children:i.jsx("tbody",{children:r.map(([o,e,t])=>i.jsxs("tr",{children:[(t==null?void 0:t.type)==="td"?t:null,i.jsx("td",{className:"whitespace-pre bg-gray-200 px-1 dark:bg-neutral-600",children:o}),i.jsx("td",{className:"px-1",children:e})]},o))})}),hb=new Map([[E.Layout,{entry:"レイアウト",description:"",detail:null}],["Aspect Ratio",{entry:"アスペクト比",description:"要素のアスペクト比を指定する",detail:i.jsx(m,{value:[["auto","自動"],["square","1:1で固定"],["video","16:9で固定"]]})}],["Container",{entry:"コンテナー",description:"ビューポートの幅に応じて要素の最大幅を640px未満、640px、768px、1024px、1280px、1536pxと段階的に変化させる",detail:null}],["Columns",{entry:"列",description:`要素のコンテンツ領域を縦に分割する
分割する数、または幅を指定する`,detail:null}],["Break After",{entry:"後の区切り",description:"要素の後における、印刷時の改ページや段区切りの動作を指定する",detail:i.jsx(m,{value:[["auto","自動"],["avoid","改ページや段区切りを禁止する"],["all","強制的に改ページする"],["avoid-page","改ページを禁止する"],["page","改ページする"],["left","次のページが左側に来るよう改ページする"],["right","次のページが右側に来るよう改ページする"],["column","段区切りする"]]})}],["Break Before",{entry:"前の区切り",description:"要素の前における、印刷時の改ページや段区切りの動作を指定する",detail:i.jsx(m,{value:[["auto","自動"],["avoid","改ページや段区切りを禁止する"],["all","強制的に改ページする"],["avoid-page","改ページを禁止する"],["page","改ページする"],["left","次のページが左側に来るよう改ページする"],["right","次のページが右側に来るよう改ページする"],["column","段区切りする"]]})}],["Break Inside",{entry:"中の区切り",description:"要素の中における、印刷時の改ページや段区切りの動作を指定する",detail:i.jsx(m,{value:[["auto","自動"],["avoid","改ページや段区切りを禁止する"],["avoid-page","改ページを禁止する"],["avoid-column","段区切りを禁止する"]]})}],["Box Decoration Break",{entry:"区切られたボックスの装飾",description:"要素が複数の行、段、ページに区切られる場合の装飾方法を指定する",detail:i.jsx(m,{value:[["clone","それぞれの断片ごとに装飾する"],["slice","断片化していない状態で装飾。それから行、段、ページに区切られる"]]})}],["Box Sizing",{entry:"ボックス寸法",description:"要素の幅と高さを求めるための領域を指定する",detail:i.jsx(m,{value:[["border","境界や余白を含めて要素の寸法とする"],["content","コンテンツ領域を要素の寸法とする"]]})}],["Display",{entry:"ディスプレイ",description:"要素の表示方法を指定する",detail:i.jsx(m,{value:[["block","前後に改行を生成し、要素を縦に並べる"],["inline-block","前後に改行を生成しない"],["inline","前後に改行を生成しない。垂直方向の境界や余白を無視する"],["flex","Flexboxカテゴリーのクラス名と併用することで、複雑なレイアウトを実現する"],["inline-flex","inline + flexの効果"],["table","<table>要素と同じく動作する"],["inline-table","inline + tableの効果"],["table-caption","<caption>要素と同じく動作する"],["table-cell","<td>要素と同じく動作する"],["table-column","<col>要素と同じく動作する"],["table-column-group","<colgroup>要素と同じく動作する"],["table-footer-group","<tfoot>要素と同じく動作する"],["table-header-group","<thead>要素と同じく動作する"],["table-row-group","<tbody>要素と同じく動作する"],["table-row","<tr>要素と同じく動作する"],["flow-root","子要素がFloatsのクラス名を使用している場合に、その回り込みを解除する"],["grid","子要素をタイル状に配置する"],["inline-grid","inline + gridの効果"],["contents","ボックスを生成せずに、コンテンツ領域だけを表示する"],["list-item","<li>要素と同じく動作する"],["hidden","要素を非表示にする"]]})}],["Floats",{entry:"フロート",description:"要素を左右どちらかに配置し、その横に余白があれば続く要素を回り込ませる",detail:i.jsx(m,{value:[["start","テキストの開始側に配置"],["end","テキストの終端側に配置"],["right","右端に配置"],["left","左端に配置"],["none","フロートしない"]]})}],["Clear",{entry:"クリアー",description:"Floatsの効果を打ち消し、自身の要素が回り込もうとするのを防ぐ",detail:i.jsx(m,{value:[["start","テキストの開始側にある要素のFloatsの効果を打ち消す"],["end","テキストの終端側にある要素のFloatsの効果を打ち消す"],["left","左端にある要素のFloatsの効果を打ち消す"],["right","右端にある要素のFloatsの効果を打ち消す"],["both","左右どちらでもFloatsの効果を打ち消す"],["none","Floatsの効果を受け入れる"]]})}],["Isolation",{entry:"隔離",description:"子要素の存在を内に留め、外部の要素と相互に作用させない",detail:i.jsx(m,{value:[["isolate","子要素を隔離する"],["isolation-auto","自動"]]})}],["Object Fit",{entry:"オブジェクトフィット",description:"コンテンツの表示方法を指定する",detail:i.jsx(m,{value:[["contain","コンテンツ全体が要素に収まるように拡大縮小する"],["cover","要素全体を覆うように拡大縮小する"],["fill","元のアスペクト比を無視して、要素全体を覆うように拡大縮小する"],["none","等倍で表示する"],["scale-down","等倍で表示する。ただし、はみ出す場合は縮小する"]]})}],["Object Position",{entry:"オブジェクト位置",description:"コンテンツが要素からはみ出す場合に、メインで見せたい位置を指定する",detail:i.jsx(m,{value:[["bottom","下"],["center","中央"],["left","左"],["left-bottom","左下"],["left-top","左上"],["right","右"],["right-bottom","右下"],["right-top","右上"],["top","上"]]})}],["Overflow",{entry:"オーバーフロー",description:"コンテンツが要素からはみ出す場合の動作を指定する",detail:i.jsx(m,{value:[["auto","自動"],["hidden","切り取る。ユーザーからのスクロール操作は受け付けないが、プログラムからは許可する"],["clip","切り取る。全てのスクロール操作を禁止する"],["visible","切り取らない"],["scroll","スクロール可能にする"],["x-*","水平方向に対する動作"],["y-*","垂直方向に対する動作"]]})}],["Overscroll Behavior",{entry:"オーバースクロール動作",description:"スクロール領域の限界に達したときの動作を指定する",detail:i.jsx(m,{value:[["auto","バウンスする。限界に達した状態でさらにスクロールすると、親要素へ伝播する"],["contain","バウンスする。スクロールを親要素へ伝播させない"],["none","バウンスしない。スクロールを親要素へ伝播させない"],["y-*","垂直方向に対する動作"],["x-*","水平方向に対する動作"]]})}],["Position",{entry:"位置",description:"要素の配置方法を指定する",detail:i.jsx(m,{value:[["static","デフォルトの動作。オフセット操作（Top、Right、Bottom、Left、Z-Index）を受け付けない"],["fixed","ブラウザの表示領域を基準に、オフセット操作を受け付ける"],["absolute","relativeが指定された親要素を基準に、オフセット操作を受け付ける"],["relative","デフォルトの動作で配置しつつ、オフセット操作を受け付ける"],["sticky","fixedのように振る舞うが、親要素が画面外に押し出されると自身も押し出される"]]})}],["Top / Right / Bottom / Left",{entry:"トップ、ライト、ボトム、レフト",description:"指定した位置に要素を配置する",detail:i.jsx(m,{value:[["inset-*","top、right、bottom、leftに同じ値を指定する"],["inset-x-*","leftとrightに同じ値を指定する"],["inset-y-*","topとbottomに同じ値を指定する"],["start-*","テキストの開始側に値を指定する"],["end-*","テキストの終端側に値を指定する"],["top-*","上からの距離の位置に配置"],["right-*","右からの距離の位置に配置"],["bottom-*","下からの距離の位置に配置"],["left-*","左からの距離の位置に配置"]]})}],["Visibility",{entry:"可視性",description:"要素の可視状態を指定する",detail:i.jsx(m,{value:[["visible","表示"],["invisible","レイアウトは維持したまま非表示（完全に非表示にしたい場合はhiddenを指定）"],["collapse","テーブル列の幅を維持したまま、一部の行を非表示"]]})}],["Z-Index",{entry:"Zインデックス",description:"要素の重なり順を指定する",detail:null}]]),vb=new Map([[E.FlexboxAndGrid,{entry:"フレックスボックス＆グリッド",description:"",detail:null}],["Flex Basis",{entry:"フレックスベーシス",description:`親要素にflexが指定されている場合の、自身の初期サイズを指定する
親要素にflex-rowが指定されている場合はwidth、flex-colが指定されている場合はheightとして動作する`,detail:null}],["Flex Direction",{entry:"フレックスの方向",description:"flexの子要素の並べ方を指定する",detail:i.jsx(m,{value:[["row","左から右へ並べる"],["row-reverse","右から左へ並べる"],["col","上から下へ並べる"],["col-reverse","下から上へ並べる"]]})}],["Flex Wrap",{entry:"フレックスラップ",description:"flexの子要素を配置する際に、はみ出す場合の折り返し動作を指定する",detail:i.jsx(m,{value:[["wrap","複数行に折り返す"],["wrap-reverse","複数行に折り返す。折り返した行は上に積み上がる"],["nowrap","折り返さない"]]})}],["Flex",{entry:"フレックス",description:"Flex Basis、Flex Grow、Flex Shrinkを一度に設定し、親要素のサイズに合わせた自身の伸び縮みを指定する",detail:i.jsx(m,{value:[["1","自身のwidth、またはheightのサイズを無視して伸び縮みする"],["auto","自身のwidth、またはheightのサイズを考慮して伸び縮みする"],["initial","縮みはするが、親要素の空きを埋めるために伸びはしない"],["none","初期サイズのまま固定する"]]})}],["Flex Grow",{entry:"フレックスの伸び",description:"flexが指定されている親要素に空間があれば、自身を伸ばすかどうかを指定する",detail:i.jsx(m,{value:[["grow","伸ばす"],["grow-0","伸ばさない"]]})}],["Flex Shrink",{entry:"フレックスの縮み",description:"flexが指定されている親要素からはみ出す場合に、自身を縮めるかどうかを指定する",detail:i.jsx(m,{value:[["shrink","縮める"],["shrink-0","縮めない"]]})}],["Order",{entry:"オーダー",description:"flexやgridの子要素の並びに対して、自身を何番目に差し込むかを指定する",detail:null}],["Grid Template Columns",{entry:"グリッドテンプレートの列",description:"gridの列を指定する",detail:i.jsx(m,{value:[["*","指定した数だけ等間隔の列を作成する"],["none","グリッドレイアウトを解除する"],["subgrid","グリッドの中にグリッドを配置する場合に、親グリッドのレイアウトを子グリッドに引き継がせる"]]})}],["Grid Column Start / End",{entry:"グリッド列スタート／エンド",description:"gridの複数のセルを水平方向に連結する",detail:i.jsx(m,{value:[["auto","自動"],["span-*","指定した数だけセルを連結する"],["start-*","連結の開始位置を指定する"],["end-*","連結の終端位置を指定する"]]})}],["Grid Template Rows",{entry:"グリッドテンプレートの行",description:"gridの行を指定する",detail:i.jsx(m,{value:[["*","指定した数だけ等間隔の行を作成する"],["none","グリッドレイアウトを解除する"],["subgrid","グリッドの中にグリッドを配置する場合に、親グリッドのレイアウトを子グリッドに引き継がせる"]]})}],["Grid Row Start / End",{entry:"グリッド行スタート／エンド",description:"gridの複数のセルを垂直方向に連結する",detail:i.jsx(m,{value:[["auto","自動"],["span-*","指定した数だけセルを連結する"],["start-*","連結の開始位置を指定する"],["end-*","連結の終端位置を指定する"]]})}],["Grid Auto Flow",{entry:"グリッドオートフロー",description:"gridの子要素の並べ方を指定する",detail:i.jsx(m,{value:[["row","右方向へ子要素を並べ、下に向かって折り返す"],["col","下方向へ子要素を並べ、右に向かって折り返す"],["dense","可能な限りセルを埋めるように子要素を並べる"],["row-dense","row + denseの効果"],["col-dense","col + denseの効果"]]})}],["Grid Auto Columns",{entry:"グリッドオート列",description:"セルの連結具合を元に、gridの列数を自動的に決定。その際の列の幅の計算方法を指定する",detail:i.jsx(m,{value:[["auto","自動"],["min","子要素のコンテンツの最小幅を元に、列の幅を決定する（例えば「Hello, world!」というテキストの場合、半角スペースの箇所で折り返せるため6文字分が最小幅）"],["max","子要素のコンテンツの最大幅を元に、列の幅を決定する（例えば「Hello, world!」であれば全体の13文字分が最大幅）"],["fr","等間隔の列を作る"]]})}],["Grid Auto Rows",{entry:"グリッドオート行",description:"セルの連結具合を元に、gridの行数を自動的に決定。その際の行の高さの計算方法を指定する",detail:i.jsx(m,{value:[["auto","自動"],["min","子要素のコンテンツの最小高さを元に、行の高さを決定する（縦書きで有効）"],["max","子要素のコンテンツの最大高さを元に、行の高さを決定する（縦書きで有効）"],["fr","等間隔の行を作る"]]})}],["Gap",{entry:"隙間",description:"flexやgridの子要素同士の隙間の長さを指定する",detail:i.jsx(m,{value:[["*","水平、垂直の両方向に指定した長さの隙間を挟む"],["x-*","水平方向に指定した幅の隙間を挟む"],["y-*","垂直方向に指定した高さの隙間を挟む"]]})}],["Justify Content",{entry:"コンテンツの行揃え",description:"flexやgridの行揃えを指定する",detail:i.jsx(m,{value:[["normal","flexではstart、gridではstretchの動作"],["start","水平方向の開始側に寄せる"],["end","水平方向の終端側に寄せる"],["center","中央揃え"],["between","行の最初と最後の子要素を両端に配置し、残りの子要素を均等に配置する"],["around","各子要素が持つ両脇の空間の幅が等しくなるように配置する"],["evenly","各空間の幅が等しくなるように配置する"],["stretch","隙間を埋めるように子要素を引き延ばして配置する（gridで有効）"]]})}],["Justify Items",{entry:"アイテムの行揃え",description:"gridのセル内での配置方法を指定する",detail:i.jsx(m,{value:[["start","水平方向の開始側に寄せる"],["end","水平方向の終端側に寄せる"],["center","中央揃え"],["stretch","隙間を埋めるように子要素を引き延ばす"]]})}],["Justify Self",{entry:"自身の行揃え",description:"Justify Itemsの効果を打ち消し、セル内での自身の配置方法を強制する",detail:i.jsx(m,{value:[["auto","Justify Itemsの効果を受け入れる"],["start","水平方向の開始側に寄せる"],["end","水平方向の終端側に寄せる"],["center","中央揃え"],["stretch","隙間を埋めるように子要素を引き延ばす"]]})}],["Align Content",{entry:"コンテンツの整列",description:"flexやgridの垂直方向の揃えを指定する",detail:i.jsx(m,{value:[["normal","flexではstart、gridではstretchの動作"],["start","垂直方向の開始側に寄せる"],["end","垂直方向の終端側に寄せる"],["center","中央揃え"],["between","列の最初と最後の子要素を両端に配置し、残りの子要素を均等に配置する"],["around","各子要素が持つ上下の空間の高さが等しくなるように配置する"],["evenly","各空間の高さが等しくなるように配置する"],["baseline","startと同じ動作"],["stretch","隙間を埋めるように子要素を引き延ばす（gridで有効）"]]})}],["Align Items",{entry:"アイテムの整列",description:"gridのセル内での配置方法を指定する",detail:i.jsx(m,{value:[["start","垂直方向の開始側に寄せる"],["end","垂直方向の終端側に寄せる"],["center","中央揃え"],["baseline","コンテンツのベースラインが横に揃うように配置する"],["stretch","隙間を埋めるように子要素を引き延ばす"]]})}],["Align Self",{entry:"自身の整列",description:"Align Itemsの効果を打ち消し、セル内での自身の配置方法を強制する",detail:i.jsx(m,{value:[["auto","Align Itemsの効果を受け入れる"],["start","垂直方向の開始側に寄せる"],["end","垂直方向の終端側に寄せる"],["center","中央揃え"],["baseline","startと同じ動作"],["stretch","隙間を埋めるように子要素を引き延ばす"]]})}],["Place Content",{entry:"コンテンツの場所",description:"Justify ContentとAlign Contentを一度に指定する",detail:i.jsx(m,{value:[["center","子要素を中央に引き寄せるように配置する"],["start","子要素を開始側の角に引き寄せるように配置する"],["end","子要素を終端側の角に引き寄せるように配置する"],["between","子要素を中心から離れるように配置する"],["around","子要素が持つ周囲の空間が同じ広さになるように配置する"],["evenly","子要素を縦に通るライン上の空間の高さと、横に通るライン上の空間の幅が、それぞれ同じ長さになるように配置する"],["baseline","startと同じ動作"],["stretch","セルの隙間を埋めるように子要素を引き延ばす（gridで有効）"]]})}],["Place Items",{entry:"アイテムの場所",description:"Justify ItemsとAlign Itemsを一度に指定する",detail:i.jsx(m,{value:[["start","セルの開始側の角に配置する"],["end","セルの終端側の角に配置する"],["center","セルの中央に配置する"],["baseline","セルの水平方向の開始側に寄せつつ、コンテンツのベースラインが横に揃うように配置する"],["stretch","セルの隙間を埋めるように子要素を引き延ばす"]]})}],["Place Self",{entry:"自身の場所",description:"Justify SelfとAlign Selfを一度に指定する",detail:i.jsx(m,{value:[["auto","Place Itemsの効果を受け入れる"],["start","セルの開始側の角に配置する"],["end","セルの終端側の角に配置する"],["center","セルの中央に配置する"],["stretch","セルの隙間を埋めるように子要素を引き延ばす"]]})}]]),yb=new Map([[E.Spacing,{entry:"空間",description:"",detail:null}],["Padding",{entry:"パディング",description:"要素の内側に指定した長さの余白を与える",detail:i.jsx(m,{value:[["p-*","上下左右に余白を与える"],["px-*","水平方向に余白を与える"],["py-*","垂直方向に余白を与える"],["ps-*","テキストの開始側に余白を与える"],["pe-*","テキストの終端側に余白を与える"],["pt-*","上側に余白を与える"],["pr-*","右側に余白を与える"],["pb-*","下側に余白を与える"],["pl-*","左側に余白を与える"]]})}],["Margin",{entry:"マージン",description:"要素の外側に指定した長さの余白を与える",detail:i.jsx(m,{value:[["m-*","上下左右に余白を与える"],["mx-*","水平方向に余白を与える"],["my-*","垂直方向に余白を与える"],["ms-*","テキストの開始側に余白を与える"],["me-*","テキストの終端側に余白を与える"],["mt-*","上側に余白を与える"],["mr-*","右側に余白を与える"],["mb-*","下側に余白を与える"],["ml-*","左側に余白を与える"]]})}],["Space Between",{entry:"要素間の空間",description:"子要素が縦や横に並ぶ場合の、子要素同士の隙間の長さを指定する",detail:i.jsx(m,{value:[["x-*","水平方向に指定した長さの隙間を挟む"],["y-*","垂直方向に指定した長さの隙間を挟む"],["y-reverse","下から上へ要素が並ぶ場合に、隙間を正しい位置に挟む"],["x-reverse","右から左へ要素が並ぶ場合に、隙間を正しい位置に挟む"]]})}]]),kb=new Map([[E.Sizing,{entry:"寸法",description:"",detail:null}],["Width",{entry:"幅",description:"要素の幅を指定する",detail:i.jsx(m,{value:[["*","指定した長さ、または親要素に対する割合で指定する"],["auto","自動"],["full","親要素の幅で指定する"],["screen","ビューポートの幅で指定する"],["svw","スモールビューポートの幅で指定する"],["lvw","ラージビューポートの幅で指定する"],["dvw","ダイナミックビューポートの幅で指定する"],["min","コンテンツの最小幅で指定する（例えば「Hello, world!」というテキストの場合、半角スペースの箇所で折り返せるため6文字分が最小幅）"],["max","コンテンツの最大幅で指定する（例えば「Hello, world!」であれば全体の13文字分が最大幅）"],["fit","親要素からはみ出す場合にmaxでは折り返しが発生しないが、fitでは折り返す"]]})}],["Min-Width",{entry:"最小幅",description:"要素の最小幅を指定する",detail:i.jsx(m,{value:[["*","指定した長さで指定する"],["full","親要素の幅で指定する"],["min","コンテンツの最小幅で指定する（例えば「Hello, world!」というテキストの場合、半角スペースの箇所で折り返せるため6文字分が最小幅）"],["max","コンテンツの最大幅で指定する（例えば「Hello, world!」であれば全体の13文字分が最大幅）"],["fit","親要素からはみ出す場合にmaxでは折り返しが発生しないが、fitでは折り返す"]]})}],["Max-Width",{entry:"最大幅",description:"要素の最大幅を指定する",detail:i.jsx(m,{value:[["*","指定した長さで指定する"],["none","最大幅を指定しない"],["full","親要素の幅で指定する"],["min","コンテンツの最小幅で指定する（例えば「Hello, world!」というテキストの場合、半角スペースの箇所で折り返せるため6文字分が最小幅）"],["max","コンテンツの最大幅で指定する（例えば「Hello, world!」であれば全体の13文字分が最大幅）"],["fit","はみ出す場合にmaxでは折り返しが発生しないが、fitでは折り返す"],["prose","半角数字0の幅を基準に、65文字分が収まる幅で指定する"],["screen-*","sm = 640px、md = 768px、lg = 1024px、lx = 1280px、2xl = 1536px"]]})}],["Height",{entry:"高さ",description:"要素の高さを指定する",detail:i.jsx(m,{value:[["*","指定した長さ、または親要素に対する割合で指定する"],["auto","自動"],["full","親要素の高さで指定する"],["screen","ビューポートの高さで指定する"],["svw","スモールビューポートの高さで指定する"],["lvw","ラージビューポートの高さで指定する"],["dvw","ダイナミックビューポートの高さで指定する"],["min","コンテンツの最小高さで指定する（縦書きで有効）"],["max","コンテンツの最大高さで指定する（縦書きで有効）"],["fit","親要素からはみ出す場合にmaxでは折り返しが発生しないが、fitでは折り返す（縦書きで有効）"]]})}],["Min-Height",{entry:"最小高さ",description:"要素の最小高さを指定する",detail:i.jsx(m,{value:[["*","指定した長さで指定する"],["full","親要素の高さで指定する"],["screen","ビューポートの高さで指定する"],["svw","スモールビューポートの高さで指定する"],["lvw","ラージビューポートの高さで指定する"],["dvw","ダイナミックビューポートの高さで指定する"],["min","コンテンツの最小高さで指定する（縦書きで有効）"],["max","コンテンツの最大高さで指定する（縦書きで有効）"],["fit","親要素からはみ出す場合にmaxでは折り返しが発生しないが、fitでは折り返す（縦書きで有効）"]]})}],["Max-Height",{entry:"最大高さ",description:"要素の最大高さを指定する",detail:i.jsx(m,{value:[["*","指定した長さで指定する"],["none","最大高さを指定しない"],["full","親要素の高さで指定する"],["screen","ビューポートの高さで指定する"],["svw","スモールビューポートの高さで指定する"],["lvw","ラージビューポートの高さで指定する"],["dvw","ダイナミックビューポートの高さで指定する"],["min","コンテンツの最小高さで指定する（縦書きで有効）"],["max","コンテンツの最大高さで指定する（縦書きで有効）"],["fit","親要素からはみ出す場合にmaxでは折り返しが発生しないが、fitでは折り返す（縦書きで有効）"]]})}],["Size",{entry:"サイズ",description:"widthとheightを一度に指定する",detail:i.jsx(m,{value:[["*","指定した長さ、または親要素に対する割合で指定する"],["auto","自動"],["full","親要素の幅と高さで指定する"],["min","コンテンツの最小幅と最小高さで指定する"],["max","コンテンツの最大幅と最大高さで指定する"],["fit","親要素からはみ出す場合にmaxでは折り返しが発生しないが、fitでは折り返す"]]})}]]),jb=new Map([[E.Typography,{entry:"タイポグラフィー",description:"",detail:null}],["Font Family",{entry:"フォントファミリー",description:"フォントファミリーを指定する",detail:i.jsx(m,{value:[["sans","ゴシック体"],["serif","明朝体"],["mono","等幅フォント"]]})}],["Font Size",{entry:"フォントサイズ",description:"フォントサイズを指定する",detail:null}],["Font Smoothing",{entry:"フォントのなめらかさ",description:"アンチエイリアスの方式を指定する（macOSで有効）",detail:i.jsx(m,{value:[["antialiased","グレースケール方式（線がわずかに細く見える）"],["subpixel-antialiased","サブピクセル方式（線がわずかに太く見える）。デフォルト"]]})}],["Font Style",{entry:"フォントスタイル",description:"斜体で表示するかどうかを指定する",detail:null}],["Font Weight",{entry:"フォントウェイト",description:"フォントの太さを指定する",detail:null}],["Font Variant Numeric",{entry:"数字の異形",description:`数字の表記形式を指定する
正しく表示するには、フォント側がそれぞれの形式に対応している必要がある`,detail:i.jsx(m,{value:[["normal-nums","標準"],["ordinal","「1st」などの序数詞を数字の右肩に小さく表記する"],["slashed-zero","斜線付き「0」を使用する"],["lining-nums","高さが揃った数字"],["oldstyle-nums","高さが不揃いな数字"],["proportional-nums","プロポーショナルフォント（幅が不揃い）を使用する"],["tabular-nums","等幅フォントを使用する"],["diagonal-fractions","「1/2」などの分数をコンパクトに表記する"],["stacked-fractions","分数の分母と分子を積み上げる形で表記する"]]})}],["Letter Spacing",{entry:"文字間隔",description:"文字間隔を指定する",detail:null}],["Line Clamp",{entry:"行の固定",description:"固定する行数を指定する",detail:i.jsx(m,{value:[["*","固定する行数"],["none","固定しない"]]})}],["Line Height",{entry:"行の高さ",description:"行の高さを指定する",detail:null}],["List Style Image",{entry:"リストスタイルの画像",description:"リスト項目のマーカーとして使用する画像を指定する",detail:i.jsx(m,{value:[["list-image-none","マーカーを指定しない"],["list-image-[url(***.png)]","特定の画像をマーカーとして使用する例"]]})}],["List Style Position",{entry:"リストスタイルの位置",description:"リスト項目のマーカー位置を指定する",detail:i.jsx(m,{value:[["inside","マーカーを要素の内側に収める"],["outside","マーカーを要素の外側に置く"]]})}],["List Style Type",{entry:"リストスタイルの種類",description:"リスト項目のマーカー種類を指定する",detail:i.jsx(m,{value:[["none","マーカーなし"],["disc","箇条書き（「・」で表す）"],["decimal","数値リスト（「1.」「2.」のように表す）"]]})}],["Text Align",{entry:"テキストの整列",description:"テキストの行揃えを指定する",detail:i.jsx(m,{value:[["left","左揃え"],["center","中央揃え"],["right","右揃え"],["justify","両端揃え"],["start","テキストの開始側に揃える"],["end","テキストの終端側に揃える"]]})}],["Text Color",{entry:"テキストの色",description:"テキストの色を指定する",detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10 bg-transparent"})],["current","テキスト色",i.jsx("td",{className:"w-10 bg-transparent"})],["transparent","透明",i.jsx("td",{className:"w-10 bg-transparent"})],["black","黒",i.jsx("td",{className:"w-10 bg-black"})],["white","白",i.jsx("td",{className:"w-10 bg-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 bg-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 bg-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 bg-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 bg-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 bg-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 bg-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 bg-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 bg-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 bg-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 bg-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 bg-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 bg-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 bg-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 bg-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 bg-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 bg-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 bg-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 bg-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 bg-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 bg-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 bg-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 bg-rose-500"})],["red-500/25","不透明度25％で指定する例",i.jsx("td",{className:"w-10 bg-red-500/25"})]]})}],["Text Decoration",{entry:"テキストの装飾",description:"テキストの装飾を指定する",detail:i.jsx(m,{value:[["underline","下線を引く",i.jsx("td",{children:i.jsx("p",{className:"pr-1 underline",children:"Aa"})})],["overline","上線を引く",i.jsx("td",{children:i.jsx("p",{className:"pr-1 overline",children:"Aa"})})],["line-through","取り消し線を引く",i.jsx("td",{children:i.jsx("p",{className:"pr-1 line-through",children:"Aa"})})],["no-underline","装飾しない",i.jsx("td",{children:i.jsx("p",{className:"pr-1 no-underline",children:"Aa"})})]]})}],["Text Decoration Color",{entry:"テキスト装飾の色",description:"テキスト装飾の色を指定する",detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10 bg-transparent"})],["current","テキスト色",i.jsx("td",{className:"w-10 bg-transparent"})],["transparent","透明",i.jsx("td",{className:"w-10 bg-transparent"})],["black","黒",i.jsx("td",{className:"w-10 bg-black"})],["white","白",i.jsx("td",{className:"w-10 bg-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 bg-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 bg-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 bg-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 bg-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 bg-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 bg-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 bg-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 bg-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 bg-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 bg-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 bg-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 bg-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 bg-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 bg-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 bg-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 bg-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 bg-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 bg-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 bg-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 bg-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 bg-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 bg-rose-500"})],["red-500/25","不透明度25％で指定する例",i.jsx("td",{className:"w-10 bg-red-500/25"})]]})}],["Text Decoration Style",{entry:"テキスト装飾のスタイル",description:"テキスト装飾のスタイルを指定する",detail:i.jsx(m,{value:[["solid","一本のつながった線",i.jsx("td",{children:i.jsx("p",{className:"pr-1 text-center underline decoration-solid",children:"Aa"})})],["double","二重線",i.jsx("td",{children:i.jsx("p",{className:"pr-1 text-center underline decoration-double",children:"Aa"})})],["dotted","点線",i.jsx("td",{children:i.jsx("p",{className:"pr-1 text-center underline decoration-dotted",children:"Aa"})})],["dashed","破線",i.jsx("td",{children:i.jsx("p",{className:"pr-1 text-center underline decoration-dashed",children:"Aa"})})],["wavy","波線",i.jsx("td",{children:i.jsx("p",{className:"pr-1 text-center underline decoration-wavy",children:"Aa"})})]]})}],["Text Decoration Thickness",{entry:"テキスト装飾の太さ",description:"テキスト装飾の太さを指定する",detail:i.jsx(m,{value:[["auto","自動"],["from-font","推奨される太さがフォントに埋め込まれていれば、その値を使用する"],["*","ピクセル値で指定する"]]})}],["Text Underline Offset",{entry:"テキストアンダーラインのオフセット",description:"指定した距離だけアンダーラインを下にずらす",detail:i.jsx(m,{value:[["auto","自動"],["*","ピクセル値で指定する"]]})}],["Text Transform",{entry:"テキストの変換",description:"アルファベットを変換するルールを指定する",detail:i.jsx(m,{value:[["uppercase","大文字に変換"],["lowercase","小文字に変換"],["capitalize","小文字に変換するが、単語の先頭のみ大文字にする"],["normal-case","変換しない"]]})}],["Text Overflow",{entry:"テキストのオーバーフロー",description:"テキストが要素からはみ出す場合の動作を指定する",detail:i.jsx(m,{value:[["truncate","折り返さない。あふれた部分は「…」で省略される"],["text-ellipsis","折り返す。折り返してもあふれる部分は「…」で省略される（overflow-hiddenと組み合わせて使う）"],["text-clip","折り返す。折り返してもあふれる部分は切り取られる（overflow-hiddenと組み合わせて使う）"]]})}],["Text Wrap",{entry:"テキストの折り返し",description:"テキストを折り返す動作を指定する",detail:i.jsx(m,{value:[["wrap","バランス調整せずに折り返す"],["nowrap","折り返さない"],["balance","各行にテキストを均等に配分する"],["pretty","最終行に単語がひとつだけとならないように折り返す"]]})}],["Text Indent",{entry:"テキストのインデント",description:"テキストの先頭に挿入する空白の長さを指定する",detail:null}],["Vertical Align",{entry:"垂直方向の整列",description:"垂直方向にテキストを揃える際の基準を指定する",detail:i.jsx(m,{value:[["baseline","親要素のベースラインに揃える"],["top","行の上端に揃える"],["middle","親要素のベースラインに、小文字のxの高さを足した位置に揃える"],["bottom","行の下端に揃える"],["text-top","親要素のテキストの上端に揃える"],["text-bottom","親要素のテキストの下端に揃える"],["sub","親要素の下付き文字の位置に揃える"],["super","親要素の上付き文字の位置に揃える"]]})}],["Whitespace",{entry:"ホワイトスペース",description:"ホワイトスペース（タブ、改行、スペースなど）の扱い方を指定する",detail:i.jsx(m,{value:[["normal","連続するホワイトスペースをひとつのスペースにまとめる。折り返す"],["nowrap","連続するホワイトスペースをひとつのスペースにまとめる。折り返さない"],["pre","連続するホワイトスペースをそのまま残す。折り返さない"],["pre-line","改行以外のホワイトスペースをひとつのスペースにまとめる。折り返す"],["pre-wrap","連続するホワイトスペースをそのまま残す。折り返す"],["break-spaces","pre-wrapに近しいが、行末での動作が異なる"]]})}],["Word Break",{entry:"単語の区切り",description:"単語の折り返す動作を指定する",detail:i.jsx(m,{value:[["normal","単語の途中で折り返さない"],["words","必要に応じて単語の途中で折り返す"],["all","単語を考慮せずに折り返す"],["keep","CJK（中国語、日本語、韓国語）において、文章の中では折り返さずに記号などの箇所で折り返す"]]})}],["Hyphens",{entry:"ハイフン",description:"「&shy;」（ソフトハイフン）の扱い方を指定する",detail:i.jsx(m,{value:[["none","ハイフネーション（単語内にハイフンを挿入して改行すること）をしない"],["manual","「&shy;」を目印にハイフネーションする"],["auto","単語を判定して自動的にハイフネーションする"]]})}],["Content",{entry:"コンテンツ",description:"before、またはafter修飾子を用いた疑似要素を指定する",detail:i.jsx(m,{value:[["before:content-none","要素の前側に疑似要素を使用しない"],["after:content-none","要素の後ろ側に疑似要素を使用しない"],['before:content-["✅"]',"要素の前側に絵文字の疑似要素を挿入する例"],['after:content-["✅"]',"要素の後ろ側に絵文字の疑似要素を挿入する例"]]})}]]),Nb=new Map([[E.Backgrounds,{entry:"背景",description:"",detail:null}],["Background Attachment",{entry:"背景の取り付け",description:"スクロールした際の、Background Imageに指定した背景画像の動作を指定する",detail:i.jsx(m,{value:[["fixed","ディスプレイに貼り付けたように背景画像を固定する"],["local","ページのスクロールに背景画像を連動する。背景画像を指定した要素がスクロール可能な場合、その要素のスクロールにも連動する"],["scroll","ページのスクロールに背景画像を連動する"]]})}],["Background Clip",{entry:"背景の切り抜き",description:"Background Image、またはBackground Colorに指定した背景の切り取り方法を指定する",detail:i.jsx(m,{value:[["border","境界領域から外側を切り取る"],["padding","余白領域から外側を切り取る"],["content","コンテンツ領域から外側を切り取る"],["text","テキストの形に沿って背景を切り取る（text-transparentと組み合わせて使う）"]]})}],["Background Color",{entry:"背景色",description:"要素の背景色を指定する",detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10"})],["current","テキスト色",i.jsx("td",{className:"w-10"})],["transparent","透明",i.jsx("td",{className:"w-10"})],["black","黒",i.jsx("td",{className:"w-10 bg-black"})],["white","白",i.jsx("td",{className:"w-10 bg-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 bg-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 bg-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 bg-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 bg-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 bg-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 bg-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 bg-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 bg-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 bg-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 bg-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 bg-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 bg-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 bg-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 bg-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 bg-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 bg-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 bg-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 bg-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 bg-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 bg-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 bg-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 bg-rose-500"})],["red-500/25","不透明度25％で指定する例",i.jsx("td",{className:"w-10 bg-red-500/25"})]]})}],["Background Origin",{entry:"背景の原点",description:"Background Imageに指定した背景画像を貼り付ける原点を指定する",detail:i.jsx(m,{value:[["border","境界領域の側面を原点に貼り付ける"],["padding","余白領域の側面を原点に貼り付ける"],["content","コンテンツ領域の側面を原点に貼り付ける"]]})}],["Background Position",{entry:"背景の位置",description:"Background Imageに指定した背景画像が要素からはみ出す場合に、メインに見せたい位置を指定する",detail:i.jsx(m,{value:[["bottom","下"],["center","中央"],["left","左"],["left-bottom","左下"],["left-top","左上"],["right","右"],["right-bottom","右下"],["right-top","右上"],["top","上"]]})}],["Background Repeat",{entry:"背景の繰り返し",description:"Background Imageに指定した背景画像の並べ方を指定する",detail:i.jsx(m,{value:[["repeat","全方向に繰り返す"],["no-repeat","繰り返さない"],["repeat-x","水平方向に繰り返す"],["repeat-y","垂直方向に繰り返す"],["repeat-round","要素からはみ出すことなく繰り返す。背景画像が歪みやすい"],["repeat-space","要素からはみ出すことなく繰り返す。隙間が生じやすい"]]})}],["Background Size",{entry:"背景サイズ",description:"Background Imageに指定した背景画像のサイズを指定する",detail:i.jsx(m,{value:[["auto","等倍で表示する"],["cover","要素全体を覆うように拡大縮小する"],["contain","背景画像全体が収まるように拡大縮小する"]]})}],["Background Image",{entry:"背景画像",description:"背景画像や線形グラデーションの方向を指定する",detail:i.jsx(m,{value:[["bg-none","背景画像なし"],["bg-gradient-to-t","上方向への線形グラデーション"],["bg-gradient-to-tr","右上方向への線形グラデーション"],["bg-gradient-to-r","右方向への線形グラデーション"],["bg-gradient-to-br","右下方向への線形グラデーション"],["bg-gradient-to-b","下方向への線形グラデーション"],["bg-gradient-to-bl","左下方向への線形グラデーション"],["bg-gradient-to-l","左方向への線形グラデーション"],["bg-gradient-to-tl","左上方向への線形グラデーション"],["bg-[url(***.jpg)]","特定の画像を背景画像に指定する例"]]})}],["Gradient Color Stops",{entry:"グラデーションの色経由点",description:"線形グラデーションで使用する色を指定する",detail:i.jsx(m,{value:[["from-（色）","開始色",i.jsx("td",{className:"w-10"})],["from-*%","開始位置",i.jsx("td",{className:"w-10"})],["via-（色）","中間色",i.jsx("td",{className:"w-10"})],["via-*%","中間位置",i.jsx("td",{className:"w-10"})],["to-（色）","終了色",i.jsx("td",{className:"w-10"})],["to-*%","終了位置",i.jsx("td",{className:"w-10"})],["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10"})],["current","テキスト色",i.jsx("td",{className:"w-10"})],["transparent","透明",i.jsx("td",{className:"w-10"})],["black","黒",i.jsx("td",{className:"w-10 bg-black"})],["white","白",i.jsx("td",{className:"w-10 bg-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 bg-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 bg-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 bg-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 bg-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 bg-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 bg-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 bg-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 bg-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 bg-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 bg-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 bg-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 bg-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 bg-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 bg-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 bg-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 bg-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 bg-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 bg-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 bg-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 bg-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 bg-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 bg-rose-500"})],["red-500/25","不透明度25％で指定する例",i.jsx("td",{className:"w-10 bg-red-500/25"})],[`bg-gradient-to-r
from-cyan-500
to-purple-500`,"水色から紫のグラデーションの例",i.jsx("td",{className:"w-10 bg-gradient-to-r from-cyan-500 to-purple-500"})]]})}]]),zb=new Map([[E.Borders,{entry:"境界",description:"",detail:null}],["Border Radius",{entry:"境界の半径",description:"角の丸みを指定する",detail:i.jsx(m,{value:[["none","角丸なし"],["sm〜3xl","角丸"],["full","円、またはカプセル型"],["s-*","テキストの開始側を丸める"],["e-*","テキストの終端側を丸める"],["t-*","上側を丸める"],["r-*","右側を丸める"],["b-*","下側を丸める"],["l-*","左側を丸める"],["ss-*","左上を丸める（左横書きの場合）"],["se-*","右上を丸める（左横書きの場合）"],["ee-*","右下を丸める（左横書きの場合）"],["es-*","右下を丸める（左横書きの場合）"],["tl-*","左上を丸める"],["tr-*","右上を丸める"],["br-*","右下を丸める"],["bl-*","左下を丸める"]]})}],["Border Width",{entry:"境界の太さ",description:"境界線の太さを指定する",detail:i.jsx(m,{value:[["*","指定した太さの枠で囲む"],["x-*","左右の側面に線を引く"],["y-*","上下の側面に線を引く"],["s-*","テキストの開始側に線を引く"],["e-*","テキストの終端側に線を引く"],["t-*","上の側面に線を引く"],["r-*","右の側面に線を引く"],["b-*","下の側面に線を引く"],["l-*","左の側面に線を引く"]]})}],["Border Color",{entry:"境界の色",description:"境界線の色を指定する",detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10"})],["current","テキスト色",i.jsx("td",{className:"w-10"})],["transparent","透明",i.jsx("td",{className:"w-10"})],["black","黒",i.jsx("td",{className:"w-10 border border-black"})],["white","白",i.jsx("td",{className:"w-10 border border-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 border border-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 border border-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 border border-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 border border-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 border border-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 border border-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 border border-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 border border-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 border border-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 border border-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 border border-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 border border-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 border border-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 border border-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 border border-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 border border-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 border border-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 border border-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 border border-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 border border-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 border border-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 border border-rose-500"})],["red-500/25","不透明度25％で指定する例",i.jsx("td",{className:"w-10 border border-red-500/25"})],["x-（色）","左右の線の色",i.jsx("td",{className:"w-10 border border-transparent border-x-black dark:border-x-white"})],["y-（色）","上下の線の色",i.jsx("td",{className:"w-10 border border-transparent border-y-black dark:border-y-white"})],["s-（色）","テキストの開始側に引かれる色",i.jsx("td",{className:"w-10 border border-transparent border-s-black dark:border-s-white"})],["e-（色）","テキストの終端側に引かれる色",i.jsx("td",{className:"w-10 border border-transparent border-e-black dark:border-e-white"})],["t-（色）","上側面の線の色",i.jsx("td",{className:"w-10 border border-transparent border-t-black dark:border-t-white"})],["r-（色）","右側面の線の色",i.jsx("td",{className:"w-10 border border-transparent border-r-black dark:border-r-white"})],["b-（色）","下側面の線の色",i.jsx("td",{className:"w-10 border border-transparent border-b-black dark:border-b-white"})],["l-（色）","左側面の線の色",i.jsx("td",{className:"w-10 border border-transparent border-l-black dark:border-l-white"})]]})}],["Border Style",{entry:"境界のスタイル",description:"境界線のスタイルを指定する",detail:i.jsx(m,{value:[["solid","一本のつながった線"],["dashed","破線"],["dotted","点線"],["double","二重線"],["hidden","境界線を表示しない（優先度・高）"],["none","境界線を表示しない（優先度・低）"]]})}],["Divide Width",{entry:"分割線の太さ",description:"子要素が縦や横に並ぶ場合に、要素間に引かれる線の太さを指定する",detail:i.jsx(m,{value:[["x-*","子要素が水平方向に並ぶ場合に使用する"],["y-*","子要素が垂直方向に並ぶ場合に使用する"],["y-reverse","子要素が右から左へ並ぶ場合に、正しい位置に分割線を引く"],["x-reverse","子要素が下から上へ並ぶ場合に、正しい位置に分割線を引く"]]})}],["Divide Color",{entry:"分割線の色",description:"分割線の色を指定する",detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10"})],["current","テキスト色",i.jsx("td",{className:"w-10"})],["transparent","透明",i.jsx("td",{className:"w-10"})],["black","黒",i.jsx("td",{className:"w-10 bg-black"})],["white","白",i.jsx("td",{className:"w-10 bg-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 bg-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 bg-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 bg-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 bg-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 bg-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 bg-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 bg-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 bg-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 bg-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 bg-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 bg-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 bg-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 bg-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 bg-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 bg-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 bg-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 bg-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 bg-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 bg-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 bg-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 bg-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 bg-rose-500"})],["red-500/25","不透明度25%で指定する例",i.jsx("td",{className:"w-10 divide-y bg-red-500/25"})]]})}],["Divide Style",{entry:"分割線のスタイル",description:"分割線のスタイルを指定する",detail:i.jsx(m,{value:[["solid","一本のつながった線"],["dashed","破線"],["dotted","点線"],["double","二重線"],["none","分割線を表示しない"]]})}],["Outline Width",{entry:"輪郭線の太さ",description:`輪郭線の太さを指定する
輪郭線はBorderよりも外側に引かれる`,detail:null}],["Outline Color",{entry:"輪郭線の色",description:"輪郭線の色を指定する",detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10"})],["current","テキスト色",i.jsx("td",{className:"w-10"})],["transparent","透明",i.jsx("td",{className:"w-10"})],["black","黒",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-black"})})],["white","白",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-white"})})],["slate-500","粘板岩",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-slate-500"})})],["gray-500","グレー",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-gray-500"})})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-zinc-500"})})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-neutral-500"})})],["stone-500","石",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-stone-500"})})],["red-500","赤",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-red-500"})})],["orange-500","オレンジ",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-orange-500"})})],["amber-500","琥珀",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-amber-500"})})],["yellow-500","黄色",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-yellow-500"})})],["lime-500","ライム",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-lime-500"})})],["green-500","緑",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-green-500"})})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-emerald-500"})})],["teal-500","コガモ",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-teal-500"})})],["cyan-500","シアン",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-cyan-500"})})],["sky-500","スカイ",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-sky-500"})})],["blue-500","青",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-blue-500"})})],["indigo-500","藍色",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-indigo-500"})})],["violet-500","スミレ",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-violet-500"})})],["purple-500","紫",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-purple-500"})})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-fuchsia-500"})})],["pink-500","ピンク",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-pink-500"})})],["rose-500","バラ",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-rose-500"})})],["red-500/25","不透明度25%で指定する例",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 outline outline-red-500/25"})})]]})}],["Outline Style",{entry:"輪郭線のスタイル",description:"輪郭線のスタイルを指定する",detail:i.jsx(m,{value:[["outline-none","輪郭線を表示しない"],["outline","一本のつながった線"],["outline-dashed","破線"],["outline-dotted","点線"],["outline-double","二重線"]]})}],["Outline Offset",{entry:"輪郭線のオフセット",description:"指定した距離だけ輪郭線を外側に広げる",detail:null}],["Ring Width",{entry:"輪の太さ",description:`box-shadowで描く輪郭線の太さを設定する
デフォルトでは半透明の青で描かれる`,detail:i.jsx(m,{value:[["ring-0","輪郭線なし",i.jsx("td",{className:"h-6 w-10",children:i.jsx("div",{className:"h-2 w-8 bg-gray-200 ring-0"})})],["ring-1","",i.jsx("td",{className:"h-6 w-10",children:i.jsx("div",{className:"h-2 w-8 bg-gray-200 ring-1"})})],["ring-2","",i.jsx("td",{className:"h-6 w-10",children:i.jsx("div",{className:"h-2 w-8 bg-gray-200 ring-2"})})],["ring","",i.jsx("td",{className:"h-6 w-10",children:i.jsx("div",{className:"h-2 w-8 bg-gray-200 ring"})})],["ring-4","",i.jsx("td",{className:"h-6 w-10",children:i.jsx("div",{className:"h-2 w-8 bg-gray-200 ring-4"})})],["ring-8","",i.jsx("td",{className:"h-6 w-10",children:i.jsx("div",{className:"h-2 w-8 bg-gray-200 ring-8"})})],["ring-inset","要素の内側に描く",i.jsx("td",{className:"h-6 w-10",children:i.jsx("div",{className:"h-2 w-8 bg-gray-200 ring ring-inset"})})]]})}],["Ring Color",{entry:"輪の色",description:"box-shadowで描く輪郭線の色を設定する",detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10"})],["current","テキスト色",i.jsx("td",{className:"w-10"})],["transparent","透明",i.jsx("td",{className:"w-10"})],["black","黒",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-black"})})],["white","白",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-white"})})],["slate-500","粘板岩",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-slate-500"})})],["gray-500","グレー",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-gray-500"})})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-zinc-500"})})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-neutral-500"})})],["stone-500","石",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-stone-500"})})],["red-500","赤",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-red-500"})})],["orange-500","オレンジ",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-orange-500"})})],["amber-500","琥珀",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-amber-500"})})],["yellow-500","黄色",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-yellow-500"})})],["lime-500","ライム",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-lime-500"})})],["green-500","緑",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-green-500"})})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-emerald-500"})})],["teal-500","コガモ",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-teal-500"})})],["cyan-500","シアン",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-cyan-500"})})],["sky-500","スカイ",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-sky-500"})})],["blue-500","青",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-blue-500"})})],["indigo-500","藍色",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-indigo-500"})})],["violet-500","スミレ",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-violet-500"})})],["purple-500","紫",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-purple-500"})})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-fuchsia-500"})})],["pink-500","ピンク",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-pink-500"})})],["rose-500","バラ",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-rose-500"})})],["red-500/25","不透明度25％で指定する例",i.jsx("td",{className:"w-10",children:i.jsx("div",{className:"h-4 w-9 ring-1 ring-red-500/25"})})]]})}],["Ring Offset Width",{entry:"輪のオフセット幅",description:"指定した距離だけ、box-shadowで描く輪郭線を外側に広げる",detail:null}],["Ring Offset Color",{entry:"輪のオフセット色",description:`輪郭線をRing Offset Widthで広げた、その隙間の色を指定する
デフォルトでは白で描かれるため、背景色と同じ色を指定する`,detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10"})],["current","テキスト色",i.jsx("td",{className:"w-10"})],["transparent","透明",i.jsx("td",{className:"w-10"})],["black","黒",i.jsx("td",{className:"w-10 bg-black"})],["white","白",i.jsx("td",{className:"w-10 bg-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 bg-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 bg-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 bg-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 bg-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 bg-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 bg-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 bg-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 bg-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 bg-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 bg-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 bg-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 bg-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 bg-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 bg-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 bg-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 bg-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 bg-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 bg-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 bg-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 bg-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 bg-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 bg-rose-500"})],["red-500/25","不透明度25％で指定する例",i.jsx("td",{className:"w-10 bg-red-500/25"})]]})}]]),Sb=new Map([[E.Effects,{entry:"効果",description:"",detail:null}],["Box Shadow",{entry:"ボックスシャドー",description:"要素の影を描画する",detail:i.jsx(m,{value:[["shadow-sm","",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow-sm"})})],["shadow","",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow"})})],["shadow-md","",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow-md"})})],["shadow-lg","",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow-lg"})})],["shadow-xl","",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow-xl"})})],["shadow-2xl","",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow-2xl"})})],["shadow-inner","へこんだように見える影を描画する",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow-inner"})})],["none","影を描画しない",i.jsx("td",{className:"w-10"})]]})}],["Box Shadow Color",{entry:"ボックスシャドーの色",description:"影の色を指定する",detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10"})],["current","テキスト色",i.jsx("td",{className:"w-10"})],["transparent","透明",i.jsx("td",{className:"w-10"})],["black","黒",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-black"})})],["white","白",i.jsx("td",{className:"h-8 w-10 bg-black",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-white"})})],["slate-500","粘板岩",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-slate-500"})})],["gray-500","グレー",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-gray-500"})})],["zinc-500","亜鉛",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-zinc-500"})})],["neutral-500","ニュートラル",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-neutral-500"})})],["stone-500","石",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-stone-500"})})],["red-500","赤",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-red-500"})})],["orange-500","オレンジ",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-orange-500"})})],["amber-500","琥珀",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-amber-500"})})],["yellow-500","黄色",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-yellow-500"})})],["lime-500","ライム",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-lime-500"})})],["green-500","緑",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-green-500"})})],["emerald-500","エメラルド",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-emerald-500"})})],["teal-500","コガモ",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-teal-500"})})],["cyan-500","シアン",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-cyan-500"})})],["sky-500","スカイ",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-sky-500"})})],["blue-500","青",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-blue-500"})})],["indigo-500","藍色",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-indigo-500"})})],["violet-500","スミレ",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-violet-500"})})],["purple-500","紫",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-purple-500"})})],["fuchsia-500","フクシア",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-fuchsia-500"})})],["pink-500","ピンク",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-pink-500"})})],["rose-500","バラ",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-rose-500"})})],["red-500/25","不透明度25％で指定する例",i.jsx("td",{className:"h-8 w-10 bg-white",children:i.jsx("div",{className:"mx-auto h-4 w-6 shadow shadow-red-500/25"})})]]})}],["Opacity",{entry:"不透明度",description:"不透明度を指定する",detail:null}],["Mix Blend Mode",{entry:"合成モード",description:"自身の要素と背後にある要素との合成方法を指定する",detail:i.jsx(m,{value:[["normal","通常"],["multiply","乗算"],["screen","スクリーン"],["overlay","オーバーレイ"],["darken","比較（暗）"],["lighten","比較（明）"],["color-dodge","覆い焼きカラー"],["color-burn","焼き込みカラー"],["hard-light","ハードライト"],["soft-light","ソフトライト"],["difference","差の絶対値"],["exclusion","除外"],["hue","色相"],["saturation","彩度"],["color","カラー"],["luminosity","輝度"],["plus-darker","クロスフェード専用"],["plus-lighter","クロスフェード専用"]]})}],["Background Blend Mode",{entry:"背景合成モード",description:"Background ImageとBackground Colorとの合成方法を指定する",detail:i.jsx(m,{value:[["normal","通常"],["multiply","乗算"],["screen","スクリーン"],["overlay","オーバーレイ"],["darken","比較（暗）"],["lighten","比較（明）"],["color-dodge","覆い焼きカラー"],["color-burn","焼き込みカラー"],["hard-light","ハードライト"],["soft-light","ソフトライト"],["difference","差の絶対値"],["exclusion","除外"],["hue","色相"],["saturation","彩度"],["color","カラー"],["luminosity","輝度"]]})}]]),Cb=new Map([[E.Filters,{entry:"フィルター",description:"",detail:null}],["Blur",{entry:"ぼかし",description:"ぼかしの強度を指定する",detail:null}],["Brightness",{entry:"明るさ",description:"明るさの強度を指定する",detail:null}],["Contrast",{entry:"コントラスト",description:"明暗差の強度を指定する",detail:null}],["Drop Shadow",{entry:"ドロップシャドー",description:"コンテンツに対する影を描画する",detail:i.jsx(m,{value:[["drop-shadow-sm","",i.jsx("td",{className:"bg-white",children:i.jsx("p",{className:"text-2xl text-white drop-shadow-sm",children:"Aa"})})],["drop-shadow","",i.jsx("td",{className:"bg-white",children:i.jsx("p",{className:"text-2xl text-white drop-shadow",children:"Aa"})})],["drop-shadow-md","",i.jsx("td",{className:"bg-white",children:i.jsx("p",{className:"text-2xl text-white drop-shadow-md",children:"Aa"})})],["drop-shadow-lg","",i.jsx("td",{className:"bg-white",children:i.jsx("p",{className:"text-2xl text-white drop-shadow-lg",children:"Aa"})})],["drop-shadow-xl","",i.jsx("td",{className:"bg-white",children:i.jsx("p",{className:"text-2xl text-white drop-shadow-xl",children:"Aa"})})],["drop-shadow-2xl","",i.jsx("td",{className:"bg-white",children:i.jsx("p",{className:"text-2xl text-white drop-shadow-2xl",children:"Aa"})})],["drop-shadow-none","影を描画しない",i.jsx("td",{})]]})}],["Grayscale",{entry:"グレースケール",description:"グレーの濃淡で描画する",detail:null}],["Hue Rotate",{entry:"色相",description:"指定した角度で色相を回転し色味を変える",detail:i.jsx(m,{value:[["hue-rotate-*","時計回りで回転"],["-hue-rotate-*","反時計回りに回転"]]})}],["Invert",{entry:"反転",description:"色を反転する",detail:null}],["Saturate",{entry:"彩度",description:"鮮やかさの強度を指定する",detail:null}],["Sepia",{entry:"セピア",description:"黒茶色の濃淡で描画する",detail:null}],["Backdrop Blur",{entry:"背景ぼかし",description:"背後の要素に対する、ぼかしの強度を指定する",detail:null}],["Backdrop Brightness",{entry:"背景の明るさ",description:"背後の要素に対する、明るさの強度を指定する",detail:null}],["Backdrop Contrast",{entry:"背景コントラスト",description:"背後の要素に対する、明暗差の強度を指定する",detail:null}],["Backdrop Grayscale",{entry:"背景グレースケール",description:"背後の要素に対し、グレーの濃淡で描画する",detail:null}],["Backdrop Hue Rotate",{entry:"背景の色相",description:"背後の要素に対し、指定した角度で色相を回転し色味を変える",detail:i.jsx(m,{value:[["hue-rotate-*","時計回りで回転"],["-hue-rotate-*","反時計回りに回転"]]})}],["Backdrop Invert",{entry:"背景の反転",description:"背後の要素に対し、色を反転する",detail:null}],["Backdrop Opacity",{entry:"背景の不透明度",description:"Backdrop系フィルターの不透明度を指定する",detail:null}],["Backdrop Saturate",{entry:"背景の彩度",description:"背後の要素に対する、鮮やかさの強度を指定する",detail:null}],["Backdrop Sepia",{entry:"背景セピア",description:"背後の要素に対し、黒茶色の濃淡で描画する",detail:null}]]),Ab=new Map([[E.Tables,{entry:"テーブル",description:"",detail:null}],["Border Collapse",{entry:"境界の折りたたみ",description:"テーブルセルの境界線の種類を指定する",detail:i.jsx(m,{value:[["collapse","隣接するセルの境界線をひとつに結合する"],["separate","セルの境界線を独立する"]]})}],["Border Spacing",{entry:"境界の空間",description:"セルの周辺に設ける隙間の広さを指定する",detail:i.jsx(m,{value:[["*","上下左右の隙間の広さ"],["x-*","水平方向の隙間の広さ"],["y-*","垂直方向の隙間の広さ"]]})}],["Table Layout",{entry:"テーブルレイアウト",description:"テーブル列の割り当て方を指定する",detail:i.jsx(m,{value:[["auto","セルの内容に合わせて自動的に列の幅を調整する"],["fixed","均等に割り当てる"]]})}],["Caption Side",{entry:"キャプションサイド",description:"テーブルの<caption>要素を表示する位置を指定する",detail:i.jsx(m,{value:[["top","上側"],["bottom","下側"]]})}]]),Eb=new Map([[E.TransitionsAndAnimation,{entry:"遷移＆アニメーション",description:"",detail:null}],["Transition Property",{entry:"遷移プロパティー",description:"値が変化する際に、なめらかに遷移させたいプロパティーを指定する",detail:i.jsx(m,{value:[["transition-none","瞬時に遷移する"],["transition-all","すべてのプロパティーを対象にする"],["transition","いくつかのプロパティーを組み合わせた、おすすめの設定"],["transition-colors","色のみを対象にする"],["transition-opacity","不透明度のみを対象にする"],["transition-shadow","影のみを対象にする"],["transition-transform","変形のみを対象にする"]]})}],["Transition Duration",{entry:"遷移の期間",description:"遷移が完了するまでの時間を指定する",detail:null}],["Transition Timing Function",{entry:"遷移タイミング関数",description:"値が変化する速度を指定する",detail:i.jsx(m,{value:[["linear","一定の速度"],["in","徐々に加速する"],["out","徐々に減速する"],["in-out","前半は徐々に加速し、後半は徐々に減速する"]]})}],["Transition Delay",{entry:"遷移の遅延",description:"値が変化してから実際に遷移が開始されるまでの時間を指定する",detail:null}],["Animation",{entry:"アニメーション",description:"要素に動きを与える",detail:i.jsx(m,{value:[["none","アニメーションしない",i.jsx("td",{className:"w-10"})],["spin","時計回りに回転",i.jsx("td",{className:"w-10",children:i.jsx("p",{className:"animate-spin text-center",children:"Aa"})})],["ping","波紋のように広がるアニメーション",i.jsx("td",{className:"w-10",children:i.jsx("p",{className:"animate-ping text-center",children:"Aa"})})],["pulse","フェードイン／アウトを繰り返す",i.jsx("td",{className:"w-10",children:i.jsx("p",{className:"animate-pulse text-center",children:"Aa"})})],["bounce","上下に弾む",i.jsx("td",{className:"w-10",children:i.jsx("p",{className:"animate-bounce text-center",children:"Aa"})})]]})}]]),Tb=new Map([[E.Transforms,{entry:"変形",description:"",detail:null}],["Scale",{entry:"拡大縮小",description:"指定した大きさに拡大縮小する",detail:i.jsx(m,{value:[["*","拡大縮小"],["x-*","水平方向に拡大縮小"],["y-*","垂直方向に拡大縮小"]]})}],["Rotate",{entry:"回転",description:"指定した角度に回転する",detail:i.jsx(m,{value:[["rotate-*","時計回りで回転"],["-rotate-*","反時計回りで回転"]]})}],["Translate",{entry:"移動",description:"指定した距離だけ移動する",detail:i.jsx(m,{value:[["x-*","右方向に移動"],["y-*","下方向に移動"],["-x-*","左方向に移動"],["-y-*","上方向に移動"]]})}],["Skew",{entry:"歪める",description:"斜め方向に歪める",detail:i.jsx(m,{value:[["x-*","水平方向に引き延ばしたように傾斜する"],["y-*","垂直方向に引き延ばしたように傾斜する"]]})}],["Transform Origin",{entry:"変形の原点",description:"変形の基準となる原点を指定する",detail:i.jsx(m,{value:[["center","中央"],["top","上"],["top-right","右上"],["right","右"],["bottom-right","右下"],["bottom","下"],["bottom-left","左下"],["left","左"],["top-left","左上"]]})}]]),_b=new Map([[E.Interactivity,{entry:"双方向性",description:"",detail:null}],["Accent Color",{entry:"アクセントカラー",description:"ブラウザーが用意するデフォルトカラーを変更する",detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10 bg-transparent"})],["current","テキスト色",i.jsx("td",{className:"w-10 bg-transparent"})],["transparent","透明",i.jsx("td",{className:"w-10 bg-transparent"})],["black","黒",i.jsx("td",{className:"w-10 bg-black"})],["white","白",i.jsx("td",{className:"w-10 bg-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 bg-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 bg-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 bg-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 bg-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 bg-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 bg-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 bg-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 bg-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 bg-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 bg-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 bg-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 bg-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 bg-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 bg-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 bg-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 bg-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 bg-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 bg-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 bg-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 bg-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 bg-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 bg-rose-500"})],["auto","デフォルトカラーを使用する",i.jsx("td",{className:"w-10"})]]})}],["Appearance",{entry:"外観",description:"ブラウザーが用意するデフォルトスタイルの使用、不使用を指定する",detail:i.jsx(m,{value:[["none","使用しない"],["auto","使用する"]]})}],["Cursor",{entry:"カーソル",description:`要素の上にマウスカーソルを重ねたときの、カーソル形状を指定する
↓このエリアでプレビュー可能`,detail:i.jsx(m,{value:[["auto","自動",i.jsx("td",{className:"w-10 cursor-auto border border-black"})],["default","デフォルト",i.jsx("td",{className:"w-10 cursor-default border border-black"})],["pointer","ポインター",i.jsx("td",{className:"w-10 cursor-pointer border border-black"})],["wait","ビジー状態",i.jsx("td",{className:"w-10 cursor-wait border border-black"})],["text","テキスト選択",i.jsx("td",{className:"w-10 cursor-text border border-black"})],["move","移動",i.jsx("td",{className:"w-10 cursor-move border border-black"})],["help","ヘルプ",i.jsx("td",{className:"w-10 cursor-help border border-black"})],["not-allowed","禁止",i.jsx("td",{className:"w-10 cursor-not-allowed border border-black"})],["none","非表示",i.jsx("td",{className:"w-10 cursor-none border border-black"})],["context-menu","コンテキストメニュー",i.jsx("td",{className:"w-10 cursor-context-menu border border-black"})],["progress","バックグラウンドでビジー状態",i.jsx("td",{className:"w-10 cursor-progress border border-black"})],["cell","セルの選択",i.jsx("td",{className:"w-10 cursor-cell border border-black"})],["crosshair","十字カーソル",i.jsx("td",{className:"w-10 cursor-crosshair border border-black"})],["vertical-text","縦書きのテキスト選択",i.jsx("td",{className:"w-10 cursor-vertical-text border border-black"})],["alias","ショートカットの作成",i.jsx("td",{className:"w-10 cursor-alias border border-black"})],["copy","コピー",i.jsx("td",{className:"w-10 cursor-copy border border-black"})],["no-drop","ドロップ不可",i.jsx("td",{className:"w-10 cursor-no-drop border border-black"})],["grab","グラブ（ドラッグ）可能",i.jsx("td",{className:"w-10 cursor-grab border border-black"})],["grabbing","グラブ中",i.jsx("td",{className:"w-10 cursor-grabbing border border-black"})],["all-scroll","全方向にスクロール",i.jsx("td",{className:"w-10 cursor-all-scroll border border-black"})],["col-resize","列の幅をリサイズ",i.jsx("td",{className:"w-10 cursor-col-resize border border-black"})],["row-resize","行の高さをリサイズ",i.jsx("td",{className:"w-10 cursor-row-resize border border-black"})],["n-resize","上方向にリサイズ",i.jsx("td",{className:"w-10 cursor-n-resize border border-black"})],["e-resize","右方向にリサイズ",i.jsx("td",{className:"w-10 cursor-e-resize border border-black"})],["s-resize","下方向にリサイズ",i.jsx("td",{className:"w-10 cursor-s-resize border border-black"})],["w-resize","左方向にリサイズ",i.jsx("td",{className:"w-10 cursor-w-resize border border-black"})],["ne-resize","右上方向にリサイズ",i.jsx("td",{className:"w-10 cursor-ne-resize border border-black"})],["nw-resize","左上方向にリサイズ",i.jsx("td",{className:"w-10 cursor-nw-resize border border-black"})],["se-resize","右下方向にリサイズ",i.jsx("td",{className:"w-10 cursor-se-resize border border-black"})],["sw-resize","左下方向にリサイズ",i.jsx("td",{className:"w-10 cursor-sw-resize border border-black"})],["ew-resize","水平方向にリサイズ",i.jsx("td",{className:"w-10 cursor-ew-resize border border-black"})],["ns-resize","垂直方向にリサイズ",i.jsx("td",{className:"w-10 cursor-ns-resize border border-black"})],["nesw-resize","右上と左下方向にリサイズ",i.jsx("td",{className:"w-10 cursor-nesw-resize border border-black"})],["nwse-resize","左上と右下方向にリサイズ",i.jsx("td",{className:"w-10 cursor-nwse-resize border border-black"})],["zoom-in","拡大",i.jsx("td",{className:"w-10 cursor-zoom-in border border-black"})],["zoom-out","縮小",i.jsx("td",{className:"w-10 cursor-zoom-out border border-black"})]]})}],["Caret Color",{entry:"キャレットの色",description:"テキストボックス入力時のカーソルの色を指定する",detail:i.jsx(m,{value:[["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10 bg-transparent"})],["current","テキスト色",i.jsx("td",{className:"w-10 bg-transparent"})],["transparent","透明",i.jsx("td",{className:"w-10 bg-transparent"})],["black","黒",i.jsx("td",{className:"w-10 bg-black"})],["white","白",i.jsx("td",{className:"w-10 bg-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 bg-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 bg-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 bg-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 bg-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 bg-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 bg-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 bg-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 bg-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 bg-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 bg-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 bg-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 bg-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 bg-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 bg-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 bg-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 bg-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 bg-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 bg-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 bg-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 bg-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 bg-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 bg-rose-500"})],["red-500/25","不透明度25％で指定",i.jsx("td",{className:"w-10 bg-red-500/25"})]]})}],["Pointer Events",{entry:"ポインターイベント",description:"クリックなどのマウスイベントをキャッチするかどうかを指定する",detail:i.jsx(m,{value:[["none","キャッチせずに、背後の要素へと渡す"],["auto","キャッチする"]]})}],["Resize",{entry:"リサイズ",description:"<textarea>要素や、overflow-scrollを付与した要素のサイズ変更を可能にするかどうかを指定する",detail:i.jsx(m,{value:[["resize-none","サイズ変更不可"],["resize-y","垂直方向に変更可能にする"],["resize-x","水平方向に変更可能にする"],["resize","全方向に変更可能にする"]]})}],["Scroll Behavior",{entry:"スクロール動作",description:"<a>要素を用いたページ内リンクの動作を指定する",detail:i.jsx(m,{value:[["auto","瞬時にスクロールする"],["smooth","なめらかにスクロールする"]]})}],["Scroll Margin",{entry:"スクロールマージン",description:`スクロールスナップで止まる位置を、余白を与えることで調整する
余白を子要素側に設定したい場合に使用する`,detail:i.jsx(m,{value:[["m-*","全方向に余白を与える"],["mx-*","水平方向に余白を与える"],["my-*","垂直方向に余白を与える"],["ms-*","テキストの開始側に余白を与える"],["me-*","テキストの終端側に余白を与える"],["mt-*","上側に余白を与える"],["mr-*","右側に余白を与える"],["mb-*","下側に余白を与える"],["ml-*","左側に余白を与える"]]})}],["Scroll Padding",{entry:"スクロールパディング",description:`スクロールスナップで止まる位置を、余白を与えることで調整する
余白を親要素側に設定したい場合に使用する`,detail:i.jsx(m,{value:[["p-*","全方向に余白を与える"],["px-*","水平方向に余白を与える"],["py-*","垂直方向に余白を与える"],["ps-*","テキストの開始側に余白を与える"],["pe-*","テキストの終端側に余白を与える"],["pt-*","上側に余白を与える"],["pr-*","右側に余白を与える"],["pb-*","下側に余白を与える"],["pl-*","左側に余白を与える"]]})}],["Scroll Snap Align",{entry:"スクロールスナップの整列",description:"親要素と自身との、どの位置を基準にスクロールの動きを止めるのかを指定する",detail:i.jsx(m,{value:[["start","上、または左側が互いに揃うように止める"],["end","下、または右側が互いに揃うように止める"],["center","中央が互いに揃うように止める"],["align-none","スクロールスナップしない"]]})}],["Scroll Snap Stop",{entry:"スクロールスナップの停止",description:"すばやくスクロールした際の、ブレーキのかけ方を指定する",detail:i.jsx(m,{value:[["normal","要素をスキップ可能にする"],["always","次の要素で強制的に止める（親要素にsnap-mandatoryの付与が必要）"]]})}],["Scroll Snap Type",{entry:"スクロールスナップタイプ",description:"スクロールスナップを有効にする方向や、スナップの強制度合いを指定する",detail:i.jsx(m,{value:[["none","スクロールスナップしない"],["x","水平方向にスクロールスナップ"],["y","垂直方向にスクロールスナップ"],["both","上下左右にスクロールスナップ"],["mandatory","強制的に位置を揃える"],["proximity","強制の度合いは緩く、中間位置ではスナップしない"]]})}],["Touch Action",{entry:"タッチアクション",description:"スクロールやズームに対する、タッチ操作でのジェスチャーを指定する",detail:i.jsx(m,{value:[["auto","ジェスチャーを有効にする"],["none","ジェスチャーを無効にする"],["pan-x","水平方向のスクロールを可能にする"],["pan-left","左方向へのスクロールを可能にする"],["pan-right","右方向へのスクロールを可能にする"],["pan-y","垂直方向のスクロールを可能にする"],["pan-up","上方向へのスクロールを可能にする"],["pan-down","下方向へのスクロールを可能にする"],["pinch-zoom","ピンチ操作でのズームを可能にする"],["manipulation","ダブルタップでのズームを可能にする"]]})}],["User Select",{entry:"ユーザー選択",description:"テキスト選択の動作を指定する",detail:i.jsx(m,{value:[["none","テキスト選択不可"],["text","テキスト選択を許可する"],["all","テキスト全体をワンクリックで選択状態にする"],["auto","自動"]]})}],["Will Change",{entry:"未来の変更",description:`ページに何かしらの変化が発生する可能性を事前にブラウザーへ伝えることで、アニメーションなどの最適化を図る
使用法を間違えると逆にパフォーマンス悪化につながるので、基本的にはブラウザーに任せたほうが良い`,detail:i.jsx(m,{value:[["auto","ブラウザーに最適化を任せる"],["scroll","スクロール位置が変化する可能性を伝える"],["contents","コンテンツが変化する可能性を伝える"],["transform","変形操作が行われる可能性を伝える"]]})}]]),Ub=new Map([[E.SVG,{entry:"ベクター画像",description:"",detail:null}],["Fill",{entry:"塗りつぶし",description:"<svg>要素の塗りつぶし色を指定する",detail:i.jsx(m,{value:[["none","塗りつぶししない",i.jsx("td",{className:"w-10"})],["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10"})],["current","テキスト色",i.jsx("td",{className:"w-10"})],["transparent","透明",i.jsx("td",{className:"w-10"})],["black","黒",i.jsx("td",{className:"w-10 bg-black"})],["white","白",i.jsx("td",{className:"w-10 bg-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 bg-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 bg-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 bg-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 bg-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 bg-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 bg-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 bg-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 bg-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 bg-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 bg-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 bg-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 bg-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 bg-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 bg-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 bg-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 bg-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 bg-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 bg-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 bg-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 bg-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 bg-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 bg-rose-500"})],["red-500/25","不透明度25％で指定する例",i.jsx("td",{className:"w-10 bg-red-500/25"})]]})}],["Stroke",{entry:"線",description:"<svg>要素の線の色を指定する",detail:i.jsx(m,{value:[["none","塗りつぶししない",i.jsx("td",{className:"w-10"})],["inherit","親要素からスタイルを引き継ぐ",i.jsx("td",{className:"w-10"})],["current","テキスト色",i.jsx("td",{className:"w-10"})],["transparent","透明",i.jsx("td",{className:"w-10"})],["black","黒",i.jsx("td",{className:"w-10 bg-black"})],["white","白",i.jsx("td",{className:"w-10 bg-white"})],["slate-500","粘板岩",i.jsx("td",{className:"w-10 bg-slate-500"})],["gray-500","グレー",i.jsx("td",{className:"w-10 bg-gray-500"})],["zinc-500","亜鉛",i.jsx("td",{className:"w-10 bg-zinc-500"})],["neutral-500","ニュートラル",i.jsx("td",{className:"w-10 bg-neutral-500"})],["stone-500","石",i.jsx("td",{className:"w-10 bg-stone-500"})],["red-500","赤",i.jsx("td",{className:"w-10 bg-red-500"})],["orange-500","オレンジ",i.jsx("td",{className:"w-10 bg-orange-500"})],["amber-500","琥珀",i.jsx("td",{className:"w-10 bg-amber-500"})],["yellow-500","黄色",i.jsx("td",{className:"w-10 bg-yellow-500"})],["lime-500","ライム",i.jsx("td",{className:"w-10 bg-lime-500"})],["green-500","緑",i.jsx("td",{className:"w-10 bg-green-500"})],["emerald-500","エメラルド",i.jsx("td",{className:"w-10 bg-emerald-500"})],["teal-500","コガモ",i.jsx("td",{className:"w-10 bg-teal-500"})],["cyan-500","シアン",i.jsx("td",{className:"w-10 bg-cyan-500"})],["sky-500","スカイ",i.jsx("td",{className:"w-10 bg-sky-500"})],["blue-500","青",i.jsx("td",{className:"w-10 bg-blue-500"})],["indigo-500","藍色",i.jsx("td",{className:"w-10 bg-indigo-500"})],["violet-500","スミレ",i.jsx("td",{className:"w-10 bg-violet-500"})],["purple-500","紫",i.jsx("td",{className:"w-10 bg-purple-500"})],["fuchsia-500","フクシア",i.jsx("td",{className:"w-10 bg-fuchsia-500"})],["pink-500","ピンク",i.jsx("td",{className:"w-10 bg-pink-500"})],["rose-500","バラ",i.jsx("td",{className:"w-10 bg-rose-500"})],["red-500/25","不透明度25％で指定する例",i.jsx("td",{className:"w-10 bg-red-500/25"})]]})}],["Stroke Width",{entry:"線の太さ",description:"<svg>要素の線の太さを指定する",detail:null}]]),Pb=new Map([[E.Accessibility,{entry:"アクセシビリティー",description:"",detail:null}],["Screen Readers",{entry:"スクリーンリーダー",description:"画面読み上げ機能を使用時のアクセシビリティーを向上させる",detail:i.jsx(m,{value:[["sr-only","視覚的には非表示だが、画面読み上げ機能からは認識できる状態にする"],["not-sr-only","視覚的にも認識できる状態にする"]]})}],["Forced Color Adjust",{entry:"強制カラー調整",description:`ユーザーが設定している、視覚サポート系アクセシビリティー（ハイコントラストモードなど）の効果の受け方を指定する
ブラウザー任せでは問題がある箇所に限定して、適切に使用すること`,detail:i.jsx(m,{value:[["auto","効果を受け入れる"],["none","効果を受け入れない"]]})}]]);class zs{constructor(){jr(this,"cache",null);jr(this,"getTranslations",()=>(this.cache==null&&(this.cache=this.documentationsTriple.map(([o,e,t])=>{const n=this.translateCategory(o,t),a=this.translateDetailedDocumentations(e,t);return{category:n,detailedDocumentations:a}})),this.cache));jr(this,"translateCategory",(o,e)=>{const t=e.get(o);return`${o}${t?` / ${t.entry}`:""}`});jr(this,"translateDetailedDocumentations",(o,e)=>o.map(n=>{const a=this.removedUnwantedCells(n),l=e.get(a.entry);return{url:a.url,entry:`${a.entry}
${(l==null?void 0:l.entry)??""}`,description:l!=null&&l.description!==""?l.description:a.description,detail:l==null?void 0:l.detail,parameters:a.parameters}}));jr(this,"removedUnwantedCells",o=>{const e=o.parameters.map(n=>n.filter(a=>!(a===""||a==="Aa")));return{url:o.url,entry:o.entry,description:o.description,parameters:this.removedSymbols(o.entry,e)}});jr(this,"removedSymbols",(o,e)=>o==="Space Between"||o==="Divide Width"||o==="Divide Color"||o==="Divide Style"?e.map(t=>t.map(n=>n.replace(" > * + *",""))):e)}}class Lb extends zs{constructor(){super(...arguments);jr(this,"documentationsTriple",[[E.Layout,cs,hb],[E.FlexboxAndGrid,gs,vb],[E.Spacing,bs,yb],[E.Sizing,ps,kb],[E.Typography,ms,jb],[E.Backgrounds,fs,Nb],[E.Borders,ws,zb],[E.Effects,us,Sb],[E.Filters,xs,Cb],[E.Tables,hs,Ab],[E.TransitionsAndAnimation,vs,Eb],[E.Transforms,ys,Tb],[E.Interactivity,ks,_b],[E.SVG,js,Ub],[E.Accessibility,Ns,Pb]])}}class Rb extends zs{constructor(){super(...arguments);jr(this,"empty",new Map);jr(this,"documentationsTriple",[[E.Layout,cs,this.empty],[E.FlexboxAndGrid,gs,this.empty],[E.Spacing,bs,this.empty],[E.Sizing,ps,this.empty],[E.Typography,ms,this.empty],[E.Backgrounds,fs,this.empty],[E.Borders,ws,this.empty],[E.Effects,us,this.empty],[E.Filters,xs,this.empty],[E.Tables,hs,this.empty],[E.TransitionsAndAnimation,vs,this.empty],[E.Transforms,ys,this.empty],[E.Interactivity,ks,this.empty],[E.SVG,js,this.empty],[E.Accessibility,Ns,this.empty]])}}const Go=class Go{};jr(Go,"id"),jr(Go,"run",(o,e)=>{clearInterval(Go.id),Go.id=window.setTimeout(()=>{o()},e)});let Hi=Go;const Fb="/tailwindcss-japanese-cheat-sheet/assets/github-mark-B3LxWxcL.png",Bb="/tailwindcss-japanese-cheat-sheet/assets/github-mark-white-BsLkggKK.png",kt=new Lb,Kl=new Rb,Mb=()=>{const[r,o]=G.useState(kt.getTranslations()),[e,t]=G.useState(!0);return G.useEffect(()=>{o(kt.getTranslations())},[]),i.jsxs(ob,{children:[i.jsxs("div",{className:"space-y-4 bg-gray-800 py-4 text-neutral-100",children:[i.jsx("h1",{className:"break-keep text-center text-2xl font-bold drop-shadow-[0_0_5px_rgba(0,255,255,0.75)]",children:"Tailwind CSS 日本語チートシート"}),i.jsxs("div",{className:"flex justify-between px-4",children:[i.jsx("p",{className:"my-auto -ml-4 bg-gradient-to-r from-purple-500 to-transparent px-4 text-sm",children:`Documentation ${xb}`}),i.jsx(Ob,{isJapanese:e,setIsJapanese:t,translatorJA:kt,translatorEN:Kl,setTranslations:o})]})]}),i.jsxs("div",{className:"space-y-4 p-4 text-neutral-950 dark:text-neutral-100",children:[i.jsx(Ib,{isJapanese:e}),i.jsx(Db,{translations:e?kt.getTranslations():Kl.getTranslations(),setTranslations:o}),i.jsx("div",{className:"sm:columns-1 md:columns-2 lg:columns-3 xl:columns-4",children:r.map(n=>i.jsx(sb,{category:n.category,detailedDocumentations:n.detailedDocumentations},n.category))})]}),i.jsxs("div",{className:"flex justify-center gap-2 pb-4",children:[i.jsxs("a",{className:"relative h-6 w-6 opacity-70 transition hover:opacity-100",href:"https://github.com/Telehakke/tailwindcss-japanese-cheat-sheet",target:"_blank",children:[i.jsx("img",{className:"absolute inset-0 inline-block dark:hidden",src:Fb}),i.jsx("img",{className:"absolute inset-0 hidden dark:inline-block",src:Bb})]}),i.jsx("small",{className:"my-auto text-neutral-950 dark:text-neutral-100",children:"© 2024 Telehakke"})]})]})},Ob=({isJapanese:r,setIsJapanese:o,translatorJA:e,translatorEN:t,setTranslations:n})=>i.jsxs("div",{children:[i.jsx("button",{className:`rounded-l-full border-y-2 border-l-2 border-purple-500 px-2 transition ${r?"bg-purple-500":"hover:bg-white/20"}`,onClick:()=>{o(!0),n(e.getTranslations())},children:"日本語"}),i.jsx("button",{className:`rounded-r-full border-y-2 border-r-2 border-purple-500 px-2 transition ${r?"hover:bg-white/20":"bg-purple-500"}`,onClick:()=>{o(!1),n(t.getTranslations())},children:"English"})]}),Ib=({isJapanese:r})=>{const{setShouldExpandAll:o}=G.useContext(Oa);return i.jsxs("div",{className:"flex justify-center gap-4",children:[i.jsx(Wi,{className:"px-2",Icon:i.jsx(nb,{className:"fill-neutral-500"}),text:r?"全て展開":"Expand All",onClick:()=>o(!0)}),i.jsx(Wi,{className:"px-2",Icon:i.jsx(ib,{className:"fill-neutral-500"}),text:r?"全て折りたたむ":"Collapse All",onClick:()=>o(!1)})]})},Db=({translations:r,setTranslations:o})=>{const[e,t]=G.useState(!1),[n,a]=G.useState(""),l=G.useRef(null);G.useEffect(()=>{var g,u;(g=l.current)==null||g.addEventListener("focus",()=>{t(!0)}),(u=l.current)==null||u.addEventListener("focusout",()=>{t(!1)})},[]);const d=g=>{const u=g.target.value;a(u);const w=u.toLowerCase(),f=(v,y)=>v.filter(F=>{if(F.entry.toLowerCase().includes(y)||F.description.toLowerCase().includes(y))return!0;for(const b of F.parameters)for(const c of b)if(c.toLowerCase().includes(y))return!0;return!1});Hi.run(()=>{const v=r.map(y=>{const k=f(y.detailedDocumentations,w);return{category:y.category,detailedDocumentations:k}});o(v)},400)},s=()=>{a(""),o(r)};return i.jsxs("div",{className:"relative mx-auto max-w-80",children:[i.jsx("input",{className:"h-8 w-full rounded-md bg-transparent px-2",id:"search",type:"text",onChange:d,value:n,ref:l}),i.jsx("div",{className:"absolute inset-0 -z-10 rounded-md bg-neutral-50 dark:bg-neutral-700",children:!e&&n.length===0?i.jsx(lb,{className:"absolute inset-y-0 left-2 my-auto fill-neutral-500"}):null}),n.length>0&&i.jsx("button",{onClick:s,children:i.jsx(db,{className:"absolute inset-y-0 right-2 my-auto rounded-full fill-neutral-500 transition hover:bg-neutral-200 dark:hover:bg-neutral-600 dark:hover:fill-neutral-400"})})]})};ss(document.getElementById("root")).render(i.jsx(G.StrictMode,{children:i.jsx(Mb,{})}));
